                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>商務用 Skype Online</h3>
                                                    <p>尋找在您的 Office 365 環境中管理商務用 Skype Online 的資源。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>商務用 Skype 的 PowerShell 參考</h3>
                                                    <p>瞭解管理商務用 Skype 和商務用 Skype Online 所需的 PowerShell Cmdlet。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Microsoft 團隊</h3>
                                                    <p>取得成功推出 Microsoft 團隊所需的規劃、做法及實際指導方針。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>從商務用 Skype 遷移至 Microsoft 團隊</h3>
                                                    <p>尋找指導方針與工具來探索團隊的最佳路徑。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>最終使用者</h3>
                                                    <p>在<a href='https://support.office.com/en-us/skype-for-business' target="_blank">support.office.com</a>上尋找商務用 Skype 使用者的說明、訓練和技術支援。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
