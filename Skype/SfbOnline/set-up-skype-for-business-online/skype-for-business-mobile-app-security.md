...
|**iOS** <br/> |我們不會在鑰匙圈中加密使用者名稱/密碼。 不過，鑰匙圈會自行加密。  <br/> |我們已在應用程式儲存區中的所有檔案上使用[NSFileProtectionCompleteUntilFirstUserAuthentication](https://developer.apple.com/reference/foundation/fileprotectiontype/1616633-completeuntilfirstuserauthentica)資料保護標誌。 這表示 app 儲存空間中的檔案會經過加密，直到使用者在裝置重新開機後第一次解除鎖定裝置為止。 <br/> |此資訊不會加密。  <br/> |
