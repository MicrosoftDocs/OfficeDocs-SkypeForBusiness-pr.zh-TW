...
ms.locfileid: "58581967"
---
# <a name="turn-on-or-off-offline-messages-for-admins"></a>開啟或關閉系統管理員的離線訊息

[!INCLUDE [sfbo-retirement](../../Hub/includes/sfbo-retirement.md)]

即使連絡人商務用 Skype，您也可以傳送這些 IM 給連絡人。 這項功能可讓您的連絡人知道您一直嘗試聯繫他們。 在傳送訊息給某人之前，您不需要等到某人在線上。
...
詳細資訊，請參閱在 商務用 Skype 中[使用離線商務用 Skype。](https://support.office.com/article/ffdc6a43-71a1-40ee-bfcc-640d21324a3d)
...
2. 開啟 Windows PowerShell命令提示符，然後執行下列命令： 
   ...
   ```
如果您想要開始建立帳戶Windows PowerShell，請參閱連線視窗中連線所有 Office 365[服務](/microsoft-365/enterprise/connect-to-all-microsoft-365-services-in-a-single-windows-powershell-window)Windows PowerShell或設定您的電腦[Windows PowerShell。](../set-up-your-computer-for-windows-powershell/set-up-your-computer-for-windows-powershell.md)

## <a name="turning-on-or-off-offline-im"></a>開啟或關閉離線 IM

> [!NOTE]
> 離線 **訊息僅適用于** 最新版本的 [即用即用商務用 Skype 用戶端，且在使用舊版的即用即用 商務用 Skype 或 *.msi 檔案安裝 商務用 Skype 用戶端時，則無法使用離線訊息。
...
若要啟用或停用使用者的離線郵件傳送離線訊息，請將  _EnableIMAutoArchiving 設定_ 為 `True` 或 `False` 。 根據預設，此設定為  `True` 。 您可以使用現有的策略，或建立如下範例的一個。
