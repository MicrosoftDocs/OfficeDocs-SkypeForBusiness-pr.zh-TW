...
- **為Skype啟用會議廣播預覽功能** 客戶商務用 Skype計畫可為您提供新產品與功能的提早存取權。 這樣一來，貴組織就會快速瞭解即將推出哪些功能，以及測試您環境中新功能的機會，並給予意見，然後再將產品建立發佈給一般大眾。<br/>[商務用 Skype預覽](https://www.skypepreview.com/)
    
- **允許召集人排程匿名會議** 這可讓召集人建立廣播活動，讓組織外部的任何人無需登錄即可加入。
    
- **允許錄製廣播會議** 這可讓簡報者或召集人錄製任何會議。
    
- **出席者的支援 URL** 輸入會議廣播出席者的連結，以在需要連接或出席廣播會議時需要協助時使用。
