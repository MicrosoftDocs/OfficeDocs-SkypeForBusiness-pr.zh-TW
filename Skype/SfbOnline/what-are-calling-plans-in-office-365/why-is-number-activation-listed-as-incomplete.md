...
ms.locfileid: "54279511"
---
# <a name="why-is-number-activation-listed-as-incomplete"></a>為什麼數位啟用列為不完整？

[!INCLUDE [sfbo-retirement](../../Hub/includes/sfbo-retirement.md)]?

位址驗證是設定通話方案的重要一部分。 如果因為某種原因，電話號碼未啟用，且因為位址驗證而列為不完整，您必須建立並提交服務要求。 您執行此工作是以貴組織的大小為基礎。
...
1. 以系統管理員的登錄Microsoft 365或Office 365公司或學校帳戶進行登錄。
