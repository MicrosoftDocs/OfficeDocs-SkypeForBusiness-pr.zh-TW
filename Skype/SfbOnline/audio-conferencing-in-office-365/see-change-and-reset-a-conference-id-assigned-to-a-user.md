...
---
# <a name="view-and-reset-a-conference-id-assigned-to-a-user-in-skype-for-business-online"></a>在 商務用 Skype 中查看和重設指派給使用者的會議 ID
...
您可以使用會議識別碼重設使用者Windows PowerShell。 若要這麼做，請執行：
