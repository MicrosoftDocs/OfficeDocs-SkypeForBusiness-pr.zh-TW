...
* 在 商務用 Skype中，按一下 [選項旁的顯示功能表箭號，然後按一下[工具  >  **電話撥入式會議設定。**
...
- 會議開始時，大廳中的所有使用者都會自動加入會議。 例如，如果兩位參與者在會議開始之前嘗試加入會議，則他們會放在大廳，並保留聆聽音樂，而當會議召集人透過電話使用 PIN 加入時，會議就會開始，而大廳中的參與者將會加入會議。
