...
> [!Note]
> 有關在 Microsoft Teams 中沒有 PIN 啟動音訊會議的資訊，請參閱在 Microsoft Teams 中在沒有[PIN 的情況下，在手機上啟動音訊Microsoft Teams。](/MicrosoftTeams/start-an-audio-conference-over-the-phone-without-a-pin-in-teams)
...
3. 在使用者的屬性頁面上， **選取或清除** 會議選項下的允許未經驗證的來電 **者成為會議的第一個人。如果沒有，他們會在大廳等候，直到經過驗證的使用者加入**。
