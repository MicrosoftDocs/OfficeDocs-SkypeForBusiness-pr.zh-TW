 ...
 **想要尋找價格嗎？** 請參閱 [音訊會議] https://www.microsoft.com/microsoft-teams/audio-conferencing) 。
...
如果貴組織只有一個可用的電話號碼，它會做為所有使用者的預設號碼。 當有多個電話號碼可用時，您可以選取每個使用者的預設電話號碼。 此預設號碼會包含在商務用 Skype邀請中。
