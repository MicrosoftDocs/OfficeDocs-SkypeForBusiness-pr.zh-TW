...
當您在會議或Microsoft 365中Office 365音訊會議時，就會獲得音訊會議橋接器。 會議橋接器可以包含一或多個電話號碼，使用者會使用該電話號碼來商務用 Skype會議。 
...
- 當涉及Windows PowerShell，商務用 Skype Online 就是管理使用者，以及允許使用者或不允許使用者執行哪些操作。 有了Windows PowerShell，您可以使用單一Microsoft 365管理Office 365管理，當您有多個工作需要執行時，可以簡化您的日常工作。 若要開始使用Windows PowerShell，請參閱以下主題：
