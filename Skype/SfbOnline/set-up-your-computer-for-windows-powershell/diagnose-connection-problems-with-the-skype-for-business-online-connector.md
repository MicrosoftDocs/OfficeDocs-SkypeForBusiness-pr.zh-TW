...
- [Import-Windows PowerShell 執行原則所導致的模組錯誤](diagnose-connection-problems-with-the-skype-for-business-online-connector.md#BKMKPowerShellExecutionPolicy)
    
- [匯入-由於不正確的 Windows PowerShell 版本所導致的模組錯誤](diagnose-connection-problems-with-the-skype-for-business-online-connector.md#BKMKIncorrectVersion)
    
- [無法連線至 [Live ID] 伺服器](diagnose-connection-problems-with-the-skype-for-business-online-connector.md#BKMKFailedConnect)
    
- [無法載入 [實際 ID] 模組](diagnose-connection-problems-with-the-skype-for-business-online-connector.md#BKMKFailedLoad)
...
- [在商務用 Skype Online 中已停用連接至租使用者的能力](diagnose-connection-problems-with-the-skype-for-business-online-connector.md#BKMKAbilityConnect)
