...
- 請前往系統管理中心>系統管理 **中心**  >  **商務用 Skype**  >  **報告**  >  **PSTN 分鐘數庫**。
    
> [!NOTE]
> 視您Microsoft 365或Office 365訂閱，您可能不會在這裡看到所有相同的詳細資料。 
...
***
![數位 1。](../images/sfbcallout1.png)<br/>表格顯示授權與使用位置 (分鐘) 明細。 
*    **功能** 是通話所使用的授權/服務方案。 您可能會在此報告中看到授權/服務方案包括：
     * MCOPSTN1 - 國內通話方案 (3000 分鐘美國/1200 分鐘的歐盟方案
     * MCOPSTN2 - 國內 & (國際通話方案，您可從該計畫看到 3000 分鐘美國/加拿大/PR、1200 分鐘的歐洲國家 /地區) 以及 600 分鐘的 (國際泳池) 。 每當在日曆月份內達到國內 -OR- 國際上限時，即會達到分鐘數上限。 
