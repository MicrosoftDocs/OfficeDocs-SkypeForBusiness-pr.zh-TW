...
2. 在使用 **狀況頁面上****，商務用 Skype** 左側的選取報表清單上的會議參與者  >  活動。 或者，按一下 **[商務用 Skype活動** 小工具，然後按一下 [商務用 Skype **活動** 清單上的會議商務用 Skype **活動**。
...
***
![數位 3](../images/sfbcallout3.png)<br/>使用活動圖表上的互動式圖表資料來瞭解使用趨勢，並查看參與的會議總數，以及貴組織中正在召開的會議類型。 它會顯示您組織中參與的 **IM、** 音訊 **/** 視像、 **應用程式** 共用 **、Web** 和撥入 **/** 撥出 - 協力廠商會議總數和類型。
***
...
***
![數位 5](../images/sfbcallout5.png)<br/>使用分鐘圖表上的互動式圖表資料來瞭解使用趨勢，以及查看使用者在使用音訊/視像、撥入和撥出來組織會議時所使用的分鐘數 - Microsoft 作為音訊會議提供者。 它會顯示參與會議期間所使用之音訊 **/** 視音訊的總分鐘數。
***
![數位 6](../images/sfbcallout6.png)<br/>您可以按一下圖例中的專案，來篩選圖表上看到的數列。 例如，在 [活動圖上，按一下或點一下 **IM、****音訊/視** 像、**應用程式共用****、Web** 及撥 **入/撥出 - 第三** 方，即可只查看與每個專案相關的資訊。 變更此選取範圍不會變更格線表格中的資訊。 
***
![數位 7](../images/sfbcallout7.png)<br/>每個圖表都有一個水準軸 (X，) 垂直軸 (Y) 。  
*    在活動活動圖表中，Y 軸是貴組織中使用者參與的 IM、音訊/視訊、應用程式共用、Web 以及撥入/撥出協力廠商會議總數。 
...
***
![數位 8](../images/sfbcallout8.png)<br/>下表顯示每個使用者參與會議活動的明細。 這會顯示所有已指派商務用 Skype使用者，以及他們參與的會議。 您可以新增其他欄至資料表。
*    **使用者名稱** 是使用者的名稱。 
