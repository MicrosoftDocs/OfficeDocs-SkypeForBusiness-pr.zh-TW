...
報表 **儀表板** 會顯示您組織中所有Microsoft 365 Office 365活動概觀。 它可讓您深入查看個別的產品層級報告，以進一步深入瞭解每個產品內的活動。 例如，您可以使用 **商務用 Skype** 會議召集人活動報告，查看使用者組織使用 IM、音訊/視像、應用程式共用、Web、撥入/撥出 - 協力廠商以及撥入/撥出 - Microsoft 的會議。 
...
***
![數位 4](../images/sfbcallout4.png)<br/>使用使用者圖表上的互動式圖表和即時資料，瞭解使用趨勢，並查看組織貴組織會議的唯一使用者數目。 它會顯示使用者總數，以及已組織會議的 **IM、** 音訊 **/** 視像、應用程式共用 **、Web、** 撥入/撥出 -**第三** 方，以及撥 **入/** 撥出 Microsoft 的類型。  
***
...
*    在分鐘 **活動** 圖表上，Y 軸是使用者組織在貴組織中召開的會議的總分鐘數音訊/視訊、撥入 Microsoft 分鐘數，以及撥出 Microsoft 分鐘數。  
...
* **已刪除** 表示使用者授權已移除。<br/><br/>
  > [!NOTE]
  > 只要在所選時段內獲得授權，已刪除使用者的活動仍然會顯示在報告中。 刪除 **欄** 可協助您注意使用者可能不再作用中，但已對報告中的資料有影響。
...
* **撥出 Microsoft 分鐘數** 顯示使用 Microsoft 作為音訊會議提供者的已組織會議所使用的撥出分鐘總數。 
