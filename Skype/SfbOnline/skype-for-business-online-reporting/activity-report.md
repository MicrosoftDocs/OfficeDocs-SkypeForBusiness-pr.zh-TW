...
ms.locfileid: "58605652"
---
# <a name="activity-report"></a>活動報告

[!INCLUDE [sfbo-retirement](../../Hub/includes/sfbo-retirement.md)]

報表 **儀表板** 會顯示您組織中Microsoft 365 Office 365活動概觀。 它可讓您深入查看個別的產品層級報告，以進一步深入瞭解每個產品內的活動。 例如，**您可以使用 商務用 Skype** 活動報告來查看使用者使用對等或有組織的會議會話，或是他們參與會議會話的量。 
...
## <a name="interpret-the-skype-for-business-activity-report"></a>解譯商務用 Skype活動報告
...
***
![數位 1](../images/sfbcallout1.png)<br/>
您可以 **商務用 Skype** 活動電子郵件活動報告，查看過去 7 天、30 天、90 天或 180 天的趨勢。 不過，如果您按一下報告中的特定日期，資料表 (請參閱數位 7) 會顯示自目前日期起最多 28 天的資料 (而不是報表的產生日期) 。
...
使用活動圖表上的互動式圖表資料來瞭解使用趨勢，並查看貴組織中進行的會議活動數目。 它會顯示整個組織的點對點工作階段、已組織及參與會議會話的總數和類型。   
***
![數位 4](../images/sfbcallout4.png)<br/>
使用使用者圖表上的互動式圖表資料來瞭解使用趨勢，並查看參與貴組織進行之會議活動的唯一使用者數目。 它會顯示使用者總數，以及點對點工作階段、已組織及 **參與會議會話** 的類型。  
***
![數位 5](../images/sfbcallout5.png)<br/>
...
* **對等顯示** 使用者使用的對等會議會話總數。
* **已組織會議** 會顯示該使用者所組織的會議總數。
* **參與的會議會顯示** 此使用者參與的會議總數。
* **指派的產品** 是指派Microsoft 365 Office 365指派給該使用者的產品。<br/>
...
***
![數位 8](../images/sfbcallout8.png)<br/>
按一下或點一 **下** 任一欄的 [欄」 圖示，即可從報表新增或移除欄。           <br/> ![商務用 Skype線上報告管理按鈕。](../images/4c8f5387-cebb-4d6c-b7d3-05c954a2c234.png)
***
![數位 9](../images/sfbcallout9.png)<br/>
您也可以按一下或點Excel .csv匯出，將報表資料匯出至 **檔案。**           <br/> ![商務用 Skype報表匯出按鈕。](../images/de7e2ab7-d70c-422f-a0ec-178b10f7dd51.png)<br/> 這會匯出所有使用者的資料，並可讓您執行簡單的排序和篩選，以便進一步分析。 如果您的使用者少於 2000 人，您可以在報表本身的表格內排序和篩選。 如果您有超過 2000 個使用者，若要篩選和排序，您必須匯出資料。 
