...
>
>若要取得支援裝置上的最新更新和最新資訊，請參閱智慧Microsoft Teams[裝置。](https://products.office.com/microsoft-teams/across-devices?ms.url=officecomteamsdevices&rtc=1)
...
>
> 今年稍後，Office 365不支援任何 1.2 以前的 TLS 版本。 由於 LPE 的基礎作業系統不支援 TLS 1.2，因此不再支援 LPE Office 365連結。 請參閱[準備在 Office 365 中強制使用 TLS 1.2。](https://support.microsoft.com/en-gb/help/4057306/preparing-for-tls-1-2-in-office-365)
