...
線上商務用 Skype方案 1 已停用。 不過，如果您有線上方案 1 商務用 Skype訂閱，這項變更並不會影響您。 做為Office 365系統管理員，您會收到電子郵件更新，並查看訊息中心中的文章 (位於 Microsoft 365 系統管理中心的一部分) 並提供有關何時需要採取行動的資訊。 同時，您可以繼續使用現有的線上方案 1 商務用 Skype授權。
...
您可以立即切換到Office 365 F1，或等到更新程式期間需要續約和升級。 無論是哪種方式，您都得與帳戶代表或合作夥伴合作進行切換，除非您直接向 Microsoft 購買訂閱，在這種情況下，您可以切換到 Office 365 F1 系統管理中心Microsoft 365帳戶。
