...
ms.locfileid: "51103719"
---
# <a name="skype-for-business-add-on-licensing"></a>商務用 Skype 附加元件授權

## <a name="what-are-add-on-licenses"></a>什麼是附加元件授權？

附加元件授權是特定商務用 Skype 功能授權。 一些企業希望靈活地以有競爭力的價格購買特定功能。 為了新增一個功能，需為每個將使用此功能的使用者購買一個附加元件授權。

商務用 Skype 授權是專為為您提供最大彈性所設計。 例如，使用商務用 Skype 基本功能一段時間之後，您可以在準備好使用更多功能時購買附加元件授權，例如音訊會議或 Office 365 中的電話系統。
...
- [通話方案價格](https://products.office.com/skype-for-business/calling-plans)

## <a name="what-features-can-i-get-with-add-on-licenses"></a>附加元件授權可以取得哪些功能？

視您已有的計畫不同，您可以購買下列商務用 Skype 功能的附加元件授權：

|||
|:-----|:-----|
|**功能** <br/> |**描述** <br/> |
|**音訊會議** <br/> |有時候，貴組織的人員需要使用電話來撥打商務用 Skype 會議，而不是使用電腦。 在這種情況下，可使用音訊會議功能。  <br/> 若要了解您的國家/地區是否可使用音訊會議，請參閱[音訊會議與通話方案的適用國家和地區](/microsoftteams/country-and-region-availability-for-audio-conferencing-and-calling-plans/country-and-region-availability-for-audio-conferencing-and-calling-plans)。 <br/> 如果您正在尋找其成本，請參閱音訊 [會議的需求](https://products.office.com/skype-for-business/audio-conferencing#requirements)。  <br/> |
...
|**電話系統** <br/> |企業的電話系統是 PBX。 電話系統是一種託管電話語音。 它提供傳統和創新的 PBX 功能，但不需要複雜且昂貴的設備。 [以下是使用電話系統取得功能](/MicrosoftTeams/here-s-what-you-get-with-phone-system)。  <br/> 如果您要尋找其成本，請參閱電話 [系統需求](https://products.office.com/skype-for-business/cloud-pbx#requirements)。  <br/> |
|**通話方案** <br/> |撥打給其他商務用 Skype 使用者是免費的，但如果您希望使用者能夠撥打公司外的任何電話號碼，請取得 [通話方案](/MicrosoftTeams/calling-plans-for-office-365)。 有國內通話方案及國內及國際通話方案。  <br/> 如果您要尋找費用，請參閱通話方案 [需求](https://products.office.com/skype-for-business/pstn-calling-plans#requirements)。  <br/> |
|**Microsoft Teams 會議室** <br/> |這不是附加元件，只是將影片、音訊、內容共用帶到會議室的功能。 請參閱 [Microsoft Teams 會議室](/MicrosoftTeams/rooms/rooms-licensing)。  <br/> |
...
- [Office 365 Premium、Microsoft 365 企業版 App 或商務用 Skype Online 方案 2](../skype-for-business-and-microsoft-teams-add-on-licensing/license-options-based-on-your-plan/office-365-premium-pro-plus-or-business-online-plan.md)
...
有關每個商務用 Skype 方案的詳細功能和比較清單，請參閱商務用 [Skype Online 服務描述](/office365/servicedescriptions/skype-for-business-online-service-description/skype-for-business-online-service-description)。

## <a name="how-to-see-prices-and-buy-add-on-licenses"></a>如何查看價格和購買附加元件授權
<a name="bkmk_how"> </a>

 **購買 Microsoft 365** 方案之後，您即會看到價格，並透過 Microsoft 365 系統管理中心購買附加元件。
...
如果您想要使用現有的通話方案，請購買電話 **系統** 附加元件，然後與免費的 **[雲端連接器一起使用](../../SfbServer/skype-for-business-hybrid-solutions/plan-your-phone-system-cloud-pbx-solution/plan-skype-for-business-cloud-connector-edition.md)**。
...
- [設定 Office](/microsoftteams/set-up-calling-plans) [365](/MicrosoftTeams/calling-plans-for-office-365)的通話方案與通話方案
