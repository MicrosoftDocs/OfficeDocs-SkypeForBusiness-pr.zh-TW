...
若要瞭解更多成本資訊，請參閱 [如何查看價格及購買](skype-for-business-and-microsoft-teams-add-on-licensing.md#bkmk_how) 附加元件授權，或下列其中一項：
...
- [通話方案的價格](https://docs.microsoft.com/microsoftteams/set-up-audio-conferencing-in-team)
...
|**電話系統**  |企業的電話系統是 PBX。 電話系統是一種託管電話語音。 它提供傳統和創新的 PBX 功能，但不需要複雜且昂貴的設備。 [以下是使用電話系統取得功能。](/MicrosoftTeams/here-s-what-you-get-with-phone-system)  <br/> 如果您要尋找其成本，請參閱電話 [系統需求](https://products.office.com/skype-for-business/cloud-pbx#requirements)。   |
|**通話方案**  |撥打給其他商務用 Skype 使用者是免費的，但如果您希望使用者能夠撥打公司外的任何電話號碼，請取得 [通話方案](/MicrosoftTeams/calling-plans-for-office-365)。 有國內通話方案及國內及國際通話方案。  <br/> 如果您要尋找費用，請參閱通話方案 [需求](https://products.office.com/skype-for-business/pstn-calling-plans#requirements)。   |
 ...
 **購買 Microsoft 365 方案** 之後，您即會看到價格，並透過 Microsoft 365 系統管理中心購買附加元件。
