...
您可以將檔案附加到會議商務用 Skype，參與者可以開啟並下載。 附加到 商務用 Skype 會議的檔案會保留在信箱中，其信箱會置於訴訟保留狀態、已適用 Microsoft 365 或 Office 365 保留原則，或保留與 Microsoft 365 合規性中心電子檔探索案例相關聯的保留狀態。 此內容會儲存到 **參與者信箱中的** 可復原專案資料夾。
