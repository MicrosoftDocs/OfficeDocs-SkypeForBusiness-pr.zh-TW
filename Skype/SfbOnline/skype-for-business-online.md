---
title: 商務用 Skype Online 系統管理員
ms.reviewer: brandber
description: 瞭解如何為您的組織管理商務用 Skype Online。
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>新功能</h3>
                        <p><a href="/MicrosoftTeams/country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-canada">在加拿大撥打電話方案（一般可用性）</a></p>
                        <p><a href="/MicrosoftTeams/country-and-region-availability-for-audio-conferencing-and-calling-plans/availability-in-australia">在澳大利亞通話方案（僅限預覽版）</a></p>
                        <p><a href="/MicrosoftTeams/teams-powershell-overview.md">商務用 Skype Online 連接器與團隊 PowerShell 整合（僅限預覽版）</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>主要更新</h3>
                        <p><a href="/microsoftteams/audio-conferencing-in-office-365">設定音訊會議</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>附加元件授權</h3>
                        <p><a href="/SkypeForBusiness/skype-for-business-and-microsoft-teams-add-on-licensing/skype-for-business-and-microsoft-teams-add-on-licensing">商務用 Skype 和 Microsoft 團隊附加元件授權</a></p><p><a href="/MicrosoftTeams/what-are-communications-credits">什麼是通訊點數？</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>改善通話與視頻品質</h3>
                        <p><a href="https://support.office.com/article/ca302828-783f-425c-bbe2-356348583771">疑難排解商務用 Skype 中的連線問題</a></p><p><a href="https://support.office.com/article/62777bc6-c52b-47ae-84ba-a8905c3b71dc">疑難排解商務用 Skype 的音訊和影片</a></p><p><a href="https://support.office.com/article/beec23c2-c5d6-4e84-a8af-e82aefca7802">調整商務用 Skype Online 效能</a></p>
                    </div>
                </div>
            </div>
        </div>
