...
管理套件可與 System Center Operations Manager 2007 R2 (64 位) 搭配使用 (僅適用于遷移) 或 System Center Operations Manager 2012 SP1 &amp; R2 (64) 或 System Center operations manager 2016 (64 位)。 下表顯示商務用 Skype Server 2015 的管理套件支援的設定: 
...
|日前  <br/> |影片交互操作伺服器  <br/> |商務用 Skype Server 2015 中的新功能  <br/> |
