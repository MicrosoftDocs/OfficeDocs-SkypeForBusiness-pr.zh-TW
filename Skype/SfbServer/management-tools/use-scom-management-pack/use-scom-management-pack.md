...
**總結：** 瞭解如何設定商務用 Skype Server 2015 基礎結構，以與 System Center Operations Manager 搭配使用。
...
|組態|支援？|
|:-----|:-----|
|Windows Server 2008 R2 operating system  <br/> Windows Server 2012 R2 作業系統   |是。 在商務用 Skype Server 2015 伺服器及綜合交易觀察程式節點上。   |
|聚簇伺服器   |不支援。   |
|無代理監控   |不支援。   |
|虛擬環境   |是。   |
...
|:-----|:-----|
|商務用 Skype Server 部署   |代表組織中商務用 Skype Server 2015 的部署。   |
