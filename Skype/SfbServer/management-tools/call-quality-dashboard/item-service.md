...
|**一道**|**說明**|
|:-----|:-----|
|[取得項目](get-items.md) <br/> |[取得專案] 會傳回知識庫中的所有專案。  <br/> |
|[取得項目](get-item.md) <br/> |[取得專案] 會傳回特定專案。  <br/> |
|[取得子項目](get-sub-items.md) <br/> |[取得子專案] 會傳回特定專案的子專案。  <br/> |
|[取得項目上階](get-item-ancestors.md) <br/> |取得專案上級會傳回特定專案的上級。  <br/> |
|[更新項目](update-item.md) <br/> |更新存儲庫中的特定專案。  <br/> |
