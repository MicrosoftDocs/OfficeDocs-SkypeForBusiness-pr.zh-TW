...
## <a name="create-users-and-contacts"></a><span data-ttu-id="f43b8-110">建立使用者和連絡人</span><span class="sxs-lookup"><span data-stu-id="f43b8-110">Create Users and Contacts</span></span>
...
<span data-ttu-id="f43b8-124">您必須使用商務用 Skype Server 使用者預配工具來建立負載模擬的使用者和連絡人。</span><span class="sxs-lookup"><span data-stu-id="f43b8-124">You have to use the Skype for Business Server User Provisioning Tool to create users and contacts for load simulation.</span></span>
...
3. <span data-ttu-id="f43b8-138">在 [**密碼**] 欄位中，輸入將在所有測試使用者帳戶中使用的密碼。</span><span class="sxs-lookup"><span data-stu-id="f43b8-138">In the **Password** field, type a password that will be used across all the test user accounts.</span></span>
...
#### <a name="create-users-button"></a><span data-ttu-id="f43b8-148">[建立使用者] 按鈕</span><span class="sxs-lookup"><span data-stu-id="f43b8-148">Create Users button</span></span>
...
### <a name="to-configure-users-contacts-do-the-following"></a><span data-ttu-id="f43b8-176">若要設定使用者的連絡人，請執行下列動作：</span><span class="sxs-lookup"><span data-stu-id="f43b8-176">To configure users' contacts, do the following:</span></span>
...
#### <a name="distribution-list"></a><span data-ttu-id="f43b8-194">通訊群組清單</span><span class="sxs-lookup"><span data-stu-id="f43b8-194">Distribution List</span></span>
...
<span data-ttu-id="f43b8-215">如果您選擇測試此功能，請填寫表單中的值，然後按一下將會建立的 [產生 .LIS 配置檔案] 按鈕。名為的 CSV 檔案：</span><span class="sxs-lookup"><span data-stu-id="f43b8-215">If you choose to test this feature, fill in the values in the form and click the Generate LIS Config Files button, which will create .CSV files called:</span></span>
...
11. <span data-ttu-id="f43b8-256">在 [ **Port** ] （埠）欄位中，輸入您希望使用者使用的 SIP 埠（預設值為5061）。</span><span class="sxs-lookup"><span data-stu-id="f43b8-256">In the **Port** field, enter the port that you want users to use for SIP (the default here is 5061).</span></span>
...
- <span data-ttu-id="f43b8-266">**立即訊息-** 這包括對等與會議;針對載入層級選擇適當的值。</span><span class="sxs-lookup"><span data-stu-id="f43b8-266">**Instant Messaging -** This includes peer-to-peer and conferencing; choose the appropriate value for Load Level.</span></span>
...
- <span data-ttu-id="f43b8-284">選擇 [*隨機*] 會讓此工具產生一段時間內將建立的會議類比。</span><span class="sxs-lookup"><span data-stu-id="f43b8-284">Choosing  *Ad-hoc*  will allow the tool to generate simulation of conferences that will be created throughout the hour.</span></span>
...
- <span data-ttu-id="f43b8-332">目前**狀態與 P2P 立即訊息/音訊-** 選取 [負載等級] 的值，即可啟用行動模擬。</span><span class="sxs-lookup"><span data-stu-id="f43b8-332">**Presence and P2P Instant Messaging/Audio -** Select a value for Load Level to enable the Mobility simulation.</span></span>
...
<span data-ttu-id="f43b8-338">[摘要] 索引標籤會指出要在每個案例中使用的使用者。</span><span class="sxs-lookup"><span data-stu-id="f43b8-338">The Summary tab indicates which users to use for each of the scenarios.</span></span> 
...
### <a name="running-the-skype-for-business-server-2015-stress-and-performance-tool"></a><span data-ttu-id="f43b8-351">執行商務用 Skype Server 2015 應力與效能工具</span><span class="sxs-lookup"><span data-stu-id="f43b8-351">Running the Skype for Business Server 2015 Stress and Performance tool</span></span>
...
<span data-ttu-id="f43b8-363">若要讓工具顯示配置檔案中的值，請在前面`/displayfile`的命令中加入參數，使其看起來像這樣：</span><span class="sxs-lookup"><span data-stu-id="f43b8-363">To have the tool display the values in the configuration file, include the  `/displayfile` parameter on the preceding command, so that it looks like this:</span></span>
...
|<span data-ttu-id="f43b8-405">GetPresence 通話</span><span class="sxs-lookup"><span data-stu-id="f43b8-405">GetPresence Calls</span></span>  <br/> |<span data-ttu-id="f43b8-406">[取得目前狀態] 要求嘗試的總數。</span><span class="sxs-lookup"><span data-stu-id="f43b8-406">Total number of get presence request attempts.</span></span>  <br/> |
|<span data-ttu-id="f43b8-407">GetPresence 的 NNN 回應</span><span class="sxs-lookup"><span data-stu-id="f43b8-407">NNN Responses for GetPresence</span></span>  <br/> |<span data-ttu-id="f43b8-408">從伺服器接收的 nnn 回應碼總數目。</span><span class="sxs-lookup"><span data-stu-id="f43b8-408">Total number of nnn response codes received from the server.</span></span>  <br/> |
   
<span data-ttu-id="f43b8-409">**通訊錄服務資訊**</span><span class="sxs-lookup"><span data-stu-id="f43b8-409">**Address Book service information**</span></span>

|<span data-ttu-id="f43b8-410">**效能計數器**</span><span class="sxs-lookup"><span data-stu-id="f43b8-410">**Performance Counter**</span></span>|<span data-ttu-id="f43b8-411">**描述**</span><span class="sxs-lookup"><span data-stu-id="f43b8-411">**Description**</span></span>|
|:-----|:-----|
|<span data-ttu-id="f43b8-412">嘗試的 ABS 完整/增量檔案下載</span><span class="sxs-lookup"><span data-stu-id="f43b8-412">ABS Full/Delta File Downloads Attempted</span></span>  <br/> |<span data-ttu-id="f43b8-413">已嘗試完整或增量檔案下載要求的總數目。</span><span class="sxs-lookup"><span data-stu-id="f43b8-413">Total number of full or delta file download requests attempted.</span></span>  <br/> |
|<span data-ttu-id="f43b8-414">ABS 完整/Delta 檔案下載成功</span><span class="sxs-lookup"><span data-stu-id="f43b8-414">ABS Full/Delta File Downloads Succeeded</span></span>  <br/> |<span data-ttu-id="f43b8-415">已嘗試完整或增量檔案下載要求的總數目。</span><span class="sxs-lookup"><span data-stu-id="f43b8-415">Total number of full or delta file download requests attempted.</span></span>  <br/> |
|<span data-ttu-id="f43b8-416">通訊錄 Web 查詢服務相關計數器</span><span class="sxs-lookup"><span data-stu-id="f43b8-416">Address Book Web Query service related counters</span></span>  <br/> |<span data-ttu-id="f43b8-417">通訊錄檔案下載相關計數器。</span><span class="sxs-lookup"><span data-stu-id="f43b8-417">Address book file download related counters.</span></span>  <br/> |
|<span data-ttu-id="f43b8-418">嘗試 ABS 通話</span><span class="sxs-lookup"><span data-stu-id="f43b8-418">ABS WS Calls attempted</span></span>  <br/> |<span data-ttu-id="f43b8-419">嘗試的通訊錄 Web 查詢服務要求總數。</span><span class="sxs-lookup"><span data-stu-id="f43b8-419">Total number of Address Book Web Query service requests attempted.</span></span>  <br/> |
|<span data-ttu-id="f43b8-420">ABS WS 通話成功</span><span class="sxs-lookup"><span data-stu-id="f43b8-420">ABS WS Calls Succeeded</span></span>  <br/> |<span data-ttu-id="f43b8-421">傳回成功回應代碼之通訊錄 Web 查詢服務要求的總數。</span><span class="sxs-lookup"><span data-stu-id="f43b8-421">Total number of Address Book Web Query service requests that returned a successful response code.</span></span>  <br/> |
|<span data-ttu-id="f43b8-422">ABS WS 通話失敗</span><span class="sxs-lookup"><span data-stu-id="f43b8-422">ABS WS Calls Failed</span></span>  <br/> |<span data-ttu-id="f43b8-423">傳回錯誤回應代碼之通訊錄 Web 查詢服務要求的總數。</span><span class="sxs-lookup"><span data-stu-id="f43b8-423">Total number of Address Book Web Query service requests that returned an error response code.</span></span>  <br/> |
   
> [!NOTE]
> <span data-ttu-id="f43b8-424">此類別包含用來監視通訊錄服務（ABS）檔案下載和通訊錄網頁查詢服務要求的計數器。</span><span class="sxs-lookup"><span data-stu-id="f43b8-424">This category includes counters used to monitor Address Book service (ABS) file downloads and Address Book Web Query service requests.</span></span> 
  
<span data-ttu-id="f43b8-425">**通訊群組清單（DL）資訊**</span><span class="sxs-lookup"><span data-stu-id="f43b8-425">**Distribution List (DL) Information**</span></span>

|<span data-ttu-id="f43b8-426">**效能計數器**</span><span class="sxs-lookup"><span data-stu-id="f43b8-426">**Performance Counter**</span></span>|<span data-ttu-id="f43b8-427">**描述**</span><span class="sxs-lookup"><span data-stu-id="f43b8-427">**Description**</span></span>|
|:-----|:-----|
|<span data-ttu-id="f43b8-428">已嘗試來電</span><span class="sxs-lookup"><span data-stu-id="f43b8-428">Calls Attempted</span></span>  <br/> |<span data-ttu-id="f43b8-429">嘗試的通訊群組清單展開（DLX） web 服務要求總數。</span><span class="sxs-lookup"><span data-stu-id="f43b8-429">Total number of distribution list expansion (DLX) web service requests attempted.</span></span>  <br/> |
|<span data-ttu-id="f43b8-430">通話成功</span><span class="sxs-lookup"><span data-stu-id="f43b8-430">Calls Succeeded</span></span>  <br/> |<span data-ttu-id="f43b8-431">傳回成功回應代碼之 DLX web 服務要求的總數目。</span><span class="sxs-lookup"><span data-stu-id="f43b8-431">Total number of DLX web service requests that returned a successful response code.</span></span>  <br/> |
|<span data-ttu-id="f43b8-432">通話失敗</span><span class="sxs-lookup"><span data-stu-id="f43b8-432">Calls Failed</span></span>  <br/> |<span data-ttu-id="f43b8-433">傳回錯誤回應代碼之 DLX web 服務要求的總數。</span><span class="sxs-lookup"><span data-stu-id="f43b8-433">Total number of DLX web service requests that returned an error response code.</span></span>  <br/> |
   

  
> [!NOTE]
> <span data-ttu-id="f43b8-434">在啟用這些案例時，以下所列的效能計數器會列示在所有的語音 IP （VoIP）通話中，包括對轉送伺服器、A/V 會議伺服器、邊緣伺服器、回應群組應用程式，以及會議自動語音應答。</span><span class="sxs-lookup"><span data-stu-id="f43b8-434">The performance counters listed below report numbers for all Voice over IP (VoIP) calls, including calls to Mediation Server, A/V Conferencing Server, Edge Server, Response Group application, and Conference Auto Attendant, when these scenarios are enabled.</span></span> 
  
<span data-ttu-id="f43b8-435">**VoIP 基本資訊**</span><span class="sxs-lookup"><span data-stu-id="f43b8-435">**VoIP Basic Information**</span></span>

|<span data-ttu-id="f43b8-436">**效能計數器**</span><span class="sxs-lookup"><span data-stu-id="f43b8-436">**Performance Counter**</span></span>|<span data-ttu-id="f43b8-437">**描述**</span><span class="sxs-lookup"><span data-stu-id="f43b8-437">**Description**</span></span>|
|:-----|:-----|
|<span data-ttu-id="f43b8-438">使用中的通話</span><span class="sxs-lookup"><span data-stu-id="f43b8-438">Calls Active</span></span>  <br/> |<span data-ttu-id="f43b8-439">目前正在進行的傳入/傳出語音通話總數。</span><span class="sxs-lookup"><span data-stu-id="f43b8-439">Total number of incoming/outgoing voice calls ongoing currently.</span></span>  <br/> |
|<span data-ttu-id="f43b8-440">呼叫終止</span><span class="sxs-lookup"><span data-stu-id="f43b8-440">Calls Terminated</span></span>  <br/> |<span data-ttu-id="f43b8-441">已終止的傳入/傳出語音通話總數。</span><span class="sxs-lookup"><span data-stu-id="f43b8-441">Total number of incoming/outgoing voice calls already terminated.</span></span>  <br/> |
|<span data-ttu-id="f43b8-442">拒絕通話</span><span class="sxs-lookup"><span data-stu-id="f43b8-442">Calls Declined</span></span>  <br/> |<span data-ttu-id="f43b8-443">已拒絕的來電通話總數。</span><span class="sxs-lookup"><span data-stu-id="f43b8-443">Total number of incoming voice calls declined.</span></span>  <br/> |
|<span data-ttu-id="f43b8-444">已嘗試來電/撥出通話</span><span class="sxs-lookup"><span data-stu-id="f43b8-444">Incoming/Outgoing Calls Attempted</span></span>  <br/> |<span data-ttu-id="f43b8-445">已嘗試輸入/撥出語音通話的總數。</span><span class="sxs-lookup"><span data-stu-id="f43b8-445">Total number of incoming/outgoing voice calls attempted.</span></span>  <br/> |
|<span data-ttu-id="f43b8-446">已建立來電/撥出通話</span><span class="sxs-lookup"><span data-stu-id="f43b8-446">Incoming/Outgoing Calls Established</span></span>  <br/> |<span data-ttu-id="f43b8-447">已建立的傳入/傳出語音通話總數。</span><span class="sxs-lookup"><span data-stu-id="f43b8-447">Total number of incoming/outgoing voice calls established.</span></span>  <br/> |
|<span data-ttu-id="f43b8-448">呼叫已收到 NNN</span><span class="sxs-lookup"><span data-stu-id="f43b8-448">Calls Received NNN</span></span>  <br/> |<span data-ttu-id="f43b8-449">從伺服器接收的 nnn 回應碼總數目。</span><span class="sxs-lookup"><span data-stu-id="f43b8-449">Total number of nnn response codes received from the server.</span></span>  <br/> |
|<span data-ttu-id="f43b8-450">VoIP 傳遞率（%）</span><span class="sxs-lookup"><span data-stu-id="f43b8-450">VoIP Pass Rate (%)</span></span>  <br/> |<span data-ttu-id="f43b8-451">已建立的通話總數/嘗試的通話總數。</span><span class="sxs-lookup"><span data-stu-id="f43b8-451">Total calls established/Total calls attempted.</span></span>  <br/> |
   
<span data-ttu-id="f43b8-452">**回應群組服務通話資訊**</span><span class="sxs-lookup"><span data-stu-id="f43b8-452">**Response Group service Call Information**</span></span>

|<span data-ttu-id="f43b8-453">**效能計數器**</span><span class="sxs-lookup"><span data-stu-id="f43b8-453">**Performance Counter**</span></span>|<span data-ttu-id="f43b8-454">**描述**</span><span class="sxs-lookup"><span data-stu-id="f43b8-454">**Description**</span></span>|
|:-----|:-----|
|<span data-ttu-id="f43b8-455">使用中的通話</span><span class="sxs-lookup"><span data-stu-id="f43b8-455">Calls Active</span></span>  <br/> |<span data-ttu-id="f43b8-456">回應群組應用程式的使用中通話總次數。</span><span class="sxs-lookup"><span data-stu-id="f43b8-456">Total number of active calls to the Response Group application.</span></span>  <br/> |
|<span data-ttu-id="f43b8-457">已嘗試來電</span><span class="sxs-lookup"><span data-stu-id="f43b8-457">Calls Attempted</span></span>  <br/> |<span data-ttu-id="f43b8-458">嘗試的通話總次數。</span><span class="sxs-lookup"><span data-stu-id="f43b8-458">Total number of calls attempted.</span></span>  <br/> |
   
<span data-ttu-id="f43b8-459">**立即訊息（IM）通話資訊**</span><span class="sxs-lookup"><span data-stu-id="f43b8-459">**Instant Messaging (IM) Call Information**</span></span>

|<span data-ttu-id="f43b8-460">**效能計數器**</span><span class="sxs-lookup"><span data-stu-id="f43b8-460">**Performance Counter**</span></span>|<span data-ttu-id="f43b8-461">**描述**</span><span class="sxs-lookup"><span data-stu-id="f43b8-461">**Description**</span></span>|
|:-----|:-----|
|<span data-ttu-id="f43b8-462">使用中的通話</span><span class="sxs-lookup"><span data-stu-id="f43b8-462">Calls Active</span></span>  <br/> |<span data-ttu-id="f43b8-463">正在進行內傳/撥出的立即訊息通話總數。</span><span class="sxs-lookup"><span data-stu-id="f43b8-463">Total number of ongoing incoming/outgoing instant messaging calls.</span></span>  <br/> |
|<span data-ttu-id="f43b8-464">呼叫終止</span><span class="sxs-lookup"><span data-stu-id="f43b8-464">Calls Terminated</span></span>  <br/> |<span data-ttu-id="f43b8-465">已終止傳入/傳出立即訊息通話的總數。</span><span class="sxs-lookup"><span data-stu-id="f43b8-465">Total number of incoming/outgoing instant messaging calls already terminated.</span></span>  <br/> |
|<span data-ttu-id="f43b8-466">呼叫已收到 NNN</span><span class="sxs-lookup"><span data-stu-id="f43b8-466">Calls Received NNN</span></span>  <br/> |<span data-ttu-id="f43b8-467">從伺服器接收的 nnn 回應碼總數目。</span><span class="sxs-lookup"><span data-stu-id="f43b8-467">Total number of nnn response codes received from the server.</span></span>  <br/> |
|<span data-ttu-id="f43b8-468">接收/傳送的 IM 訊息</span><span class="sxs-lookup"><span data-stu-id="f43b8-468">IM Messages Received/Sent</span></span>  <br/> |<span data-ttu-id="f43b8-469">所有會話接收或傳送的訊息總數。</span><span class="sxs-lookup"><span data-stu-id="f43b8-469">Total number of messages received or sent for all sessions.</span></span>  <br/> |
|<span data-ttu-id="f43b8-470">已嘗試來電/撥出通話</span><span class="sxs-lookup"><span data-stu-id="f43b8-470">Incoming/Outgoing Calls Attempted</span></span>  <br/> |<span data-ttu-id="f43b8-471">嘗試的傳入/傳出立即訊息呼叫總數。</span><span class="sxs-lookup"><span data-stu-id="f43b8-471">Total number of incoming/outgoing instant messaging calls attempted.</span></span>  <br/> |
|<span data-ttu-id="f43b8-472">已建立來電/撥出通話</span><span class="sxs-lookup"><span data-stu-id="f43b8-472">Incoming/Outgoing Calls Established</span></span>  <br/> |<span data-ttu-id="f43b8-473">已建立的傳入/傳出立即訊息通話總數。</span><span class="sxs-lookup"><span data-stu-id="f43b8-473">Total number of incoming/outgoing instant message calls established.</span></span>  <br/> |
   
<span data-ttu-id="f43b8-474">**App 共用呼叫資訊**</span><span class="sxs-lookup"><span data-stu-id="f43b8-474">**App Sharing Call Information**</span></span>

|<span data-ttu-id="f43b8-475">**效能計數器**</span><span class="sxs-lookup"><span data-stu-id="f43b8-475">**Performance Counter**</span></span>|<span data-ttu-id="f43b8-476">**描述**</span><span class="sxs-lookup"><span data-stu-id="f43b8-476">**Description**</span></span>|
|:-----|:-----|
|<span data-ttu-id="f43b8-477">使用中的通話</span><span class="sxs-lookup"><span data-stu-id="f43b8-477">Calls Active</span></span>  <br/> |<span data-ttu-id="f43b8-478">正在進行中傳入/傳出應用程式共用通話的總數。</span><span class="sxs-lookup"><span data-stu-id="f43b8-478">Total number of ongoing incoming/outgoing application sharing calls.</span></span>  <br/> |
|<span data-ttu-id="f43b8-479">呼叫終止</span><span class="sxs-lookup"><span data-stu-id="f43b8-479">Calls Terminated</span></span>  <br/> |<span data-ttu-id="f43b8-480">已終止的傳入/傳出應用程式共用通話總數。</span><span class="sxs-lookup"><span data-stu-id="f43b8-480">Total number of incoming/outgoing application sharing calls already terminated.</span></span>  <br/> |
|<span data-ttu-id="f43b8-481">呼叫已收到 NNN</span><span class="sxs-lookup"><span data-stu-id="f43b8-481">Calls Received NNN</span></span>  <br/> |<span data-ttu-id="f43b8-482">從伺服器接收的 nnn 回應碼總數目。</span><span class="sxs-lookup"><span data-stu-id="f43b8-482">Total number of nnn response codes received from the server.</span></span>  <br/> |
|<span data-ttu-id="f43b8-483">已嘗試來電/撥出通話</span><span class="sxs-lookup"><span data-stu-id="f43b8-483">Incoming/Outgoing Calls Attempted</span></span>  <br/> |<span data-ttu-id="f43b8-484">嘗試的傳入/傳出應用程式共用呼叫總數。</span><span class="sxs-lookup"><span data-stu-id="f43b8-484">Total number of incoming/outgoing application sharing calls attempted.</span></span>  <br/> |
|<span data-ttu-id="f43b8-485">已建立來電/撥出通話</span><span class="sxs-lookup"><span data-stu-id="f43b8-485">Incoming/Outgoing Calls Established</span></span>  <br/> |<span data-ttu-id="f43b8-486">已建立的傳入/傳出應用程式共用通話總數。</span><span class="sxs-lookup"><span data-stu-id="f43b8-486">Total number of incoming/outgoing application sharing calls established.</span></span>  <br/> |
   
<span data-ttu-id="f43b8-487">**CAA 通話資訊**</span><span class="sxs-lookup"><span data-stu-id="f43b8-487">**CAA Call Information**</span></span>

|<span data-ttu-id="f43b8-488">**效能計數器**</span><span class="sxs-lookup"><span data-stu-id="f43b8-488">**Performance Counter**</span></span>|<span data-ttu-id="f43b8-489">**描述**</span><span class="sxs-lookup"><span data-stu-id="f43b8-489">**Description**</span></span>|
|:-----|:-----|
|<span data-ttu-id="f43b8-490">使用中的通話</span><span class="sxs-lookup"><span data-stu-id="f43b8-490">Calls Active</span></span>  <br/> |<span data-ttu-id="f43b8-491">目前正在進行中的內送/出局公用電話網絡（PSTN）通話總數。</span><span class="sxs-lookup"><span data-stu-id="f43b8-491">Total number of incoming/outgoing public switched telephone network (PSTN) calls ongoing currently.</span></span>  <br/> |
|<span data-ttu-id="f43b8-492">呼叫終止</span><span class="sxs-lookup"><span data-stu-id="f43b8-492">Calls Terminated</span></span>  <br/> |<span data-ttu-id="f43b8-493">已終止的傳入/傳出 PSTN 通話總數。</span><span class="sxs-lookup"><span data-stu-id="f43b8-493">Total number of incoming/outgoing PSTN calls already terminated.</span></span>  <br/> |
|<span data-ttu-id="f43b8-494">已嘗試來電/撥出通話</span><span class="sxs-lookup"><span data-stu-id="f43b8-494">Incoming/Outgoing Calls Attempted</span></span>  <br/> |<span data-ttu-id="f43b8-495">嘗試的傳入/傳出 PSTN 呼叫總數。</span><span class="sxs-lookup"><span data-stu-id="f43b8-495">Total number of incoming/outgoing PSTN calls attempted.</span></span>  <br/> |
|<span data-ttu-id="f43b8-496">已建立來電/撥出通話</span><span class="sxs-lookup"><span data-stu-id="f43b8-496">Incoming/Outgoing Calls Established</span></span>  <br/> |<span data-ttu-id="f43b8-497">已建立的傳入/傳出 PSTN 通話總數。</span><span class="sxs-lookup"><span data-stu-id="f43b8-497">Total number of incoming/outgoing PSTN calls established.</span></span>  <br/> |
   
<span data-ttu-id="f43b8-498">**會議資訊**</span><span class="sxs-lookup"><span data-stu-id="f43b8-498">**Conference Information**</span></span>

|<span data-ttu-id="f43b8-499">**效能計數器**</span><span class="sxs-lookup"><span data-stu-id="f43b8-499">**Performance Counter**</span></span>|<span data-ttu-id="f43b8-500">**描述**</span><span class="sxs-lookup"><span data-stu-id="f43b8-500">**Description**</span></span>|
|:-----|:-----|
|<span data-ttu-id="f43b8-501">即時立即訊息會議</span><span class="sxs-lookup"><span data-stu-id="f43b8-501">Active Instant Messaging Conferences</span></span>  <br/> |<span data-ttu-id="f43b8-502">即時立即訊息會議的總數。</span><span class="sxs-lookup"><span data-stu-id="f43b8-502">Total number of ongoing instant messaging conferences.</span></span>  <br/> |
|<span data-ttu-id="f43b8-503">活動音訊/視訊會議</span><span class="sxs-lookup"><span data-stu-id="f43b8-503">Active Audio/Video Conferences</span></span>  <br/> |<span data-ttu-id="f43b8-504">正在進行的音訊/視頻（A/V）會議總數。</span><span class="sxs-lookup"><span data-stu-id="f43b8-504">Total number of ongoing audio/video (A/V) conferences.</span></span>  <br/> |
|<span data-ttu-id="f43b8-505">使用中的應用程式共用會議</span><span class="sxs-lookup"><span data-stu-id="f43b8-505">Active Application Sharing Conferences</span></span>  <br/> |<span data-ttu-id="f43b8-506">正在進行的應用程式共用會議總數。</span><span class="sxs-lookup"><span data-stu-id="f43b8-506">Total number of ongoing application sharing conferences.</span></span>  <br/> |
|<span data-ttu-id="f43b8-507">參與者人數</span><span class="sxs-lookup"><span data-stu-id="f43b8-507">Number of Participants</span></span>  <br/> |<span data-ttu-id="f43b8-508">目前與會議連接的參與者總數。</span><span class="sxs-lookup"><span data-stu-id="f43b8-508">Total number of participants currently connected to conferences.</span></span>  <br/> |
|<span data-ttu-id="f43b8-509">會議排程失敗</span><span class="sxs-lookup"><span data-stu-id="f43b8-509">Conference Schedule Failure</span></span>  <br/> |<span data-ttu-id="f43b8-510">嘗試排程會議時失敗的總數。</span><span class="sxs-lookup"><span data-stu-id="f43b8-510">Total number of failures while trying to schedule a conference.</span></span>  <br/> |
|<span data-ttu-id="f43b8-511">加入會議失敗</span><span class="sxs-lookup"><span data-stu-id="f43b8-511">Join Conference Failure</span></span>  <br/> |<span data-ttu-id="f43b8-512">嘗試連線到會議時失敗的總數。</span><span class="sxs-lookup"><span data-stu-id="f43b8-512">Total number of failures while trying to connect to a conference.</span></span>  <br/> |
   
<span data-ttu-id="f43b8-513">**UCWA 用戶端計數器**</span><span class="sxs-lookup"><span data-stu-id="f43b8-513">**UCWA Client Counters**</span></span>

|<span data-ttu-id="f43b8-514">**效能計數器**</span><span class="sxs-lookup"><span data-stu-id="f43b8-514">**Performance Counter**</span></span>|<span data-ttu-id="f43b8-515">**描述**</span><span class="sxs-lookup"><span data-stu-id="f43b8-515">**Description**</span></span>|
|:-----|:-----|
|<span data-ttu-id="f43b8-516">成功的 IMMCU 連接總數</span><span class="sxs-lookup"><span data-stu-id="f43b8-516">Total Number of IMMCU Joins Succeeded</span></span>  <br/> |<span data-ttu-id="f43b8-517">已加入之立即訊息會議的總數。</span><span class="sxs-lookup"><span data-stu-id="f43b8-517">Total number of instant messaging conferences joined.</span></span>  <br/> |
|<span data-ttu-id="f43b8-518">成功的 DMCU 連接總數</span><span class="sxs-lookup"><span data-stu-id="f43b8-518">Total Number of DMCU Joins Succeeded</span></span>  <br/> |<span data-ttu-id="f43b8-519">已加入/V 會議的總數。</span><span class="sxs-lookup"><span data-stu-id="f43b8-519">Total number of A/V conferences joined.</span></span>  <br/> |
