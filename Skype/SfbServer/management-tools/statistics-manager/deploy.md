...
---
# <a name="deploy-statistics-manager-for-skype-for-business-server"></a>部署商務用 Skype Server 的統計資料管理器
...
您可以執行 StatsManWebSite (隨附于[商務用 Skype Server、即時統計管理員 (64 位)](https://www.microsoft.com/en-in/download/details.aspx?id=57518)) 並指定下列專案, 在主機電腦上安裝網站:
