...
ms.locfileid: "62389065"
---
# <a name="useragentdef-table"></a>UserAgentDef 表格
 
UserAgentDef 表會將使用者代理程式識別碼對應到代理程式的描述性名稱。 使用者代理程式是用來連接至商務用 Skype Server 2015 的軟體用戶端。 此表格已引進 Microsoft Lync Server 2013。
