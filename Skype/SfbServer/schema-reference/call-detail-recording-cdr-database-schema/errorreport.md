...
|**ApplicationId** <br/> |int  <br/> |Foreign  <br/> |傳送錯誤報表 (的伺服器，如果報告是從伺服器元件傳送) 中傳送。 如需詳細資訊，請參閱 [商務用 Skype Server 2015 中的應用程式表](application.md) 。 <br/> 此欄位是在 Microsoft Lync Server 2013 中引入的。  <br/> |
