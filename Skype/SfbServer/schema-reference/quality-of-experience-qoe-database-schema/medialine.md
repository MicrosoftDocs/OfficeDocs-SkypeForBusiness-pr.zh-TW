...
|安全性  <br/> |Tinyint  <br/> |安全設定檔正在使用中。 0為 [無]，1為 SRTP，2為 V1。  <br/> |
...
|CalleeInside  <br/> |稍微  <br/> |指出被呼叫者是否在商業網路內。 1代表被呼叫者是在商業網路內，0代表被呼叫者在網路以外。  <br/> |
...
|呼叫  <br/> |稍微  <br/> |指出來自來電者的統計資料是否已收到;1為 [是]，0為 [否]。  <br/> |
|方  <br/> |稍微  <br/> |指出是否已收到來自呼叫接收器的指標;1為 [是]，0為 [否]。  <br/> |
