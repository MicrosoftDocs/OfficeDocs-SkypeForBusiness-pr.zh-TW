...
|**PurgeHour** <br/> |int  <br/> ||指定要在進行資料庫清除時的當地時間。 時間是以 24 小時制指定，0 代表午夜 (12:00 AM)，而 23 則代表 11:00 PM。 請注意, 您只能指定一天中的小時數: 值為 10 (表示 10:00 AM), 但不允許值為 10:30 of 10.5 (表示 10:30 AM)。 預設值為 1 (1:00 AM)。 指定要在進行資料庫清除時的當地時間。 時間是以 24 小時制指定，0 代表午夜 (12:00 AM)，而 23 則代表 11:00 PM。 請注意, 您只能指定一天中的小時數: 值為 10 (表示 10:00 AM), 但不允許值為 10:30 of 10.5 (表示 10:30 AM)。 預設值為 1 (1:00 AM)。  <br/> |
