...
|DialogCategory  <br/> |稍微  <br/> |對話方塊類別：0是商務用 Skype 伺服器以轉送伺服器腿;1是通向 PSTN 閘道腿的中繼伺服器。  <br/> |
...
|CallerInside  <br/> |稍微  <br/> |指出來電者是否在間隔網路內：1表示呼叫者是在商業網路內，0代表來電者在網路以外。  <br/> |
|CalleeIPAddr  <br/> |var （50）  <br/> |被呼叫者的 IP 位址。 這可能是 IPv4 或 IPv6 位址。  <br/> |
|CalleePort  <br/> |int  <br/> |被呼叫者使用的埠。  <br/> |
|CalleeInside  <br/> |稍微  <br/> |指出被呼叫者是否在間隔網路內：1代表被呼叫者是在商業網路內，0代表被呼叫者在網路以外。  <br/> |
...
|CalleeVPN  <br/> |稍微  <br/> |指出呼叫者是否已經由虛擬專用網路連接：1是虛擬私人網路（VPN），0是非 VPN。  <br/> |
