...
您可以從商務用 Skype Server 的 [控制台] 或 [商務用 Skype 伺服器管理] 命令介面管理商務用 Skype Server PIN 原則。 使用下列程式來設定貴組織的 PIN 原則。
...
- [在商務用 Skype Server 中查看使用者 PIN 資訊](view-user-pin-information.md)
