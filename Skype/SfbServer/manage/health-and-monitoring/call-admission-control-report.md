...
|**名稱**|**您可以針對此專案進行排序嗎？**|**說明**|
|:-----|:-----|:-----|
|**具體** <br/> |不  <br/> |當您按一下此專案時, 報告會顯示指定會話的點對點工作階段詳細資料包告。  <br/> |
|**從使用者** <br/> |是的  <br/> |啟動會話之使用者的 SIP 位址。  <br/> |
|**給使用者** <br/> |是的  <br/> |受邀加入會話之使用者的 SIP 位址。  <br/> |
|**形式** <br/> |是的  <br/> |在會話期間使用的通訊形式 (例如音訊與影片)。  <br/> |
|**邀請時間** <br/> |是的  <br/> |將初始會話邀請傳送給 [寄件者] 使用者的日期和時間。  <br/> |
|**回應時間** <br/> |是的  <br/> |收到邀請接受的日期和時間。  <br/> |
|**結束時間** <br/> |是的  <br/> |會話結束的日期和時間。  <br/> |
...
|**名稱**|**您可以針對此專案進行排序嗎？**|**說明**|
|:-----|:-----|:-----|
|**會議 URI** <br/> |是的  <br/> |會議的唯一識別碼。 當您按一下此專案時, 報告會顯示個別的會議參與者。  <br/> |
|**召集人** <br/> |是的  <br/> |組織會議的使用者的 SIP 位址。  <br/> |
|**共** <br/> |是的  <br/> |在會議中使用的邊緣伺服器。  <br/> |
...
|**名稱**|**您可以針對此專案進行排序嗎？**|**說明**|
|:-----|:-----|:-----|
|**角色** <br/> |不  <br/> |會議參與者所扮演的角色 (例如, 簡報者)。  <br/> |
|**參加** <br/> |不  <br/> |會議參與者的 SIP 位址。  <br/> |
|**連通** <br/> |不  <br/> |參與者的網路連線 (通常是內部或外部的網路連線)。  <br/> |
|**模態** <br/> |不  <br/> |會議類型 (例如, A/V 會議)。  <br/> |
|**加入時間** <br/> |不  <br/> |參與者加入會議的日期和時間。  <br/> |
|**休假時間** <br/> |不  <br/> |參與者離開會議的日期和時間。  <br/> |
