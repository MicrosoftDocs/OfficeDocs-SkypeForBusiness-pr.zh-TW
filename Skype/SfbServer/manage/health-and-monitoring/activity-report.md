...
|**名稱**|**您可以針對此專案進行排序嗎？**|**說明**|
|:-----|:-----|:-----|
|**集區** <br/> |否  <br/> |在會議中使用的註冊機構池或邊緣伺服器的名稱。  <br/> |
|**日期/時間** <br/> |否  <br/> |舉行會議的日期和時間。  <br/> |
|**總額** <br/> |否  <br/> |參與者總數、總參與者分鐘數或會議總數。  <br/> |
...
|**名稱**|**您可以針對此專案進行排序嗎？**|**說明**|
|:-----|:-----|:-----|
|**會議服務器類型** <br/> |否  <br/> | 在會議中使用的伺服器類型，通常是下列其中一項： <br/>  網路會議服務器 <br/>  IM 會議伺服器 <br/>  電話會議伺服器 <br/>  防病毒會議服務器 <br/>  應用程式共用 <br/> |
|**日期/時間** <br/> |否  <br/> |舉行會議的日期和時間。  <br/> |
|**總額** <br/> |否  <br/> |參與者總數、總參與者分鐘數或會議總數。  <br/> |
