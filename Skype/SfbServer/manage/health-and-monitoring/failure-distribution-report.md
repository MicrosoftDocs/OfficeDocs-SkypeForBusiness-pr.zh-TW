...
|**名稱**|**您可以針對此專案進行排序嗎？**|**說明**|
|:-----|:-----|:-----|
|**排名** <br/> |不  <br/> |根據診斷識別碼, 失敗會話的相對排名。 診斷識別碼是附加至 SIP 訊息的唯一識別碼 (以 ms 診斷標頭形式), 它通常會在疑難排解錯誤中提供有用的資訊。  <br/> |
|**常見的診斷原因** <br/> |不  <br/> |在會話中產生的診斷 ID。  <br/> |
|**時段** <br/> |不  <br/> |產生指定診斷 ID 的失敗會話總數。  <br/> |
...
|**名稱**|**您可以針對此專案進行排序嗎？**|**說明**|
|:-----|:-----|:-----|
|**排名** <br/> |不  <br/> |根據會話類型 (例如音訊/視訊會議或對等檔案傳輸會話), 以失敗的會話為基礎的相對排名。  <br/> |
|**上方形式** <br/> |不  <br/> |會話類型。  <br/> |
|**時段** <br/> |不  <br/> |涉及指定模態的失敗會話總數。  <br/> |
...
|**名稱**|**您可以針對此專案進行排序嗎？**|**說明**|
|:-----|:-----|:-----|
|**排名** <br/> |不  <br/> |根據執行會話的註冊機構池或邊緣伺服器來找出失敗會話的相對等級。  <br/> |
|**頂層池** <br/> |不  <br/> |註冊機構池或邊緣伺服器的名稱。  <br/> |
|**時段** <br/> |不  <br/> |每個註冊機構池或邊緣伺服器的失敗會話總數。  <br/> |
...
|**名稱**|**您可以針對此專案進行排序嗎？**|**說明**|
|:-----|:-----|:-----|
|**排名** <br/> |不  <br/> |每個電腦的相對排名失敗的會話。  <br/> |
|**熱門來源** <br/> |不  <br/> |失敗會話中所涉及的電腦名稱稱。  <br/> |
|**時段** <br/> |不  <br/> |每個電腦的失敗會話總數。  <br/> |
...
|**名稱**|**您可以針對此專案進行排序嗎？**|**說明**|
|:-----|:-----|:-----|
|**排名** <br/> |不  <br/> |根據元件 (例如 ExumRouting、GroupChat 或 MediationServer) 進行失敗會話的相對排名。  <br/> |
|**上方元件** <br/> |不  <br/> |失敗會話中所涉及元件的名稱。  <br/> |
|**時段** <br/> |不  <br/> |每個元件的失敗會話總數。  <br/> |
...
|**名稱**|**您可以針對此專案進行排序嗎？**|**說明**|
|:-----|:-----|:-----|
|**排名** <br/> |不  <br/> |根據受邀加入會話的使用者, 對失敗的會話進行相對等級。  <br/> |
|**使用者頂端** <br/> |不  <br/> |受邀加入會話的使用者 SIP 位址。  <br/> |
|**時段** <br/> |不  <br/> |每個使用者的失敗會話總數。  <br/> |
...
|**名稱**|**您可以針對此專案進行排序嗎？**|**說明**|
|:-----|:-----|:-----|
|**排名** <br/> |不  <br/> |根據啟動會話的使用者, 失敗會話的相對等級。  <br/> |
|**使用者頂端** <br/> |不  <br/> |啟動會話之使用者的 SIP 位址。  <br/> |
|**時段** <br/> |不  <br/> |每個使用者的失敗會話總數。  <br/> |
...
|**名稱**|**您可以針對此專案進行排序嗎？**|**說明**|
|:-----|:-----|:-----|
|**排名** <br/> |不  <br/> |根據會話中所涉及的使用者代理程式 (軟體), 在失敗的會話中相對排名的依據。 例如: RTCC/4.0.0.0 入站路由/4.0.0.0。  <br/> |
|**最上層的使用者代理程式** <br/> |不  <br/> |失敗會話中所涉及之使用者代理程式的名稱。  <br/> |
|**時段** <br/> |不  <br/> |每個使用者代理程式失敗的會話總數。  <br/> |
