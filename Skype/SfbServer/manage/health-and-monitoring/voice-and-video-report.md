...
|**名稱**|**您可以針對此專案進行排序嗎？**|**說明**|
|:-----|:-----|:-----|
|**集區** <br/> |否  <br/> |用於通話的註冊機構池或邊緣伺服器的名稱。  <br/> |
|**日期/時間** <br/> |否  <br/> |通話發生的日期和時間週期。  <br/> |
...
|**名稱**|**您可以針對此專案進行排序嗎？**|**說明**|
|:-----|:-----|:-----|
|**通話類型** <br/> |否  <br/> | 指出所撥打的通話類型。 [值] 是下列其中一項： <br/>  UC 對 UC <br/>  UC 對 PSTN <br/>  PSTN 到 UC <br/>  PSTN 到 PSTN <br/> |
|**日期/時間** <br/> |否  <br/> |通話發生的日期和時間週期。  <br/> |
|**總額** <br/> |否  <br/> |[會話總數] 或 [總郵件數]。  <br/> |
...
|**名稱**|**您可以針對此專案進行排序嗎？**|**說明**|
|:-----|:-----|:-----|
|**活動類型** <br/> |否  <br/> | 指出在撥打電話時，用戶端是否已登入內部網路或外部網路。 值通常是下列其中一項： <br/>  內部 <br/>  外來 <br/>  混淆 <br/> |
|**日期/時間** <br/> |否  <br/> |通話發生的日期和時間週期。  <br/> |
|**總額** <br/> |否  <br/> |[會話總數] 或 [總郵件數]。  <br/> |
