...
|**名稱**|**您可以針對此專案進行排序嗎？**|**說明**|
|:-----|:-----|:-----|
|**會議總數** <br/> |不  <br/> |已舉行的會議總數。  <br/> |
|**會議會話總數** <br/> |不  <br/> |會議會話總數。 單一會議可以有多個會話;例如, 會議可能同時包含焦點會話和 MCU 會話。  <br/> |
|**總體會話失敗率** <br/> |不  <br/> |所有失敗的會議所占的百分比。  <br/> |
|**焦點會話** <br/> |不  <br/> |焦點會話總數。  <br/> |
|**焦點失敗率** <br/> |不  <br/> |失敗的焦點會話百分比。  <br/> |
|MCU 會話  <br/> |不  <br/> |MCU 會話總數。  <br/> |
|**MCU 失敗率** <br/> |不  <br/> |失敗的 MCU 會話百分比。  <br/> |
|**使用模態的 MCU 會話** <br/> |不  <br/> |MCU 會話總數, 依模態分組 (例如 IM 會議)。  <br/> |
|**依模態的失敗率** <br/> |不  <br/> |失敗的 MCU 會話百分比, 依模態分組 (例如 IM 會議)。  <br/> |
