...
|**名稱**|**您可以針對此專案進行排序嗎？**|**說明**|
|:-----|:-----|:-----|
|**為止** <br/> 這個指標的實際標題會根據所選的間隔而有所不同。  <br/> |不  <br/> |會議發生的日期和時間。  <br/> |
|**總會話數** <br/> |不  <br/> |會話總數, 包括成功的會話、失敗的會話 (預期的失敗與意外的失敗), 以及未分類的會話。  <br/> |
|**Average (毫秒)** <br/> |不  <br/> |參與者加入會議所需的平均時間 (以毫秒為單位)。  <br/> |
|**會話\< 2 秒, 大量** <br/> |不  <br/> |可在不超過2秒內加入會議的參與者人數。  <br/> |
|**會話\< 2 秒、百分比** <br/> |不  <br/> ||
|**會話2-5 秒、成交量** <br/> |不  <br/> |在2秒到5秒之間加入會議所需的參與者人數。  <br/> |
|**會話2-5 秒、百分比** <br/> |不  <br/> |在2秒到5秒之間加入會議所需的呼叫參與者總數的百分比。  <br/> |
|**會話5-10 秒、成交量** <br/> |不  <br/> |在5秒到10秒之間加入會議所需的參與者人數。  <br/> |
|**會話5-10 秒、百分比** <br/> |不  <br/> |在5秒和10秒之間加入會議所需的呼叫參與者總數的百分比。  <br/> |
|**會話\> 10 秒、成交量** <br/> |不  <br/> |需要10秒以上的參與者加入會議的人數。  <br/> |
|**會話\> 10 秒、百分比** <br/> |不  <br/> |需要10秒以上的時間來加入會議的呼叫參與者總數的百分比。  <br/> |
