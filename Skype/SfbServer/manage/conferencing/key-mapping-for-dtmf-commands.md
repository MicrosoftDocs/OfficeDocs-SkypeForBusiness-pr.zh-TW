...
若要管理 DTMF 命令使用的金鑰, 請使用商務用 Skype 伺服器管理命令介面, 並提供**CsDialinConferencingDtmfConfiguration**、 **CsDialinConferencingDtmfConfiguration**和**新的-CsDialinConferencingDtmfConfiguration** Cmdlet。
