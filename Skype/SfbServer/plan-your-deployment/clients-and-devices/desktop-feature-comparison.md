...
> [!NOTE]
> 商務用 Skype Web App 瀏覽器用戶端和 Skype 會議應用程式 Windows 10 應用程式只會提供 [會議支援](desktop-feature-comparison.md#BKMK_Conferencing)。 如需有關這些用戶端的詳細資訊，請參閱 [Plan For meeting (Web App 和會議應用程式) 用戶端 ](meetings-clients.md) 。
...
|新增自訂位置 |&#x2714;|&#x2714;|&#x2714;|&#x2714;||||||
|新增自訂附注 |&#x2714;|&#x2714;|&#x2714;|&#x2714;|&#x2714;|&#x2714;||&#x2714;|&#x2714;|
|在商務用 Skype Online 中無法使用「我的圖片」的任何公開網站中的相片 ()  |&#x2714;||&#x2714;|||||||
...
|檔案傳輸、共用 OneNote 頁面及 PowerPoint 批註的用戶端封存  <br/> 在商務用 Skype Online 中無法使用 () |&#x2714;||&#x2714;||&#x2714;|||||
...
- 變更問候語
- 群組來電接聽
- 未接來電通知電子郵件會在停用使用者狀態時產生，並使用舊版 Outlook 用戶端 (2013 或更早版本) 
