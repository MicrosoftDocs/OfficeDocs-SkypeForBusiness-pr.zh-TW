...
在商務用 Skype Server、Skype 會議應用程式（在 Windows 上）和商務用 Skype for Mac （Mac 版）都可作為從 CU5 開始的商務用 skype Web App 的取代，但提供替換應用程式需要啟用 Skype 會議 App 中所述的其他設定，[以取代商務用 Skype Web app （選用）](../../deploy/deploy-clients/deploy-web-downloadable-clients.md#SMA_Enable)。  如果啟用 Skype 會議應用程式和 Mac 版商務用 Skype，使用者將會從 Office 365 內容傳遞網路（CDN）下載最新版本的 app，而不是從商務用 Skype 伺服器下載。 針對商務用 Skype Server 2019，使用 Skype 會議應用程式和 Mac 版商務用 Skype 是唯一的選項。
...
|:-----|:-----|:-----|:-----|:-----|:-----|:-----|
|Windows 10  <br/> |是  <br/> |是  <br/> |不適用  <br/> |不適用  <br/> |不適用  <br/> |[是] &#x2778; <br/> |
|Windows 8.1 &#x2776; <br/> |不適用  <br/> |是  <br/> |不適用  <br/> |不適用  <br/> |不適用 <br/> |[是] &#x2778; <br/> |
|Windows 8 （以 Intel 為基礎） &#x2776; <br/> |不適用  <br/> |不適用  <br/> |是  <br/> |不適用 <br/> |不適用  <br/> |[是] &#x2778; <br/> |
|Windows 7 （含 SP1） &#x2777; <br/> |不適用  <br/> |是  <br/> |否  <br/> |否  <br/> |不適用 <br/>|[是] &#x2778; <br/> |
|Windows Server 2008 R2 （含 SP1） &#x2777; <br/> |不適用  <br/> |是  <br/> |是  <br/> |是  <br/> |不適用 <br/>|[是] &#x2778; <br/> |
|macOS 10.8 及更新版本（以 Intel 為基礎） &#x2777; <br/> |不適用  <br/> |不適用  <br/> |不適用  <br/> |不適用  <br/> |是  <br/> |是 <br/> |
