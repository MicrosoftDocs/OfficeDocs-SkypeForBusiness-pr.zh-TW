...
|啟用 Exchange UM 的 Enterprise Voice 使用者。  <br/> |在 Exchange UM 伺服器上，確定已建立整合通訊信箱原則，且每位使用者都有唯一的分機號碼指派，然後為使用者啟用整合通訊。  <br/> |Exchange 收件者系統管理員  <br/> |針對 Exchange 2010 或最新的 service pack，請參閱 [Enable a User for a 整合通訊](https://go.microsoft.com/fwlink/p/?LinkId=268701)。  <br/> 若為 Exchange 2013，請參閱 [整合通訊](https://go.microsoft.com/fwlink/p/?LinkId=266579)。  <br/> |
