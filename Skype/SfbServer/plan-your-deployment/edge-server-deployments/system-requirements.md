...
- 必須能夠發佈主控網站的所有內容。 根據預設，您可以使用 **/\\** _ 指令，大多數的網頁伺服器都可以辨識此指令，以表示「在網頁伺服器上發行所有內容」。 您也可以修改此指令，例如， _*/Uwca/ \\* *_，這表示「發行虛擬目錄 Ucwa 下的所有內容」。
...
- Exchange UM （適用于使用 Exchange *um _ 的* 遠端使用者）在 exchange 2013。
