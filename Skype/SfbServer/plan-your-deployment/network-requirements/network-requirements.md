...
> [!NOTE]
> 如果您使用 Windows Server 2012 或 Windows Server 2012 R2，您可能會對可用來在該平臺上管理 QoS 的一組新 Windows PowerShell Cmdlet 感興趣。 如需詳細資訊，請參閱[Windows PowerShell 中的網路 QoS Cmdlet](https://go.microsoft.com/fwlink/p/?LinkId=285379)。
