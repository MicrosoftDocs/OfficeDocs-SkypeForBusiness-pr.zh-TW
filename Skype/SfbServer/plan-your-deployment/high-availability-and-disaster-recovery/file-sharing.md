...
為了確保商務用 Skype Server 部署中的檔案共用具有高可用性，您可以使用分散式檔案系統 (DFS) 。 DFS 支援在相同的資料中心內，從一個檔案伺服器到另一個檔案伺服器的容錯移轉。 在大規模部署中，建議您使用使用 DFS 成對的專用檔案伺服器。 如需有關 Windows Server 2012 中 DFS 的詳細資訊，請參閱 [https://go.microsoft.com/fwlink/?LinkId=524384](https://go.microsoft.com/fwlink/?LinkId=524384) 。 如需有關 Windows Server 2008 上之 DFS 的資訊，請參閱 [https://go.microsoft.com/fwlink/p/?LinkId=524385](https://go.microsoft.com/fwlink/p/?LinkId=524385) 。
