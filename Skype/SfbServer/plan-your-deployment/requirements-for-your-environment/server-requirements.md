...
|網路  <br/> |1個雙埠網路介面卡，可使用 1 Gbps 或以上 (2 網路介面卡，但必須以單一 MAC 位址和單一 IP) 位址進行分組。  <br/> 前端伺服器、後端伺服器、Standard Edition 伺服器及 Persistent Chat server **不** 支援雙重或多穴設定。 <br/> 只要未對作業系統公開，而且正用來監視和管理伺服器硬體，您就可以使用無頻帶管理系統，例如 DRAC 或 ILO。 此案例不會組成多穴伺服器，而且支援此案例。  <br/> |
...
|Windows Server 2012 Datacenter安裝所有必要更新的作業系統。  <br/> |Windows Server 2012 Standard安裝所有必要更新的作業系統。  <br/> |
