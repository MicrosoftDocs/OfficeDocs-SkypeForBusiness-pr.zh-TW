...
摘要說明啟用 E9-1-1 in 商務用 Skype Server Enterprise Voice （取決於您是否有 SIP 主幹 E9-1-1 服務提供者或 ELIN 閘道）所需的步驟。
...
|[為商務用 Skype Server 中的 E9-1-1 啟用使用者](enable-users.md) <br/> |[為商務用 Skype Server 中的 E9-1-1 啟用使用者](enable-users.md) <br/> |
...
|[在商務用 Skype Server 中設計 E9-1-1 的 SIP 主幹](design-the-sip-trunk.md) <br/> |[在商務用 Skype 中包含安全性桌面伺服器](security-desk.md) <br/> |
|[在商務用 Skype 中包含安全性桌面伺服器](security-desk.md) <br/> |[規劃商務用 Skype Server 的位置原則](location-policies.md) <br/> |
