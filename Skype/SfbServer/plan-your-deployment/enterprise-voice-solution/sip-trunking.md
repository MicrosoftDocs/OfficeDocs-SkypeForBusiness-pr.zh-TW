...
SIP 主幹連線之服務提供者端的實作方式，會根據 ITSP 而不同。 如需部署資訊，請連絡服務提供者。 如需認證 SIP 主幹服務提供者的清單，請參閱 [Microsoft 整合通訊開啟互通性計畫網站](https://go.microsoft.com/fwlink/p/?LinkId=287029)。
...
> [!NOTE]
> 若為 SIP 主幹，強烈建議您部署獨立的轉送伺服器。 如需詳細資訊，請參閱部署檔中的 [部署轉送伺服器及定義對等](https://technet.microsoft.com/library/a684f1da-6671-4011-adf6-2db49e2528e2.aspx) 專案。
