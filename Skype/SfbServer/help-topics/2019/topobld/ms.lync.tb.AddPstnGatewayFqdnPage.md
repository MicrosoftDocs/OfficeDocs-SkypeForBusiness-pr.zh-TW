...
ms.locfileid: "60761201"
---
# <a name="define-the-pstn-gateway-fqdn"></a>定義 PSTN 閘道 FQDN

您可以指定公用交換電話網路 (PSTN) 閘道的完整功能變數名稱 (FQDN) ，該閘道會將您的企業語音元件連線至 PSTN 或專用交換機 (PBX) 。

如需詳細資訊，請參閱[PSTN connectivity components in 商務用 Skype Server](../../../plan-your-deployment/enterprise-voice-solution/pstn-connectivity.md)
