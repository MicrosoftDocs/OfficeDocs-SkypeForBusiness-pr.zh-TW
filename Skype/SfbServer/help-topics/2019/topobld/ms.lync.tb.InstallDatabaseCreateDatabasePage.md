...
> [!CAUTION]
> 您必須已為實例 (設定 SQL Server，如果必須開啟任何) 和防火牆埠才能容納要部署資料庫的實例。 如需詳細資訊，請參閱[Configure SQL Server](/previous-versions/office/lync-server-2013/lync-server-2013-configure-sql-server-for-lync-server)
