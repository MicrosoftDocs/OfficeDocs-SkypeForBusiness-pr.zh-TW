...
> [!CAUTION]
> 如果必須開啟任何) 和防火牆埠以容納要部署資料庫的實例，則必須已為實例設定 SQL Server (。 如需詳細資訊，請參閱 [CONFIGURE SQL Server](/previous-versions/office/lync-server-2013/lync-server-2013-configure-sql-server-for-lync-server)
