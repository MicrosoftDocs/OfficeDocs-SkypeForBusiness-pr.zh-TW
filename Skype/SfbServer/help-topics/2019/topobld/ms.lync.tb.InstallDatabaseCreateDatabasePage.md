...
---
# <a name="install-and-create-databases"></a>安裝並建立資料庫
...
> [!CAUTION]
> 必須已針對實例 (如果有的話) 設定 SQL Server, 而且必須開啟防火牆埠, 才能容納您要部署資料庫的實例。 如需詳細資訊, 請參閱[設定 SQL Server](https://technet.microsoft.com/library/375e5cc4-e436-46dc-9b02-5063f35cdcc1.aspx)
