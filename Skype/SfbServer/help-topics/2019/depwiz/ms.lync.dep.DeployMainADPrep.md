...
若要開始安裝商務用 Skype Server，您必須準備能主持伺服器與使用者的 Active Directory 網域服務架構、林及網域。 商務用 Skype Server 部署嚮導將引導您完成準備 Active Directory 所需的步驟（從架構開始，然後再移至林準備）。 確認 Active Directory 複製成功之後，您就可以準備每個要主持使用者或伺服器的網域。
