...
---
# <a name="verify-replication-of-schema-partition"></a>驗證架構分區的複製
...
6. 在架構容器底下, 搜尋 CN = ms-SIP-SchemaVersion。 如果此物件存在, 且**rangeUpper**屬性的值為 1150, 且**rangeLower**屬性的值為 3, 則架構已成功更新並複製。 如果此物件不存在, 或**rangeUpper**和**rangeLower**屬性的值不是指定的, 則架構並未被修改或未複製。
