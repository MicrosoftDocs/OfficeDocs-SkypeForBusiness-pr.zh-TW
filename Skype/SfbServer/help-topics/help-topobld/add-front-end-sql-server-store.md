...
如需有關 SQL Server 支援的詳細資訊，請參閱支援檔中的[資料庫軟體和群集支援](https://technet.microsoft.com/library/e05d0032-bbea-4e61-987d-d07b1c045fd5.aspx)。 如需有關為後端資料庫設定 SQL Server 的詳細資訊，請參閱部署檔中的[Lync server 2010 的 [設定 Sql server](https://technet.microsoft.com/library/375e5cc4-e436-46dc-9b02-5063f35cdcc1.aspx) ]。
