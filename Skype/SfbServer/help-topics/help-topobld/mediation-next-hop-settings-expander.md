...
如需有關中繼伺服器池或轉送伺服器的設定的詳細資訊，請參閱部署檔中[商務用 Skype server 2015 的拓撲](../../deploy/deploy-enterprise-voice/deploy-a-mediation-server.md)建立器中的 [部署轉送伺服器]。
