...
- **啟用呼叫許可控制**選取此設定以啟用 CAC。 清除此設定以針對您的整個網路停用 CAC。 若要啟用 CAC，您必須將您的網路設定為 CAC。 如需詳細資訊，請參閱部署檔中的[商務用 Skype Server 2015 中的 [部署呼叫許可控制](../../deploy/deploy-enterprise-voice/deploy-call-admission-control.md)]。
