...
如需有關中央管理存放區的詳細資訊，請參閱 [Move The Lync server 2010 Central Management Server To Lync server 2013](/previous-versions/office/lync-server-2013/move-the-lync-server-2010-central-management-server-to-lync-server-2013)。
