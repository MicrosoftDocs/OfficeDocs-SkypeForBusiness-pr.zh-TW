...
---
# <a name="add-edge-server-options-for-lync-server-2010"></a>新增 Lync Server 2010 的 Edge Server 選項
...
- **啟用同盟（埠5061）**：如果您要與其他 SIP 聯合體、提供者或使用會話初始通訊協定（SIP）的託管產品進行聯盟，請選取此核取方塊。

- **此 edge 池的外部 ip 位址是由 NAT 來轉譯**：如果您針對 edge 外部介面使用私人 IP 位址，並提供網路位址轉譯（NAT）裝置，以邏輯方式放置邊緣伺服器或邊緣池，請選取此核取方塊。
