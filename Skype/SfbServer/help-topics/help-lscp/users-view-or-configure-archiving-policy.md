...
ms.locfileid: "58623955"
---
# <a name="users-view-or-configure-archiving-policy"></a>使用者：檢視或設定封存原則

您要執行的工作 按一下您要執行之任務的連結。

- [指派 Per-User 封存原則](/previous-versions/office/lync-server-2013/lync-server-2013-assign-a-per-user-archiving-policy)

- [將封存原則套用至使用者或使用者群組](/previous-versions/office/lync-server-2013/lync-server-2013-applying-an-archiving-policy-to-users)
