...
使用正確的類別，就能更輕鬆地建立及管理持續聊天室。 持續性聊天管理員可以定義每個類別的**AllowedMembers**和**創意者**，也可以定義預設的聊天室設定和行為，這些動作會套用至在類別中建立的所有聊天室。 持續聊天系統管理員使用商務用 Skype Server 的 [控制台] 或 [Windows PowerShell Cmdlet] 來建立及管理類別。
...
[使用類別管理持久聊天伺服器](https://technet.microsoft.com/library/dfcb3ad1-da90-467e-b08c-f4e68673b7b5.aspx)

[將聊天室從一個類別移至另一個類別](https://technet.microsoft.com/library/7e93b8f6-5a18-4476-a432-3918e01bcfa6.aspx)

[建立或編輯新的聊天室](https://technet.microsoft.com/library/aa8f4349-cfd9-4036-9c4d-de8fb2c4c8a4.aspx)
