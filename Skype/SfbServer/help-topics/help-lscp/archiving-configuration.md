...
- 與 Exchange 2013 儲存體整合，供位於 Exchange 2013 的使用者使用
...
> [!NOTE]
> 封存設定會套用至位於商務用 Skype Server 上的使用者，而且如果您使用 Exchange 將封存資料儲存在 Microsoft Exchange 中，則在 Exchange 2013 上的使用者，但是會以稍有不同的方式來執行 Exchange 2013 上的使用者。 其差異會在下一節中說明。 
