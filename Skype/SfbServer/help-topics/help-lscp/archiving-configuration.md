...
- 與 Exchange 中的使用者整合 Exchange 2013 儲存空間（針對駐留在 Exchange 2013 的使用者）
...
> [!NOTE]
> 封存設定適用于駐留在商務用 Skype Server 的使用者，而且如果您使用 Exchange 將存檔資料儲存在 Microsoft Exchange 中，則是駐留在 Exchange 2013 的使用者，但在 Exchange 2013 上的使用者的執行方式稍有不同。 下一節將說明此不同之處。 
