...
ms.locfileid: "54323165"
---
# <a name="bandwidth-policy-profile"></a>頻寬原則設定檔

您要執行的工作 按一下您要執行之任務的連結。

- [設定頻寬原則設定檔](/previous-versions/office/lync-server-2013/lync-server-2013-creating-or-modifying-bandwidth-policy-profiles)
