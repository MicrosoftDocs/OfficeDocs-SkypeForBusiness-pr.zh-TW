...
我們強烈建議您複習本主題中提到的工作，然後針對貴組織中的 Lync Server 部署執行適當的程式。
...
|如果您部署了監控伺服器，請檢視監控伺服器報告，以便檢視使用方式和診斷資訊。  <br/> |**首頁** <br/> |[在商務用 Skype 中管理運作狀況與監控](../../manage/health-and-monitoring/health-and-monitoring.md) <br/> |
