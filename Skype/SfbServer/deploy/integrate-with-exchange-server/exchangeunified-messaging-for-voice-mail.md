...
> [!IMPORTANT]
> 如果您想要使用 Exchange 整合訊息 (UM) 來提供呼叫應答、Outlook Voice Access 或適用于企業語音使用者的自動助理服務, 請參閱[商務用 Skype 中的 Exchange 整合訊息整合規劃](../../plan-your-deployment/integrate-with-exchange/unified-messaging.md), 然後依照本節中的指示。 
