...
**摘要：** 在 Exchange Server 2019、Exchange Server 2016、Exchange Server 2013 或 Exchange Online 及商務用 Skype Server 中設定高解析度相片的使用。
  
在商務用 Skype Server 中，相片可以儲存在使用者的 Exchange Server 2019、Exchange Server 2016、Exchange Server 2013 或 Exchange Online 信箱中，這可讓相片大小達到648圖元的648圖元。 此外，Exchange Server 可以根據需要自動調整這些相片的大小，以供不同的產品使用。 通常這表示三種不同的相片大小與解析度：
