...
2. 選取 [**安裝] 或 [移除商務用 Skype Server 元件**]。
    
3. 選取 [ **要求]，安裝或指派憑證**。
    
4. 選取 [ **啟動服務**]。
    
目前已安裝及執行此服務的軟體。 您可以開啟服務 mmc 工具，查看 **商務用 Skype Server 的視頻 Interop 伺服器** 服務是否與其他商務用 Skype Server 服務一起執行。 接下來，您必須設定 VIS 伺服器或集區。
