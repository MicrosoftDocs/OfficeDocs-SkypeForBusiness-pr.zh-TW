...
請閱讀本主題，瞭解如何在商務用 Skype Server 2015 （2015年11月累計更新）中部署共用線條外觀（SLA）。 SLA 是一項功能，可在稱為共用號碼的特定號碼上處理多個通話。

如需此功能的詳細資訊，請參閱[在商務用 Skype Server 2015 中規劃共用線外觀](../../plan-your-deployment/enterprise-voice-solution/shared-line-appearance.md)。

共用線外觀（SLA）是商務用 Skype Server 中的新功能，2015年11月累計更新。 若要啟用此功能，您必須先部署此累積更新。
