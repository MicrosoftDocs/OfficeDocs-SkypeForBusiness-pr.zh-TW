...
1. 在商務用 Skype Server 控制台中，按一下 [ **語音路由** ]，然後按一下 [ **主幹** 設定]。
...
5. 在 [ **商務用 Skype 伺服器控制台** ] 對話方塊中，按一下 **[確定**]。
    
6. 如果您改變心意決定不要刪除集合，請按一下 **[認可]**，然後按一下 **[取消所有未認可的變更]**。 當 [ **商務用 Skype Server 控制台** ] 對話方塊出現時，按一下 **[確定]**。
...
您可以使用商務用 Skype Server 管理命令介面和 **get-cstrunkconfiguration** Cmdlet 來刪除主幹設定設定。 您可以從商務用 Skype Server 管理命令介面或從商務用 Skype Server 管理命令介面的遠端會話中執行此 Cmdlet。
