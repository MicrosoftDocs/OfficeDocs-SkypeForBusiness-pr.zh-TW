...
**總結：** 瞭解如何安裝商務用 Skype Server 安裝所需的管理工具。 從 Microsoft 評估中心下載免費試用版商務用 Skype Server，網址如下： [https://www.microsoft.com/evalcenter/evaluate-skype-for-business-server](https://www.microsoft.com/evalcenter/evaluate-skype-for-business-server) 。
...
5. 商務用 Skype Server 核心元件將會安裝在伺服器上。 
   ...
   - **商務用 Skype Server 部署嚮導** 可提供啟動墊以安裝各種商務用 Skype Server 元件的部署程式。
    
   - **商務用 Skype Server 管理命令** 介面：可供管理商務用 Skype Server 的預先設定 PowerShell 程式。
...
8. 完成安裝後，請按一下 **[完成]**。 系統管理工具現在已新增至伺服器，如圖所示。
   ...
   - **商務用 Skype Server 拓撲** 產生器，用來建立、部署及管理拓撲的程式。
