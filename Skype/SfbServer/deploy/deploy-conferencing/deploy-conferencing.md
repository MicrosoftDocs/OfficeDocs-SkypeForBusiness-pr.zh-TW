...
|**將行 URI 指派給使用者帳戶** <br/> |使用商務用 Skype Server 控制台或商務用 Skype Server 管理命令介面，將電話語音列 **URI** 設定為唯一且正規化的電話號碼 (例如， `tel:+14255550200`) 。 <br/> |RTCUniversalServerAdmins  <br/> CsAdministrator  <br/> CsUserAdministrator  <br/> |[將行 URI 指派給使用者帳戶](dial-in-conferencing.md#BKMK_AssignaLineURI) <br/> |
