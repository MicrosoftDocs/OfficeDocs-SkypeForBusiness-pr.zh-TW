...
- Office 365 方案必須包含商務用 Skype Online 方案 2, 或 Office 365 E1、E3 或 E5。 <br/>如需商務用 Skype Online 方案的詳細資料, 請參閱[商務用 Skype Online 服務說明](https://technet.microsoft.com/library/jj822172.aspx)。
...
- 若要使用企業語音功能 entitle 會議室, 讓會議室可以使用電話號碼來啟用, 必須有手機系統授權或 Office 365 E5 的商務用 Skype Online 方案 2 (1)。
