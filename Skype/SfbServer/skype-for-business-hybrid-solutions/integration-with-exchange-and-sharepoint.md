...
|會議委派  <br/> |只有在兩位使用者都位於相同樹系中的線上，或兩者都位於內部部署時，才受支援。 如需詳細資訊，請參閱 [設定商務用 Skype Server 和團隊之間的混合](../../SfbHybrid/hybrid/configure-hybrid-connectivity.md)式連線。 <br/> |
