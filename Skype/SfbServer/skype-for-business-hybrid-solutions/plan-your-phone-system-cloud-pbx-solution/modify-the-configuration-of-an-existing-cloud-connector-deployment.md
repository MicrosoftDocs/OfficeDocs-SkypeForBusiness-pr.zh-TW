...
---
# <a name="modify-the-configuration-of-an-existing-cloud-connector-deployment"></a>修改現有雲端連接器部署的設定
...
3. 
    ...
    如果新憑證的密碼與舊版相同, 則會成功匯入。 如果密碼不同, 您會收到錯誤訊息, 指出密碼錯誤, 而且您必須執行 CcAppliance Cmdlet 與-Local 參數, 然後重複步驟 2, 以重設密碼。 
