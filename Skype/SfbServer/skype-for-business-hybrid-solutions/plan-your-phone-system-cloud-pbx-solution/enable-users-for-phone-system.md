...
- 若要瞭解如何設定混合式連線，請參閱 [規劃商務用 Skype server 與商務用 Skype online 之間的混合式連線](../../../SfbHybrid/hybrid/plan-hybrid-connectivity.md?bc=%2fSkypeForBusiness%2fbreadcrumb%2ftoc.json&toc=%2fSkypeForBusiness%2ftoc.json) ，以及 [在商務用 Skype server 與商務用 Skype online 之間部署混合](../../../SfbHybrid/hybrid/configure-hybrid-connectivity.md?bc=%2fSkypeForBusiness%2fbreadcrumb%2ftoc.json&toc=%2fSkypeForBusiness%2ftoc.json)式連接。
...
將使用者移至商務用 Skype Online 之前，建議您先在商務用 Skype Server 或 Lync Server 2013 中，啟用您的使用者，然後再將其移動到線上。 如需詳細資訊，請參閱 [規劃商務用 Skype Server 與商務用 Skype Online 的混合式連線](../../../SfbHybrid/hybrid/plan-hybrid-connectivity.md?bc=%2fSkypeForBusiness%2fbreadcrumb%2ftoc.json&toc=%2fSkypeForBusiness%2ftoc.json) ，以及在使用者執行內部部署) 時， [啟用使用者的企業語音語音](enable-the-users-for-enterprise-voice-on-premises.md) (的特殊考慮一節。 
...
- [將內部部署使用者移至商務用 Skype Online](../../../SfbHybrid/hybrid/move-users-from-on-premises-to-skype-for-business-online.md) (執行使用 Windows PowerShell 內部部署，但使用 Office 365 系統管理員認證) 。
