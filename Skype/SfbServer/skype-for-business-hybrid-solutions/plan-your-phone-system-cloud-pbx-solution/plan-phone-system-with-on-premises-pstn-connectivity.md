...
---
# <a name="plan-phone-system-with-on-premises-pstn-connectivity-in-skype-for-business-server"></a>在商務用 Skype Server 中規劃具有內部部署 PSTN 連線的電話系統
...
如果您已在內部部署中部署商務用 Skype Server 或 Lync Server 2013，則此內容是相關的。 如需其他案例，請參閱[Microsoft 電話語音解決方案](https://docs.microsoft.com/SkypeForBusiness/hybrid/msft-telephony-solutions)。
 ...
 使用內部部署 PSTN 連線的電話系統可讓您為使用者利用電話系統（Cloud PBX）功能。 這可協助您進行下列案例：
...
| 下一個躍點同盟路由內部集區伺服器  <br/> | 商務用 Skype Server 2015，年 3 2016 月累積更新6.0.9319.235 或更高版本（前端或 Director）  <br/> |
...
- **推薦Active Directory Federation Services （AD FS）。** 建議您部署 AD FS 以支援單一登入。 如需詳細資訊，請參閱[Active Directory Federation Services （AD FS）](https://technet.microsoft.com/library/cc736690%28v=ws.10%29.aspx)。
