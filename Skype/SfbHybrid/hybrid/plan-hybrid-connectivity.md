...
使用者必須已獲指派商務用 Skype Online （方案2）授權，使用者才能在線上移動。 如果使用者使用的是小組，也必須指派小組授權（而且商務用 Skype 授權必須保持啟用）。 如果您的使用者想要利用其他線上功能（例如音訊會議或電話系統），您必須在 Microsoft 365 或 Office 365 中指派適當的授權。
