---
title: 商務用 Skype Server 2019 控制台驗證腳本
ms.reviewer: rogupta
ms.author: heidip
...
---
# <a name="skype-for-business-server-2019-control-panel-authentication-script"></a><span data-ttu-id="21ff7-103">商務用 Skype Server 2019 控制台驗證腳本</span><span class="sxs-lookup"><span data-stu-id="21ff7-103">Skype for Business Server 2019 control panel authentication script</span></span>

<span data-ttu-id="21ff7-104">以下是新式系統管理員控制台的驗證相關 helper 腳本 (MACP) 。</span><span class="sxs-lookup"><span data-stu-id="21ff7-104">Following are the authentication related helper scripts for Modern Admin Control Panel (MACP).</span></span>

## <a name="configure-macp-authentication-with-microsoft-365-or-office-365"></a><span data-ttu-id="21ff7-105">使用 Microsoft 365 或 Office 365 設定 MACP 驗證</span><span class="sxs-lookup"><span data-stu-id="21ff7-105">Configure MACP authentication with Microsoft 365 or Office 365</span></span>

<span data-ttu-id="21ff7-106">安裝商務用 Skype Server 2019 累積更新1或更新版本時，應執行此腳本，以供您設定新的 [控制台] 的一部分。</span><span class="sxs-lookup"><span data-stu-id="21ff7-106">This script should be run after installing Skype for Business Server 2019 Cumulative Update 1 or later, as part of the set-up for the new Control Panel.</span></span> 
...
```
## <a name="configure-macp-application-in-adfs-farm"></a><span data-ttu-id="21ff7-107">在 ADFS 伺服器陣列中設定 MACP 應用程式</span><span class="sxs-lookup"><span data-stu-id="21ff7-107">Configure MACP application in ADFS Farm</span></span>

<span data-ttu-id="21ff7-108">安裝商務用 Skype Server 2019 最新的累計更新後，應執行此腳本，以供您設定新控制台的一部分。</span><span class="sxs-lookup"><span data-stu-id="21ff7-108">This script should be run after installing Skype for Business Server 2019 latest Cumulative Update, as part of the set-up for the new Control Panel.</span></span>
...
```
## <a name="configure-oauth-for-macp"></a><span data-ttu-id="21ff7-109">設定 MACP 的 OAuth</span><span class="sxs-lookup"><span data-stu-id="21ff7-109">Configure OAuth for MACP</span></span>

<span data-ttu-id="21ff7-110">安裝商務用 Skype Server 2019 最新的累計更新後，應執行此腳本，以供您設定新控制台的一部分。</span><span class="sxs-lookup"><span data-stu-id="21ff7-110">This script should be run after installing Skype for Business Server 2019 latest Cumulative Update, as part of the set-up for the new Control Panel.</span></span>
