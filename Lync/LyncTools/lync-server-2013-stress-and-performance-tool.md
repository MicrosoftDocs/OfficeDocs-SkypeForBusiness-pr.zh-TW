...
4.  [設定 Lync Server 2013 案例](configure-lync-server-2013-scenarios.md)

5.  [建立使用者和連絡人](create-users-and-contacts.md)

6.  [設定使用者設定檔](configure-user-profile.md)
