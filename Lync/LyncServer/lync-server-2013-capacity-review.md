...
# <a name="capacity-review-in-lync-server-2013"></a>在 [Lync Server 2013 的容量檢閱
...
檢閱上個月，容量數字，並產生任何升級，接下來的月份可能需要讓貴組織的 Sla 所指定的限制內操作系統的計劃。
