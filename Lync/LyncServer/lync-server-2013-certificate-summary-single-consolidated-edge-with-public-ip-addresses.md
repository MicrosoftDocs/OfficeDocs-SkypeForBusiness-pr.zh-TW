...
# <a name="certificate-summary---single-consolidated-edge-with-public-ip-addresses-in-lync-server-2013"></a>Lync Server 2013 中的憑證摘要 - 含公用 IP 位址的單一合併 Edge
...
## <a name="certificates-required-for-single-consolidated-edge-with-public-ip-addresses"></a>使用公用 IP 位址的單一合併邊緣所需的憑證
