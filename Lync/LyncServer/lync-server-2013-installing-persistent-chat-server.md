...
# <a name="installing-persistent-chat-server-in-lync-server-2013"></a>在 Lync Server 2013 中安裝常設聊天室伺服器
...
安裝永久性聊天伺服器已整合至 Lync Server 2013 設定，並使用 Lync Server 2013 用來進行安裝的相同引導程式。 如需安裝指示，請參閱部署檔中的 [[部署 Lync Server 2013](lync-server-2013-deploying-lync-server.md) ]。
