...
# <a name="trusted-applications-cmdlets-in-lync-server-2013"></a>Lync Server 2013 中受信任的應用程式 Cmdlet
...
受信任的應用程式是由協力廠商所開發的協力廠商所開發的應用程式，該應用程式是以 Microsoft Lync Server 2013 的一部分提供，但不是產品內建的元件。 Lync Server 2013 提供可用於設定及管理受信任的應用程式的 Cmdlet。

<div>

## <a name="trusted-applications-cmdlets"></a>受信任的應用程式 Cmdlet

使用下列 Cmdlet 來管理受信任的應用程式。
