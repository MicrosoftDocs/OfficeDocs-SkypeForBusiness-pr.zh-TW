...
ms.locfileid: "48515130"
---
# <a name="monitoredregionlink-table-in-lync-server-2013"></a>Lync Server 2013 中的 MonitoredRegionLink 表格
...
MonitoredRegionLink 表格是支援的表格。 每筆記錄代表兩個國家/地區之間的一個連結。
...
<td><p>int</p></td>
<td><p>主要、外部</p></td>
<td><p><a href="lync-server-2013-region-table.md">在 Lync Server 2013 中從地區表</a>參考。</p></td>
</tr>
<tr class="even">
