...
---
# <a name="advanced-enterprise-voice-cmdlets-in-lync-server-2013"></a>Lync Server 2013 中的高級 Enterprise Voice Cmdlet
...
在組織中實作企業語音的同時，您也可以實作其他功能與應用程式，以便提升使用者經驗和組織效率。這些功能包括通話許可控制、增強型 9-1-1 (E9-1-1) 緊急通話和媒體組態設定。

<div>

## <a name="advanced-enterprise-voice-cmdlets"></a>進階 Enterprise Voice Cmdlet

下表包含的 Cmdlet，可供您管理企業語音部署的進階功能：

**[Lync Server 2013 中的通話許可控制 Cmdlet](lync-server-2013-call-admission-control-cmdlets.md)**
...
**[Lync Server 2013 中的增強型 9-1-1 Cmdlet](lync-server-2013-enhanced-9-1-1-cmdlets.md)**
...
**[共用線外觀 (SLA) Cmdlet](shared-line-appearance-sla-cmdlets.md)**
...
**[Lync Server 2013 中的媒體旁路 Cmdlet](lync-server-2013-media-bypass-cmdlets.md)**
...
**[Lync Server 2013 中的媒體配置 Cmdlet](lync-server-2013-media-configuration-cmdlets.md)**
