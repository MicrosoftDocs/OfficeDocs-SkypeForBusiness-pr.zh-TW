...
# <a name="advanced-enterprise-voice-cmdlets-in-lync-server-2013"></a>Lync Server 2013 中的進階的 Enterprise Voice cmdlet
...
**[Lync Server 2013 中通話許可控制 cmdlet](lync-server-2013-call-admission-control-cmdlets.md)**
...
**[增強型 9-1-1 Lync Server 2013 中的 cmdlet](lync-server-2013-enhanced-9-1-1-cmdlets.md)**
...
**[共用的線外觀 (SLA) cmdlet](shared-line-appearance-sla-cmdlets.md)**
...
**[媒體旁路 Lync Server 2013 的 cmdlet](lync-server-2013-media-bypass-cmdlets.md)**
...
**[Lync Server 2013 中的媒體組態 cmdlet](lync-server-2013-media-configuration-cmdlets.md)**
