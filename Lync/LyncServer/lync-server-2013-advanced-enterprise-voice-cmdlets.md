...
# <a name="advanced-enterprise-voice-cmdlets-in-lync-server-2013"></a>Lync Server 2013 中的 [高級企業語音] Cmdlet
...
當您在組織中實現企業語音時，您也可以選擇實現其他功能和應用程式，以改善使用者體驗及貴組織的效能。 這些功能包括通話許可控制、增強的9-1-1 （E9-1-1）緊急通話，以及媒體配置設定。

<div>

## <a name="advanced-enterprise-voice-cmdlets"></a>高級企業語音 Cmdlet

下列清單所含的 Cmdlet 可讓您管理企業語音部署的高級功能：

**[在 Lync Server 2013 中呼叫許可控制 Cmdlet](lync-server-2013-call-admission-control-cmdlets.md)**
