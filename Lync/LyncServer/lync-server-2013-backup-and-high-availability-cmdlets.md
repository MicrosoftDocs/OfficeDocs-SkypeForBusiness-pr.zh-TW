...
[備份] 和 [高可用性] Cmdlet 可讓系統管理員管理 Microsoft Lync Server 2013 中所引進的 [池備份]、[還原] 和 [高可用性] 功能。

<div>

## <a name="backup-and-high-availability-cmdlets"></a>備份和高可用性 Cmdlet

以下是直接相關的 Cmdlet 清單，可與備份及設定 Lync Server 拓撲的可用性進行關聯：
