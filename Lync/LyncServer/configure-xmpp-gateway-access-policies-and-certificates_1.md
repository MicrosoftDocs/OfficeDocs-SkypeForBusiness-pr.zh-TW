...
> [!NOTE]  
> 若要開始 XMPP 閘道遷移，您需要部署 Lync Server 2013 XMPP 閘道，並設定存取原則，以讓 Lync Server 2013 的使用者能夠 XMPP 閘道。 在執行這些步驟之前，必須先將所有使用者移至 Lync Server 2013 部署。 如需詳細資訊，請參閱<A href="configure-xmpp-gateway-on-lync-server-2013_1.md">在 Lync Server 2013 上設定 XMPP 閘道</A>。
