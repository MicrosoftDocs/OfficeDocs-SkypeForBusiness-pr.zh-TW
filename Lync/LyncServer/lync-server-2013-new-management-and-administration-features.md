...
description: Lync Server 2013：新增管理功能。
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
Lync Server 2013 包含下列新功能，可簡化管理部署的工作。
  ...
  - [拓撲產生器支援 Lync Server 2013 中的 SQL Server 鏡像](lync-server-2013-topology-builder-supports-sql-server-mirroring.md)

  - [Lync Server 2013 中的新角色存取控制功能](lync-server-2013-has-new-role-based-access-control-features.md)

  - [整合 Lync Server 2013 中的持續性聊天管理工具](lync-server-2013-integration-of-persistent-chat-management-tools.md)
