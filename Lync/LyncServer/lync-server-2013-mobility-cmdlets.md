...
# <a name="mobility-cmdlets-in-lync-server-2013"></a>Lync Server 2013 中的行動 Cmdlet
...
引入行動 Cmdlet 是為了管理在 Lync Server 2010 的累積更新中新增的行動性功能：2011年11月。 使用這些 Cmdlet 來管理行動性功能的設定，例如行動服務設定和使用者原則。

<div>

## <a name="mobility-cmdlets"></a>行動 Cmdlet

[設定行動性功能的 Cmdlet] 可讓您從 Lync Server 管理命令介面執行命令，或撰寫腳本來設定及測試各種行動設定。
