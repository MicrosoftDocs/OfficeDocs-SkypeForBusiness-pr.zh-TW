...
description: Lync Server 2013：語音正常化規則 Cmdlet。
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48553049"
---
# <a name="voice-normalization-rules-cmdlets-in-lync-server-2013"></a>Lync Server 2013 中的語音正規化規則 Cmdlet
...
語音正規化規則是用來轉換電話撥號需求 (例如，撥打9以存取外線) Microsoft Lync Server 2013 所使用的 e.164 電話號碼格式。

<div>

## <a name="voice-normalization-rules-cmdlets"></a>Voice Normalization Rules Cmdlets

下列 Cmdlet 可用來管理語音正常化規則。
