...
Microsoft Lync Server 2013 隨附超過700個 Cmdlet，讓系統管理員可以從命令列管理 Lync Server 2013。 Lync Server Cmdlet 一般會搭配 Lync Server 管理命令介面使用。 使用 Lync Server 管理命令介面的其中一種方法，就是登入執行 Lync Server 服務或伺服器角色的電腦，依序按一下 [ **開始**]、[ **所有程式**]、[ **Microsoft Lync server 2013**]，然後按一下 [ **Lync server 管理命令**介面]。 管理命令介面開啟之後，您可以直接從命令列取得 Cmdlet 的說明，方法是輸入如下的命令：

    Get-Help New-CsVoicePolicy -Full

上述命令會檢索可用於 **New-CsVoicePolicy** Cmdlet 的完整説明。 若要查看其他 Cmdlet 的說明，請以您想要取得 help 之 Cmdlet 的名稱取代 **New-CsVoicePolicy** 。

若要取得可用於管理 Lync Server 的完整 Cmdlet 清單，請在 Lync Server 管理命令介面命令提示字元處，輸入下列命令：

    Get-Command * -Module Lync -CommandType cmdlet

如需使用 Lync Server 管理命令介面的詳細資訊，請參閱 Lync Server Windows PowerShell 博客，網址為 [https://go.microsoft.com/fwlink/p/?linkId=203150](https://go.microsoft.com/fwlink/p/?linkid=203150) 。
...
以下是 Lync Server 2013 隨附的 Cmdlet 清單：
  ...
  - [停用 Get-csuser](https://technet.microsoft.com/library/Gg398747(v=OCS.15))
  ...
  - [授與 Get-csclientversionpolicy](https://technet.microsoft.com/library/Gg412903(v=OCS.15))
  ...
  - [新 Set-csclientversionconfiguration](https://technet.microsoft.com/library/Gg399029(v=OCS.15))
  ...
  - [Remove-Set-csclientversionconfiguration](https://technet.microsoft.com/library/Gg425925(v=OCS.15))
  ...
  - [Remove-New-csexumcontact](rehttps://technet.microsoft.com/library/Gg425842(v=OCS.15))
  ...
  - [Remove-Get-cspresencepolicy](https://technet.microsoft.com/library/Gg399070(v=OCS.15))

  - [Remove-CsPresenceProvider](https://technet.microsoft.com/library/JJ205036(v=OCS.15))

  - [Remove-Get-csprivacyconfiguration](https://technet.microsoft.com/library/Gg425821(v=OCS.15))
  ...
  - [Remove-Get-csuserservicesconfiguration](https://technet.microsoft.com/library/Gg398722(v=OCS.15))
  ...
  - [CsMediaConfiguration](https://technet.microsoft.com/library/Gg398580(v=OCS.15))
  ...
  - [Get-csrgsholidayset](https://technet.microsoft.com/library/Gg398736(v=OCS.15))
