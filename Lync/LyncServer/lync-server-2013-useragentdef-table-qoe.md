...
# <a name="useragentdef-table-qoe-in-lync-server-2013"></a>Lync Server 2013 中的 UserAgentDef table （QoE）
...
UserAgentDef 表格會將使用者代理程式識別碼對應至代理程式的描述性名稱。 使用者代理是用來連線至 Microsoft Lync Server 2013 的軟體用戶端。
