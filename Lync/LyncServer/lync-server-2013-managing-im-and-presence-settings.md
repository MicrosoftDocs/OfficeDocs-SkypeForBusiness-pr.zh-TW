...
description: Lync Server 2013：管理 IM 和顯示狀態設定。
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48557499"
---
# <a name="managing-im-and-presence-settings-in-lync-server-2013"></a>在 Lync Server 2013 中管理 IM 及顯示狀態設定
...
本節中的主題會針對您可以使用 Lync Server 2013 控制台中的 **IM 和目前狀態** 群組執行的工作，提供逐步程式。
...
## <a name="in-this-section"></a>本章節內容
  ...
  - [在 Lync Server 2013 中指派每一使用者的目前狀態原則](lync-server-2013-assigning-per-user-presence-policies.md)
