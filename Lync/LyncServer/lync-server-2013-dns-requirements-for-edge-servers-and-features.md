...
---
# <a name="dns-requirements-for-edge-servers-and-features-in-lync-server-2013"></a>Lync Server 2013 中 Edge Server 和功能的 DNS 需求
...
Lync Server 2013 Edge server、Edge 集區和反向 proxy 具有網域名稱系統 (DNS) 記錄的特定需求。 在 Lync Server 2013 中，當使用 IPv4 和 IPv6 時，您必須同時規劃主機 A 和 AAAA 記錄。

下列主題所列的主題為您的部署規劃定義 DNS 記錄的使用：
