...
# <a name="dns-requirements-for-edge-servers-and-features-in-lync-server-2013"></a>Lync Server 2013 中 Edge 伺服器與功能的 DNS 需求
...
Lync Server 2013 Edge 伺服器、邊緣池及反向代理程式都有對網域名稱系統（DNS）記錄的特定需求。 在 Lync Server 2013 中，當您使用 IPv4 與 IPv6 時，您必須規劃主機 A 和 AAAA 記錄。

下列主題定義您的部署規劃的 DNS 記錄的使用方式：
