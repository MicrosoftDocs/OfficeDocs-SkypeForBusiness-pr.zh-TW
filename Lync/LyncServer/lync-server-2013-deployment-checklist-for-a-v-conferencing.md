...
---
# <a name="deployment-checklist-for-av-conferencing-in-lync-server-2013"></a>Lync Server 2013 中 A/V 會議的部署檢查清單
...
與其他 Lync Server 2013 元件的部署一樣，部署 A/V 會議需要您使用拓撲產生器來建立及發佈併入會議的拓撲。
