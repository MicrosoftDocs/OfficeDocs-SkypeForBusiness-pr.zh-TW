---
title: Lync Server 2013： 的常設聊天室伺服器的憑證需求
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
# <a name="certificate-requirements-for-persistent-chat-server-in-lync-server-2013"></a>在 [Lync Server 2013 常設聊天室伺服器的憑證需求
...
若要安裝 Persistent Chat Server，您必須為 Lync Server 2013 的內部伺服器所使用的每個伺服器正在執行之常設聊天室 Web 服務的檔案上傳/下載中的同一個 CA 所發出的憑證。 請確定您具有必要的憑證之前開始的常設聊天室的安裝，尤其是如果您使用外部 CA。
