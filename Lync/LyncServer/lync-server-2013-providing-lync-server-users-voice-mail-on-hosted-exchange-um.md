...
description: Lync Server 2013：在主控 Exchange UM 上提供 Lync Server 使用者語音信箱。
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48555859"
---
# <a name="providing-lync-server-2013-users-voice-mail-on-hosted-exchange-um"></a>在主控 Exchange UM 上提供 Lync Server 2013 使用者語音信箱
...
本節會引導您完成使用主控 Exchange 整合通訊 (UM) 服務上的語音信箱，在內部部署 Lync Server 2013 部署中提供使用者的處理常式。
...
## <a name="in-this-section"></a>本章節內容
  ...
  - [在 Lync Server 2013 中管理主控語音信箱原則](lync-server-2013-manage-hosted-voice-mail-policies.md)

  - [在 Lync Server 2013 中啟用使用者的主控語音信箱功能](lync-server-2013-enable-users-for-hosted-voice-mail.md)

  - [在 Lync Server 2013 中建立主控 Exchange UM 的連絡人物件](lync-server-2013-create-contact-objects-for-hosted-exchange-um.md)
