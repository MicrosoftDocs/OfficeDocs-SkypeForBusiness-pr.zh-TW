...
# <a name="planning-for-clients-and-devices-in-lync-server-2013"></a>規劃用戶端和 Lync Server 2013 中的裝置
...
本節中的主題說明如何規劃 Lync Server 2013 用戶端與您組織中的裝置。
...
## <a name="in-this-section"></a>本章節內容
  ...
  - [規劃 Lync Server 2013 中的裝置](lync-server-2013-planning-for-devices.md)
