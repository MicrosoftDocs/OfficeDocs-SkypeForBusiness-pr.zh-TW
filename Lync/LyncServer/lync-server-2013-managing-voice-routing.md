...
description: Lync Server 2013：管理語音路由。
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
本節中的主題會針對您可以使用 Lync Server [控制台] 中的 [ **語音路由** ] 群組執行的工作，提供逐步程式。

<div>

## <a name="in-this-section"></a>本章節內容

  - [在 Lync Server 2013 中定義轉譯規則和正常化規則](lync-server-2013-defining-translation-rules-and-normalization-rules.md)
