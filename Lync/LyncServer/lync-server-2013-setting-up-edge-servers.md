...
ms.locfileid: "48509680"
---
# <a name="setting-up-edge-servers-in-lync-server-2013"></a>在 Lync Server 2013 中設定 Edge server
...
## <a name="in-this-section"></a>本章節內容
  ...
  - [在 Lync Server 2013 的 Edge Server 上安裝必要軟體](lync-server-2013-install-prerequisite-software-on-edge-servers.md)
