...
# <a name="topology-builder-supports-sql-server-mirroring-in-lync-server-2013"></a>Lync Server 2013 中的拓撲產生器支援 SQL Server 鏡像
...
Lync Server 2013 支援鏡像後端伺服器以提供高可用性。 您可以使用 [拓撲建立器] 來設定鏡像，包括設定見證。
