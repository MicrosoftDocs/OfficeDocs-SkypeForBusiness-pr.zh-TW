...
---
# <a name="topology-builder-supports-sql-server-mirroring-in-lync-server-2013"></a>拓撲產生器支援 Lync Server 2013 中的 SQL Server 鏡像
...
Lync Server 2013 支援鏡像後端伺服器以取得高可用性。 您可以使用拓撲產生器來設定鏡像，包括設定見證。
