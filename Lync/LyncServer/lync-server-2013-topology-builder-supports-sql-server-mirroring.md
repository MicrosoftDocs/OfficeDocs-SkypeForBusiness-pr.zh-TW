...
# <a name="topology-builder-supports-sql-server-mirroring-in-lync-server-2013"></a>拓撲產生器支援 SQL Server 鏡像在 Lync Server 2013
...
Lync Server 2013 支援的您後端伺服器高可用性鏡像。 您可以使用拓撲產生器，以設定鏡像，包括設定見證。
