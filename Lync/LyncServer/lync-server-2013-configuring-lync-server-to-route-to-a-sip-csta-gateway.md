---
title: Lync Server 2013：設定 Lync Server 以路由傳送至 SIP/CSTA 閘道
description: Lync Server 2013：設定 Lync Server 以路由傳送至 SIP/CSTA 閘道。
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48570819"
---
# <a name="configuring-lync-server-2013-to-route-to-a-sipcsta-gateway"></a>設定 Lync Server 2013 以路由傳送至 SIP/CSTA 閘道
...
SIP/CSTA 閘道是 SIP 和電腦支援之電信應用程式 (CSTA) 之間的閘道。 SIP/CSTA 閘道提供現有專用交換機 (PBX) 和 Lync Server 之間的介面，用以將遠端呼叫控制要求路由傳送至 PBX。 安裝 SIP/CSTA 閘道之後，您必須在每個要設定遠端呼叫控制的 Lync 伺服器集區上執行下列程式：
