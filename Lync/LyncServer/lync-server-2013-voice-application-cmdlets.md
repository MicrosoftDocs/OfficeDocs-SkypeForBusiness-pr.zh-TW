...
ms.locfileid: "48508500"
---
# <a name="voice-application-cmdlets-in-lync-server-2013"></a>Lync Server 2013 中的語音應用程式 Cmdlet
...
語音應用程式會執行於前端伺服器上的應用程式服務。 這些應用程式可讓您使用寄存通話、處理未指派號碼、與 Exchange 整合通訊 (UM) ，以及執行回應群組應用程式，協助您管理來電和撥出電話。

<div>

## <a name="voice-application-cmdlets"></a>語音應用程式 Cmdlet

下列是處理語音應用程式的 Cmdlet 清單：

**[Lync Server 2013 中的通話駐留應用程式 Cmdlet](lync-server-2013-call-park-application-cmdlets.md)**
...
**[Lync Server 2013 的回應群組應用程式 Cmdlet](lync-server-2013-response-group-application-cmdlets.md)**
...
**[Lync Server 2013 中未指派的號碼 Cmdlet](lync-server-2013-unassigned-number-cmdlets.md)**
