...
# <a name="deploying-advanced-enterprise-voice-features-in-lync-server-2013"></a>在 Lync Server 2013 中部署高級企業語音功能
...
為貴組織設定基本的企業語音功能之後，您可以根據本節中的程式，選擇部署一或多個高級企業語音功能。

如需有關高級企業語音功能的詳細資訊，請參閱[Lync Server 2013 規劃](lync-server-2013-planning.md)的下列各節：
