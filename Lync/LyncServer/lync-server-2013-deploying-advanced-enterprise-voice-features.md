...
---
# <a name="deploying-advanced-enterprise-voice-features-in-lync-server-2013"></a>在 Lync Server 2013 中部署高級 Enterprise Voice 功能
...
如需有關高級 Enterprise Voice 功能的詳細資訊，請參閱 [規劃 Lync Server 2013](lync-server-2013-planning.md) 檔的下列各節：
