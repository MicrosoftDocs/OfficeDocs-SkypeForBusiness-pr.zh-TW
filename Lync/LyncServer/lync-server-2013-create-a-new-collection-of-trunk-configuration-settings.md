...
---
# <a name="create-a-new-collection-of-trunk-configuration-settings-in-lync-server-2013"></a>在 Lync Server 2013 中建立主幹設定的新集合
...
使用 Lync Server 控制台建立 SIP 主幹設定設定時，您可以使用下列選項：
...
> [!NOTE]  
> Lync Server Get-cstrunkconfiguration Cmdlet 支援未顯示在 Lync Server 控制台中的其他屬性。 如需詳細資訊，請參閱 <A href="https://docs.microsoft.com/powershell/module/skype/New-CsTrunkConfiguration">get-cstrunkconfiguration</A> Cmdlet 的 [說明] 主題。
...
## <a name="to-create-new-trunk-configuration-settings-by-using-lync-server-control-panel"></a>使用 Lync Server 控制台建立新主幹設定設定
