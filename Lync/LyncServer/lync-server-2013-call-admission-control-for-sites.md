...
# <a name="call-admission-control-for-sites-in-lync-server-2013"></a>在 Lync Server 2013 中呼叫許可控制網站
...
Network sites 是呼叫許可控制（CAC）、E9-1 及媒體旁路部署的每個網路區域內的辦公室或位置。 使用本節中的程式來設定網路網站的呼叫許可控制。

<div>

## <a name="in-this-section"></a>本節內容

  - [在 Lync Server 2013 中查看網路網站資訊](lync-server-2013-viewing-network-site-information.md)
