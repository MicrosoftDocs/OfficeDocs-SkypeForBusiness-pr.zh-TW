...
# <a name="call-admission-control-for-sites-in-lync-server-2013"></a>Lync Server 2013 中網站的通話許可控制
...
## <a name="in-this-section"></a>本章節內容
  ...
  - [Lync Server 2013 中檢視網路網站資訊](lync-server-2013-viewing-network-site-information.md)

  - [建立或修改 Lync Server 2013 中的網路網站](lync-server-2013-creating-or-modifying-network-sites.md)

  - [刪除現有網路網站在 Lync Server 2013](lync-server-2013-deleting-an-existing-network-site.md)
