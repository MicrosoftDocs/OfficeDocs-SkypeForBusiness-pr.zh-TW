...
# <a name="mediationservers-table-in-lync-server-2013"></a>Lync Server 2013 中的 MediationServers 表格
...
MediationServers 表格是一種支援資料表。 每一筆記錄資料庫中擁有記錄的通話中儲存的相關資訊的一部中繼伺服器的相關資訊。
