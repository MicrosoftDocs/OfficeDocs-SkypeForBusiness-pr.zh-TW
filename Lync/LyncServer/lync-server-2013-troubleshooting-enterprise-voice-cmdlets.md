...
將企業語音設定為 Microsoft Lync Server 2013 的一部分，包括建立必須共同作業的路線、原則與規則，以確保撥入和撥出通話如期完成。 Lync Server 管理命令介面包含可用來測試連線和路徑的 Cmdlet，以及疑難排解在實施期間可能發生的問題。

<div>

## <a name="troubleshooting-enterprise-voice-cmdlets"></a>疑難排解企業語音 Cmdlet

下列 Cmdlet 可以用來測試及疑難排解企業語音連線。
