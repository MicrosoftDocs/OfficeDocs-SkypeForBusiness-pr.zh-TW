...
# <a name="administrator-rights-and-permissions-required-for-setup-and-administration-of-lync-server-2013"></a>設定和管理 Lync Server 2013 所需的系統管理員權限
...
安裝和部署 Lync Server 2013 需要使用者安裝和部署軟體成為本機或網域層級群組的成員。 Lync Server 2013 的管理工具可能需要額外的許可權。
