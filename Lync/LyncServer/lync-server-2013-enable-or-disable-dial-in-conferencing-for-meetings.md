...
---
# <a name="enable-or-disable-dial-in-conferencing-for-meetings-in-lync-server-2013"></a>在 Lync Server 2013 中啟用或停用電話撥入式會議
...
## <a name="to-enable-or-disable-dial-in-conferencing"></a>啟用或停用電話撥入式會議
