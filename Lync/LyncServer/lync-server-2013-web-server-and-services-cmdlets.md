...
# <a name="web-server-and-services-cmdlets-in-lync-server-2013"></a>Lync Server 2013 中的 web 伺服器和服務 cmdlet
...
Microsoft Lync Server 2013 的許多元件是 web 式： 這些元件可以使用 Web 服務或網頁來執行其工作。 Web 伺服器和 Web 服務 Cmdlet 可讓您進行諸如設定 Web 伺服器設定及管理簡單 URL 等工作。 簡單 Url，方便使用者加入會議與會議，並讓系統管理員登入 Lync Server 2013 控制台更容易。
