...
# <a name="quality-of-experience-qoe-database-schema-in-lync-server-2013"></a>Lync Server 2013 中的經驗 (QoE) 資料庫結構描述的品質
...
本主題記載 Microsoft Lync Server 2010 通訊軟體中的經驗品質 (QoE) 資料庫結構的描述。
