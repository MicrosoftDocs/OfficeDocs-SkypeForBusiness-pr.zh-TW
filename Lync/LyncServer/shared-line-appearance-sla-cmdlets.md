...
# <a name="shared-line-appearance-sla-cmdlets"></a>共用線外觀（SLA） Cmdlet
...
與單行外觀相關的 Cmdlet （SLA）可讓您使用多個可以挑選該線路的代理人來設定共用的電話號碼。
