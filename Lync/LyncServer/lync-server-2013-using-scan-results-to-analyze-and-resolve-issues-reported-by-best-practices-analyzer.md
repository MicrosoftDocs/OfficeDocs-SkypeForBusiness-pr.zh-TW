...
當您在 Lync Server 2013 環境中執行 Lync Server 2013 的最佳作法分析工具時，該工具會使用掃描結果，以產生您的部署問題報告。 您可以使用最佳做法分析程式所產生的報告，識別並解決特定問題。
...
## <a name="in-this-section"></a>本章節內容
  ...
  - [在 Lync Server 2013 中查看和使用最佳做法分析程式建立的報表](lync-server-2013-viewing-and-working-with-reports-created-by-best-practices-analyzer.md)

  - [分析和解決 Lync Server 2013 中的最佳做法分析程式所識別的問題](lync-server-2013-analyzing-and-resolving-issues-identified-by-best-practices-analyzer.md)
