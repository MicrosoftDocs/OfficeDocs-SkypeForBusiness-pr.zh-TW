...
Microsoft Lync Server 2013 中包含的使用者管理 Cmdlet 可讓您啟用、停用及修改 Lync Server 使用者帳戶。

<div>

## <a name="user-management-cmdlets"></a>使用者管理 Cmdlet

您可以從 Lync Server 控制台執行大多數適用于使用者和使用者帳戶的管理工作。 主要例外狀況是處理音訊會議提供者的 Cmdlet。 您可以使用 Lync Server 管理命令介面或腳本中的 Cmdlet 執行使用者管理工作。 您可以利用指令碼來自動執行某些工作。 以下是與管理使用者和使用者帳戶直接相關的 Cmdlet 清單：
...
<!-- end list -->
  ...
  - <span></span>  
    [停用 Get-csuser](https://docs.microsoft.com/powershell/module/skype/Disable-CsUser)
