...
包含 Microsoft Lync Server 2013 中的使用者管理 cmdlet 可讓您啟用、 停用，並修改 Lync Server 使用者帳戶。

<div>

## <a name="user-management-cmdlets"></a>使用者管理 Cmdlet

從 Lync Server Control Panel 可執行大部分適用於使用者和使用者帳戶的管理工作。 主要的例外狀況是處理音訊會議提供者的 cmdlet。 使用者管理工作可以使用 cmdlet 從 Lync Server 管理命令介面或中執行指令碼。 您可以利用指令碼來自動執行某些工作。 以下是 cmdlet 的與管理使用者和使用者帳戶直接相關清單：
...
<!-- end list -->
  ...
  - [叫用 CsUcsRollback](https://docs.microsoft.com/powershell/module/skype/Invoke-CsUcsRollback)

<!-- end list -->

  - [偵錯 CsUnifiedContactStore](https://docs.microsoft.com/powershell/module/skype/Debug-CsUnifiedContactStore)
...
<!-- end list -->
  ...
  - <span></span>  
    [啟用 Get-csuser](https://docs.microsoft.com/powershell/module/skype/Enable-CsUser)
