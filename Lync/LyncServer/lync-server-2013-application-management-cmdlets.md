...
Microsoft Lync Server 2013 提供可讓您管理 Lync Server 應用程式和受信任的協力廠商應用程式的 Cmdlet。

<div>

## <a name="application-management-cmdlets"></a>應用程式管理 Cmdlet

使用這些類別中的 Cmdlet 來管理應用程式。

**[Lync Server 2013 中的 [應用程式端點] Cmdlet](lync-server-2013-application-endpoints-cmdlets.md)**
...
**[Lync Server 2013 中的 [應用程式伺服器與服務] Cmdlet](lync-server-2013-application-server-and-services-cmdlets.md)**
...
**[Lync Server 2013 中受信任的應用程式 Cmdlet](lync-server-2013-trusted-applications-cmdlets.md)**
