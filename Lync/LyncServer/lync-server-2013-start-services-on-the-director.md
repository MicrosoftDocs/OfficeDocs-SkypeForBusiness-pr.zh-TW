...
安裝本機設定存放區、安裝 Lync Server 元件及設定 Director 上的憑證之後，您必須在伺服器上啟動 Lync Server 服務。 您可以使用下列程序，在您部署中的每個 Director 上啟動服務。

<div>

## <a name="to-start-services-on-a-director"></a>若要在 Director 上啟動服務

1.  在 [Lync Server 部署嚮導] 的 [ **Lync server 2013** ] 頁面上，按一下 [**步驟4：啟動服務**] 旁邊的 [**執行**] 按鈕。
