...
Lync Server 2013 引進許多新功能，以及現有功能的顯著增強功能。 本節提供這些新功能與增強功能的高階簡介。

在本節中的主題群組討論 Lync Server 2013 中的新功能。
...
## <a name="in-this-section"></a>本章節內容
  ...
  - [Lync Server 2013 中新的嚴重損壞修復和高可用性功能](lync-server-2013-new-disaster-recovery-and-high-availability-features.md)
  ...
  - [Lync Server 2013 的新增整合連絡人存放區功能](lync-server-2013-new-unified-contact-store-feature.md)

  - [Lync Server 2013 中的新影片功能](lync-server-2013-new-video-features.md)
