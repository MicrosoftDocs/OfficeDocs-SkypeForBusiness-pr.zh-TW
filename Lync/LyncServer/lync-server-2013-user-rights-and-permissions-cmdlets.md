...
# <a name="user-rights-and-permissions-cmdlets-in-lync-server-2013"></a>Lync Server 2013 中的使用者權利和許可權 Cmdlet
...
使用者許可權 Cmdlet 主要是用來管理以角色為基礎的存取控制（RBAC），這是委派 Microsoft Lync Server 2013 系統管理控制權的新技術。

<div>

## <a name="user-permission-cmdlets"></a>使用者許可權 Cmdlet

以下是直接與管理使用者許可權相關的 Cmdlet 清單：
