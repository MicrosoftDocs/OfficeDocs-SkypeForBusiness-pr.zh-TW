...
# <a name="replication-cmdlets-in-lync-server-2013"></a>Lync Server 2013 中的複寫 cmdlet
...
複寫 cmdlet 提供方法，讓您監視和管理 Lync Server 複寫。 您可以使用這些 cmdlet 來設定的複寫設定;監視複寫進度;手動強制伺服器上的複寫。

<div>

## <a name="replication-cmdlets"></a>Replication Cmdlets

以下是 cmdlet 的與管理複寫直接相關清單：
