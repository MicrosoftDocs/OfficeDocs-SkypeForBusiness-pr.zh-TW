...
---
# <a name="replication-cmdlets-in-lync-server-2013"></a>Lync Server 2013 中的複製 Cmdlet
...
複寫 Cmdlet 提供一種方法，讓您可以監視和管理 Lync Server 複寫。 您可以使用這些 Cmdlet 來設定複寫設定;監視複寫進度;和手動強制執行伺服器上的複寫。

<div>

## <a name="replication-cmdlets"></a>Replication Cmdlets

以下是與管理複寫直接相關的 Cmdlet 清單：
