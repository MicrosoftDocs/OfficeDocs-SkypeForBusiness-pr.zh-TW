...
PreCall 診斷工具 (PCD) 可協助您找出並診斷問題在周邊網路 （QoE 資料庫不會收集資訊 edge 或周邊網路），也要疑難排解中最後一個哩的連線。 為 Windows 8 新式應用程式或 Windows 桌面應用程式工具可供https://apps.microsoft.com/windows/en-us/app/lync-2013-precall-diagnostics/9607fe33-2b51-403d-9615-c23f248e7c88。
