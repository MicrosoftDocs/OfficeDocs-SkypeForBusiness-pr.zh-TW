...
---
# <a name="components-required-for-enterprise-voice-in-lync-server-2013"></a>Lync Server 2013 中的 Enterprise Voice 所需元件
...
本節說明一或多個 Enterprise Voice 功能使用的所有元件。 其中包括：
