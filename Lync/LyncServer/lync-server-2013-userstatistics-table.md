...
# <a name="userstatistics-table-in-lync-server-2013"></a>Lync Server 2013 中的 UserStatistics 資料表
...
UserStatistics 資料表是一種支援資料表。 在資料表中的每一筆記錄會儲存系統，個別使用者的使用狀況的相關資訊。 Microsoft Lync Server 2013 中已採用此表格。
