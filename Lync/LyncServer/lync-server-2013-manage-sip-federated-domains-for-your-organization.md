...
description: Lync Server 2013：管理組織的 SIP 同盟網域。
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
## <a name="in-this-section"></a>本章節內容
  ...
  - [在 Lync Server 2013 中為允許的外部網域設定支援](lync-server-2013-configure-support-for-allowed-external-domains.md)
