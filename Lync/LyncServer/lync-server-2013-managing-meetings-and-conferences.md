---
title: Lync Server 2013：管理會議和會議
description: Lync Server 2013：管理會議和會議。
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48551529"
---
# <a name="managing-meetings-and-conferences-in-lync-server-2013"></a>在 Lync Server 2013 中管理會議和會議
...
本節中的主題會針對您可以使用 Lync Server [控制台] 的 [ **會議** ] 群組中的頁面來執行的工作，提供逐步程式。

<div>

## <a name="in-this-section"></a>本章節內容

  - [Lync Server 2013 中的會議設定設定](lync-server-2013-meeting-configuration-settings.md)
  ...
  - [在具有 Lync 功能的電話和 Lync Server 2013 上使用呼叫我](lync-server-2013-using-call-me-at-with-a-lync-enabled-phone.md)
