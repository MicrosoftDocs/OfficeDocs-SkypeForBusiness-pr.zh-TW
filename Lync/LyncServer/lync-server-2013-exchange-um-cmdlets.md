...
Microsoft Lync Server 2013 搭配 Exchange 整合通訊 (UM) ，可對主控的語音信箱執行自動語音應答和使用者存取。 您可以透過 Lync Server 管理命令介面中的 Cmdlet 來管理這些功能。

<div>

## <a name="exchange-um-cmdlets"></a>Exchange UM Cmdlets

下列 Cmdlet 可用於管理 Exchange UM
