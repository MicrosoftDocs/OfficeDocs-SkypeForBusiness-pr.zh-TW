...
# <a name="exchange-um-cmdlets-in-lync-server-2013"></a>Exchange UM Lync Server 2013 中的 cmdlet
...
Microsoft Lync Server 2013 的運作方式與 Exchange 整合通訊 (UM) 來實作自動語音應答和訂戶存取的主控的語音信箱。 這些功能可透過 Lync Server 管理命令介面中的指令程式進行管理。

<div>

## <a name="exchange-um-cmdlets"></a>Exchange UM Cmdlets

下列指令程式可用來管理 Exchange UM
