...
# <a name="configuring-persistent-chat-server-for-high-availability-and-disaster-recovery-in-lync-server-2013"></a>在 Lync Server 2013 中針對高可用性和災害復原設定常設聊天室伺服器
...
Lync Server 2013，Persistent 聊天伺服器服務會使用*延伸池*設定來進行災害復原。 延伸池是一種池，其中的電腦在兩個物理資料中心之間分佈，但位於單一邏輯 Lync 伺服器網站內。
