...
description: Lync Server 2013 可支援性。
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48549879"
---
# <a name="supportability-for-lync-server-2013"></a>Lync Server 2013 的可支援性
...
_**主題上次修改日期：** 2012-04-23_

Microsoft Lync Server 2013 通訊軟體支援拓撲，其設計目的是為了符合小型、中型或大型組織的需求，而且其效能、高可用性及擴充性需求各有不同。
...
## <a name="in-this-section"></a>本章節內容
  ...
  - [Lync Server 2013 中支援的遷移路徑和共存案例](lync-server-2013-supported-migration-paths-and-coexistence-scenarios.md)
  ...
  - [Lync Server 2013 中的用戶端和裝置軟體和基礎結構支援](lync-server-2013-client-and-device-software-and-infrastructure-support.md)
