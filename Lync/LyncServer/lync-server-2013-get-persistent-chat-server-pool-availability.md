...
description: Lync Server 2013：取得 Persistent Chat Server 集區可用性。
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48554609"
---
# <a name="get-persistent-chat-server-pool-availability-in-lync-server-2013"></a>在 Lync Server 2013 中取得 Persistent Chat Server 集區可用性
