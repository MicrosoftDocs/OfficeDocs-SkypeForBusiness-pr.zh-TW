---
title: Lync Server 2013：應用程式端點 Cmdlet
description: Lync Server 2013：應用程式端點 Cmdlet。
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48568919"
---
# <a name="application-endpoints-cmdlets-in-lync-server-2013"></a>Lync Server 2013 中的應用程式端點 Cmdlet
...
應用程式端點是 Active Directory 網域服務中的連絡人物件。 您可以使用 Lync Server 管理命令介面中的 Cmdlet 來管理這些連絡人的 Microsoft Lync Server 2013。

<div>

## <a name="application-endpoints-cmdlets"></a>Application Endpoints Cmdlets

使用下列 Cmdlet 來管理應用程式端點。
