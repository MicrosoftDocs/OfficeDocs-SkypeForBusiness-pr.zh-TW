...
系統管理員也可能會感興趣的文件中[使用 Excel 擷取 Office 365 報表資料](https://msdn.microsoft.com/library/dn781442.aspx)，以及說明如何使用 Microsoft Excel 中的 OData 資料查詢功能，來建立自訂的 office 365 報告。 自訂的報表可讓您能夠語音輸入的資料 （及多少資料） 會傳回從 Office 365 報告服務。 自訂報告也可讓您指定應該如何排序及群組，資料的變得和提供存取不會顯示在系統管理中心中的資訊。
...
[了解 Office 365 報告 Web 服務](https://msdn.microsoft.com/library/office/jj984321.aspx)  
