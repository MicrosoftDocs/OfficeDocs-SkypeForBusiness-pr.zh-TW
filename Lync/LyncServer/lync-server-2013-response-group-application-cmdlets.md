...
description: Lync Server 2013：回應群組應用程式 Cmdlet。
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
---
# <a name="response-group-application-cmdlets-in-lync-server-2013"></a>Lync Server 2013 的回應群組應用程式 Cmdlet
...
回應群組應用程式是一種企業語音通話管理功能，可將來電路由傳送給代理人群組。

<div>

## <a name="response-group-application-cmdlets"></a>Response Group Application Cmdlets

下列 Cmdlet 可用於管理回應群組應用程式。
