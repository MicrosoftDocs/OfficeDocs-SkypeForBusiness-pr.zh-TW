...
## <a name="in-this-section"></a>本章節內容
  ...
  - [Lync Server 2013 中的裝置更新設定設定](lync-server-2013-device-update-configuration-settings.md)

  - [在 Lync Server 2013 中查看裝置的軟體更新](lync-server-2013-view-software-updates-for-devices-in-your-organization.md)
