...
description: Lync Server 2013： Lync Phone Edition 配置設定。
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48570389"
---
# <a name="lync-phone-edition-configuration-settings-in-lync-server-2013"></a>Lync Server 2013 中的 lync Phone Edition 配置設定
...
執行 Lync Phone Edition 裝置的設定設定會全域性套用，您也可以建立適用于特定網站的新設定集合。 集合包含 SIP 安全性、裝置鎖定設定等等。

<div>

## <a name="in-this-section"></a>本章節內容

  - [在 Lync Server 2013 中查看 Lync Phone Edition 設定資訊](lync-server-2013-view-lync-phone-edition-configuration-settings-information.md)
