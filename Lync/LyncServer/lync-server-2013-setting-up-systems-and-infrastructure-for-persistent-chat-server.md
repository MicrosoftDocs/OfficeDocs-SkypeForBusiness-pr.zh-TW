...
# <a name="setting-up-systems-and-infrastructure-for-persistent-chat-server-in-lync-server-2013"></a>Persistent Chat Server in Lync Server 2013 的設定系統與基礎結構
...
部署 Lync Server 2013，Persistent Chat Server 之前，您需要部署適當的硬體和軟體的所有 Persistent Chat Server 元件。

<div>

## <a name="in-this-section"></a>本章節內容

  - [設定 Lync Server 2013 中的系統平台](lync-server-2013-set-up-system-platforms.md)
