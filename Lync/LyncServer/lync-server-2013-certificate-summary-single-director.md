...
# <a name="certificate-summary---single-director-in-lync-server-2013"></a>憑證摘要-Lync Server 2013 中的單一 Director
...
單一 Director 的憑證需求所組成的預設憑證，有一個主旨名稱和主體替代名稱 Director 可接收的服務。 此外，還包含用於伺服器對伺服器驗證所需的 OAuth Token 憑證。
