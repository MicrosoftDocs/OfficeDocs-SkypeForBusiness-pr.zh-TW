...
# <a name="managing-enterprise-voice-for-users-in-lync-server-2013"></a>在 Lync Server 2013 中管理企業版使用者語音
...
您可以針對每個使用者啟用企業語音。 使用本節中的程式來管理使用 Lync Server 2013 控制台和 Lync Server 2013 管理命令介面的企業語音。
