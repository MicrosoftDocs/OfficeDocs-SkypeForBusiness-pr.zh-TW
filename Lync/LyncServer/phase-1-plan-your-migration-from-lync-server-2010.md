...
# <a name="phase-1-plan-your-migration-from-lync-server-2010"></a>階段1：從 Lync Server 2010 規劃您的遷移
...
本節涵蓋從 Lync Server 2010 遷移到 Lync Server 2013 的規劃主題。
...
## <a name="in-this-section"></a>本節內容
  ...
  - [遷移群組聊天伺服器](migrating-group-chat-servers.md)
