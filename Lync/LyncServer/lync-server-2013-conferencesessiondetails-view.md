...
# <a name="conferencesessiondetails-view-in-lync-server-2013"></a>Lync Server 2013 中的 ConferenceSessionDetails 檢視
...
ConferenceSessionDetails 檢視會儲存多方成員工作階段的相關資訊。 每筆記錄都代表一個會議工作階段，它可以是有「焦點」的工作階段，或是特定會議伺服器的工作階段。 Microsoft Lync Server 2013 中已採用此檢視。
...
<td><p>會議 URI 的類型。 請參閱<a href="lync-server-2013-uritypes-table.md">Lync Server 2013 中的 UriTypes 表格</a>如需詳細資訊。</p></td>
</tr>
<tr class="even">
...
<td><p>nvarchar(256)</p></td>
<td><p>會議伺服器 URI 的類型。 請參閱<a href="lync-server-2013-uritypes-table.md">Lync Server 2013 中的 UriTypes 表格</a>如需詳細資訊。</p></td>
</tr>
<tr class="odd">
...
<td><p>nvarchar(256)</p></td>
<td><p>屬於工作階段一部分之使用者的 URI 類型。 請參閱<a href="lync-server-2013-uritypes-table.md">Lync Server 2013 中的 UriTypes 表格</a>如需詳細資訊。</p></td>
</tr>
<tr class="odd">
<td><p><strong>UserTenant</strong></p></td>
<td><p>nvarchar(256)</p></td>
<td><p>屬於工作階段一部分之使用者的租用戶。 請參閱<a href="lync-server-2013-tenants-table.md">Lync Server 2013 中的租用戶表</a>如需詳細資訊。</p></td>
</tr>
<tr class="even">
...
<td><p>int</p></td>
<td><p>會議伺服器的類型。 請參閱<a href="lync-server-2013-useragentdef-table.md">Lync Server 2013 中的 UserAgentDef 表</a>如需詳細資訊。</p></td>
</tr>
<tr class="even">
...
<td><p>int</p></td>
<td><p>參與工作階段之使用者所使用的用戶端。 請參閱<a href="lync-server-2013-useragentdef-table.md">Lync Server 2013 中的 UserAgentDef 表</a>如需詳細資訊。</p></td>
</tr>
<tr class="odd">
...
<td><p>int</p></td>
<td><p>用來識別工作階段的識別碼。 可與 ReplaceDialogIdTime 搭配使用，來唯一識別此工作階段所取代的工作階段。 <a href="lync-server-2013-dialogs-table.md">Dialogs 表格 Lync Server 2013 中的</a>如需詳細資訊，請參閱。</p></td>
</tr>
<tr class="odd">
