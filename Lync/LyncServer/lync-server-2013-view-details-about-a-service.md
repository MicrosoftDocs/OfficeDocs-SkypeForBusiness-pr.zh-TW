...
您可以使用 Lync Server [控制台] 來查看在拓撲中特定電腦上執行的每個服務的詳細資料。 您可以查看每個服務的狀態，以及相關聯的資料庫、埠和相依服務等詳細資料。

<div>

## <a name="to-view-details-for-a-service"></a>若要查看服務的詳細資料

1.  從指派給 Lync Server 2013 任何預先定義之系統管理角色的使用者帳戶登入內部部署中的任何電腦。 如需有關 Lync Server 2013 中預先定義的管理角色的詳細資訊，請參閱[在 Lync server 2013 中規劃角色式存取控制](lync-server-2013-planning-for-role-based-access-control.md)。
