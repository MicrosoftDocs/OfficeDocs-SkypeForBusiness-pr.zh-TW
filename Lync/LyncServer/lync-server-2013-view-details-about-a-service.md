...
---
# <a name="view-details-about-a-service-in-lync-server-2013"></a>在 Lync Server 2013 中查看服務的詳細資料
...
您可以使用 Lync Server 控制台，以查看拓撲中特定電腦上執行之每個服務的詳細資料。 您可以查看每個服務的狀態，以及相關聯的資料庫、埠和相依服務等詳細資訊。
