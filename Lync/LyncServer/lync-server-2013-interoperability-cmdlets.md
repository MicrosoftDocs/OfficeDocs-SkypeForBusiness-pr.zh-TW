...
互通性 cmdlet 可用於設定伺服器對伺服器驗證和 Microsoft Lync Server 2013 與其他伺服器產品，例如 Microsoft Exchange Server 2013 之間的授權。 伺服器對伺服器驗證和授權可讓這些伺服器緊密交換及共用資料。

<div>

## <a name="interoperability-cmdlets"></a>互通性 Cmdlet

下列是 cmdlet 的直接用於設定及管理 Microsoft Lync Server 2013 與其他伺服器產品之間的互通性與相關清單：
