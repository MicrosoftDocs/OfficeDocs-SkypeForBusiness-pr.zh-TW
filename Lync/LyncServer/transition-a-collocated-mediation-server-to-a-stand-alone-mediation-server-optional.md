...
# <a name="transition-a-collocated-mediation-server-to-a-stand-alone-mediation-server-optional"></a>組合式的中繼伺服器轉換成獨立中繼伺服器 （選用）
...
9.  從**拓撲產生器中**，選取頂端節點 [ **Lync Server 2013**。

10. 在 [動作]**** 窗格中，選取 [發行拓撲]****，然後完成精靈。

11. 遵循在[安裝 Lync Server 2013 中的中繼伺服器的檔案](lync-server-2013-install-the-files-for-mediation-server.md)至新的中繼伺服器上安裝檔案的部署 > 文件中的步驟。
...
15. 從**拓撲產生器中**，選取頂端節點 [ **Lync Server 2013**。
