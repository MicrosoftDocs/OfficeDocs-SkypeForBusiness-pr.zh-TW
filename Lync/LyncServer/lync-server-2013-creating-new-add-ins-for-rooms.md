...
# <a name="creating-new-add-ins-for-rooms-in-lync-server-2013"></a>在 Lync Server 2013 為聊天室建立新增益集
...
若要建立持久聊天室的增益集，請參閱部署檔中的[Lync Server 2013 中的會議室設定增益集](lync-server-2013-configure-add-ins-for-rooms.md)。 如果您是永久性聊天管理員，您可以使用 Lync Server [控制台] 或 [Windows PowerShell Cmdlet] 來建立增益集。
