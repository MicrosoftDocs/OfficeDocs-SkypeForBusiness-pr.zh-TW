...
# <a name="planning-for-exchange-server-integration-with-lync-server-2013"></a>規劃與 Lync Server 2013 整合 Exchange Server
...
當您在組織中部署 Exchange 和 Lync Server 時，兩個產品中的許多功能都得到加強。 本節包含這些功能的相關資訊。
