...
5.  在 [**編輯檔案篩選**] 中，選取 [**顯示詳細資料]。** 核取方塊。
    ...
    **編輯會議設定- \< 原則 \> **開啟顯示選取原則的設定。 如需設定設定的詳細資訊，請參閱[在 Lync Server 2013 中建立或修改會議配置設定的集合](lync-server-2013-create-or-modify-a-collection-of-meeting-configuration-settings.md)。
