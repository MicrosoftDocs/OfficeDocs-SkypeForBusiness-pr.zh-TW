...
description: 管理 Microsoft SIP 處理語言 (MSPL) 應用程式。
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48568729"
---
# <a name="managing-microsoft-sip-processing-language-mspl-applications-in-lync-server-2013"></a>在 Lync Server 2013 中管理 Microsoft SIP 處理語言 (MSPL) 應用程式
