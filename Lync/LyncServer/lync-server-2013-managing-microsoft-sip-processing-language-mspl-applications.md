...
# <a name="managing-microsoft-sip-processing-language-mspl-applications-in-lync-server-2013"></a>管理 Lync Server 2013 中的 Microsoft SIP 處理語言（MSPL）應用程式
...
您可以使用本節中的程式來管理 Microsoft SIP 處理語言（MSPL）應用程式。
