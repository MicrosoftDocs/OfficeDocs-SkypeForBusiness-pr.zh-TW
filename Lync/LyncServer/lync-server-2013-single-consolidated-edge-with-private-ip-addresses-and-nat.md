...
如果您的組織需要支援少於15000的存取邊緣服務用戶端連線、1000使用中的 Lync Server Web 會議服務用戶端連線，以及500併發的 A/V 邊緣會話，且邊緣伺服器的可用性較高，則此拓撲提供較低的硬體成本及更簡單的部署。 如果您需要更大的容量，或者需要高可用性，您必須部署經過縮放的合併邊緣伺服器拓撲。 如需詳細資訊，請參閱下列其中一項：
