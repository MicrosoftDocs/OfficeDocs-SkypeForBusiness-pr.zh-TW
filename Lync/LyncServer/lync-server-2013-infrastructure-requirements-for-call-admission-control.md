...
---
# <a name="infrastructure-requirements-for-call-admission-control-in-lync-server-2013"></a>Lync Server 2013 中通話許可控制的基礎結構需求
...
不需要特殊網路路由器之類的額外基礎結構需求。 部署 Lync Server 2013 將會自動安裝頻寬原則服務，以用於強制進行通話許可控制 (CAC) 原則。 通話許可控制只適用于執行 Lync 的用戶端。
