---
title: Lync Server 2013： Application 資料表
description: Lync Server 2013： Application 資料表。
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48568829"
---
# <a name="application-table-in-lync-server-2013"></a>Lync Server 2013 中的應用程式表
...
此表格會儲存與路由及連線有關之 Lync Server 2013 內各種處理常式的資訊。
