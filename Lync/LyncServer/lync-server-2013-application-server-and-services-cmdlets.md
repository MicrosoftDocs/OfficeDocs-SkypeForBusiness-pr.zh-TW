...
# <a name="application-server-and-services-cmdlets-in-lync-server-2013"></a>Lync Server 2013 中的 [應用程式伺服器與服務] Cmdlet
...
伺服器應用程式會參照在 Microsoft Lync Server 2013 下執行的個別程式。 您可以在 Lync Server 管理命令介面中使用 Cmdlet 來管理這些應用程式。

<div>

## <a name="application-server-and-services-cmdlets"></a>應用程式伺服器與服務 Cmdlet
