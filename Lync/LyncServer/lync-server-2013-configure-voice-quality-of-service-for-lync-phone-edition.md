...
description: Lync Server 2013：設定 Lync Phone Edition 的語音服務品質。
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
您可以設定連線至 Lync Server 2013 的 IP 電話 QoS 層級，設定集區的語音服務品質 (QoS 集區中的 Lync Phone Edition 裝置) 需求。
