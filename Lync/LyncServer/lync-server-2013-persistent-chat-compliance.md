...
# <a name="persistent-chat-compliance-in-lync-server-2013"></a><span data-ttu-id="e4bda-102">Lync Server 2013 中的常設聊天室規範</span><span class="sxs-lookup"><span data-stu-id="e4bda-102">Persistent Chat compliance in Lync Server 2013</span></span>
...
<span data-ttu-id="e4bda-103">_**主題上次修改日期：** 2012-10-06_</span><span class="sxs-lookup"><span data-stu-id="e4bda-103">_**Topic Last Modified:** 2012-10-06_</span></span>

<span data-ttu-id="e4bda-104">建立新的持續聊天相容性設定</span><span class="sxs-lookup"><span data-stu-id="e4bda-104">To create a new Persistent Chat compliance configuration</span></span>
...
<span data-ttu-id="e4bda-105">若要取得持久的聊天合規性設定</span><span class="sxs-lookup"><span data-stu-id="e4bda-105">To get Persistent Chat compliance configuration</span></span>

    Get-CsPersistentChatComplianceConfiguration [-Identity <XdsIdentity>] [-LocalStore <Switch Parameter>]

<span data-ttu-id="e4bda-106">若要設定持續性聊天規範配置</span><span class="sxs-lookup"><span data-stu-id="e4bda-106">To set Persistent Chat compliance configuration</span></span>
...
<span data-ttu-id="e4bda-107">若要移除持續性聊天規範配置</span><span class="sxs-lookup"><span data-stu-id="e4bda-107">To remove Persistent Chat compliance configuration</span></span>
