...
> [!NOTE]  
> 在這個範例中，Ken Myer 的 Active Directory 顯示名稱作為身分識別的使用者帳戶。 您也可以使用其他的識別項，例如使用者的 SMTP 地址或他/她 User Principal Name 參照的使用者帳戶。 請參閱設定 UserPhoto 指令程式在文件<A href="http://go.microsoft.com/fwlink/p/?linkid=268536">http://go.microsoft.com/fwlink/p/?LinkId=268536</A>如需詳細資訊
