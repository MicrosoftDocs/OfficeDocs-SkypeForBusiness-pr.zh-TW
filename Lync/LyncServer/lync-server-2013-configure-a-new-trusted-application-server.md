...
信任的應用程式是由 Microsoft Lync Server 2013 皆信任的 Microsoft Unified Communications Managed API (UCMA) 3.0 Core SDK 為基礎的應用程式。 如需 UCMA 應用程式的詳細資訊，請參閱 「 Unified Communications Managed API 3.0 核心 SDK 文件 」， [http://go.microsoft.com/fwlink/p/?linkId=210320](http://go.microsoft.com/fwlink/p/?linkid=210320)。
