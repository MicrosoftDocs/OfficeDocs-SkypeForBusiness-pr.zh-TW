...
如果您需要測試 Kerberos 指派或決定 Kerberos 驗證的狀態，您可以使用 Windows PowerShell Cmdlet。

<div>

## <a name="in-this-section"></a>本章節內容

  - [在 Lync Server 2013 中測試和報告 Kerberos 驗證的功能準備就緒](lync-server-2013-test-and-report-functional-readiness-for-kerberos-authentication.md)
