...
# <a name="preparing-for-installation-of-servers-in-the-perimeter-network-for-lync-server-2013"></a>在周邊網路中準備安裝 Lync Server 2013 的伺服器
...
在您設定邊緣伺服器元件之前，必須先確定您設定的電腦符合系統需求，並完成部署 Edge 伺服器元件所需的其他必要步驟。

開始之前，請先查看下列主題中的詳細資料，瞭解您要部署之參考體系結構的規劃檔：
