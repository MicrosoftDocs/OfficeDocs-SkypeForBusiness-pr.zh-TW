...
# <a name="test-persistent-chat-server-with-a-synthetic-transaction"></a><span data-ttu-id="e9cbc-102">利用綜合交易測試常設聊天室伺服器</span><span class="sxs-lookup"><span data-stu-id="e9cbc-102">Test Persistent Chat Server with a synthetic transaction</span></span>
...
<span data-ttu-id="e9cbc-103">_**主題上次修改日期：** 2012-09-21_</span><span class="sxs-lookup"><span data-stu-id="e9cbc-103">_**Topic Last Modified:** 2012-09-21_</span></span>

<span data-ttu-id="e9cbc-104">在兩個使用者之間測試持久聊天伺服器以傳送和接收聊天室中的訊息</span><span class="sxs-lookup"><span data-stu-id="e9cbc-104">To test Persistent Chat Server for sending and receiving messages in a chat room between two users</span></span>
...
<span data-ttu-id="e9cbc-105">或</span><span class="sxs-lookup"><span data-stu-id="e9cbc-105">or</span></span>
...
<span data-ttu-id="e9cbc-106">或</span><span class="sxs-lookup"><span data-stu-id="e9cbc-106">or</span></span>
