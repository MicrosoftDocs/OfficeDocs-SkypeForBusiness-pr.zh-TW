...
# <a name="test-persistent-chat-server-with-a-synthetic-transaction"></a><span data-ttu-id="12c03-102">使用綜合交易測試 Persistent Chat Server</span><span class="sxs-lookup"><span data-stu-id="12c03-102">Test Persistent Chat Server with a synthetic transaction</span></span>
...
<span data-ttu-id="12c03-103">_**主題上次修改日期：** 2012-09-21_</span><span class="sxs-lookup"><span data-stu-id="12c03-103">_**Topic Last Modified:** 2012-09-21_</span></span>

<span data-ttu-id="12c03-104">測試 Persistent Chat Server，以在兩位使用者之間的聊天室中傳送和接收郵件</span><span class="sxs-lookup"><span data-stu-id="12c03-104">To test Persistent Chat Server for sending and receiving messages in a chat room between two users</span></span>
...
<span data-ttu-id="12c03-105">或</span><span class="sxs-lookup"><span data-stu-id="12c03-105">or</span></span>
...
<span data-ttu-id="12c03-106">或</span><span class="sxs-lookup"><span data-stu-id="12c03-106">or</span></span>
