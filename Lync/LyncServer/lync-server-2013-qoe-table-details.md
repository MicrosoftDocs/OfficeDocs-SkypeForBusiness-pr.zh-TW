...
description: Lync Server 2013： QoE 表格詳細資料。
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48579149"
---
# <a name="qoe-table-details-in-lync-server-2013"></a>在 Lync Server 2013 中 QoE 表格詳細資料
...
以下各節將詳細說明 (QoE) 資料庫架構表格中的每個經驗品質各欄。
  ...
  - [Lync Server 2013 中的 AppSharingMetricsThreshold 表格](lync-server-2013-appsharingmetricsthreshold-table.md)

  - [Lync Server 2013 中的 AppSharingStream 表格](lync-server-2013-appsharingstream-table.md)
  ...
  - [Lync Server 2013 中的 CodecDescription 表格](lync-server-2013-codecdescription-table.md)

  - [Lync Server 2013 中的會議表格](lync-server-2013-conference-table.md)

  - [Lync Server 2013 中的裝置表格](lync-server-2013-device-table.md)

  - [Lync Server 2013 中的 DeviceDriver 表格](lync-server-2013-devicedriver-table.md)

  - [Lync Server 2013 中的對話方塊表格](lync-server-2013-dialog-table.md)

  - [Lync Server 2013 中的端點表格](lync-server-2013-endpoint-table.md)

  - [Lync Server 2013 中的 EndpointSubnet 表格](lync-server-2013-endpointsubnet-table.md)

  - [Lync Server 2013 中的 IPAddress 表格](lync-server-2013-ipaddress-table.md)
  ...
  - [Lync Server 2013 中的 NetworkConnectionDetail 表格](lync-server-2013-networkconnectiondetail-table.md)
  ...
  - [在 Lync Server 2013 中 PurgeSettings table (QoE) ](lync-server-2013-purgesettings-table-qoe.md)

  - [Lync Server 2013 中的地區表格](lync-server-2013-region-table.md)

  - [Lync Server 2013 中的伺服器表格](lync-server-2013-server-table.md)

  - [Lync Server 2013 中的會話表格](lync-server-2013-session-table.md)

  - [Lync Server 2013 中的 SessionCorrelation 表格](lync-server-2013-sessioncorrelation-table.md)

  - [Lync Server 2013 中的子網表格](lync-server-2013-subnet-table.md)

  - [Lync Server 2013 中的 TraceRoute 表格](lync-server-2013-traceroute-table.md)

  - [Lync Server 2013 中的使用者表格](lync-server-2013-user-table.md)

  - [Lync Server 2013 中的 UserAgent 表格](lync-server-2013-useragent-table.md)

  - [在 Lync Server 2013 中 UserAgentDef table (QoE) ](lync-server-2013-useragentdef-table-qoe.md)
  ...
  - [Lync Server 2013 中的 VideoMetricsThreshold 表格](lync-server-2013-videometricsthreshold-table.md)
