...
以下各節詳細說明每個經驗品質（QoE）資料庫架構資料表中的欄。
  ...
  - [Lync Server 2013 中的 PurgeSettings table （QoE）](lync-server-2013-purgesettings-table-qoe.md)
  ...
  - [Lync Server 2013 中的 UserAgentDef table （QoE）](lync-server-2013-useragentdef-table-qoe.md)
