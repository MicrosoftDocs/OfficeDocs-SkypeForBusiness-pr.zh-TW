...
---
# <a name="create-response-group-workflows-in-lync-server-2013"></a>在 Lync Server 2013 中建立回應群組工作流程
...
您可以使用回應群組設定工具來建立工作流程。 您可以從 Lync Server 控制台的 [回應群組] 頁面，存取回應群組設定工具。
