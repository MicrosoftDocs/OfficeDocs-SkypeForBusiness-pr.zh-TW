...
> [!NOTE]  
> 若要開始 XMPP 閘道遷移，您必須部署 Lync Server 2013 XMPP 閘道，並設定存取原則以啟用 Lync Server 2013 XMPP 閘道的使用者。 在您執行這些步驟之前，必須先將所有使用者移至 Lync Server 2013 部署。 如需詳細資訊，請參閱 <A href="configure-xmpp-gateway-on-lync-server-2013.md">CONFIGURE XMPP gateway On Lync Server 2013</A>。
