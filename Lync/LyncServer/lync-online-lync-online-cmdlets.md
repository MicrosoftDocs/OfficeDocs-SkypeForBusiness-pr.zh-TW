...
此頁面會列出 Microsoft Lync Online 租使用者所有可供系統管理員使用的 Windows PowerShell Cmdlet。

<div>

## <a name="cmdlets-available-only-to-lync-online-administrators"></a>僅可供 Lync Online 系統管理員使用的 Cmdlet

下列 Cmdlet 只能搭配 Lync Online 使用：
...
如需如何設定您的電腦以使用 Windows PowerShell 管理 Lync Online 的相關資訊，請參閱[使用 Windows Powershell 管理 Lync online](https://technet.microsoft.com/en-us/library/Dn362831(v=OCS.15))的說明主題。
...
這些 Cmdlet 可以搭配 Lync Online 或內部部署版本的 Lync Server 2013 使用：
