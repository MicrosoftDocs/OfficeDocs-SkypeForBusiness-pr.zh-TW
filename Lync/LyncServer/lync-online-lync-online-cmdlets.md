...
此頁面會列出所有 Windows PowerShell Cmdlet 可供 Microsoft Lync Online 承租人的系統管理員使用。

<div>

## <a name="cmdlets-available-only-to-lync-online-administrators"></a>僅適用于 Lync Online 系統管理員的 Cmdlet

下列 Cmdlet 只能與 Lync Online 搭配使用：
  ...
  - [CsTenantPublicProvider](https://technet.microsoft.com/library/JJ994047(v=OCS.15))

  - [更新-CsTenantMeetingUrl](https://technet.microsoft.com/library/Dn424754(v=OCS.15))

如需如何設定您的電腦使用 Windows PowerShell 以使用 Lync Online 進行管理的詳細資訊，請參閱使用說明主題[Using windows PowerShell 以管理 Lync online](https://technet.microsoft.com/library/Dn362831(v=OCS.15))。

</div>

<div>

## <a name="other-cmdlets-available-to-lync-online-administrators"></a>Lync Online 系統管理員可使用的其他 Cmdlet

這些 Cmdlet 可以與 Lync Online 或內部部署版本的 Lync Server 2013 搭配使用：
