...
---
# <a name="delete-an-existing-collection-of-av-edge-server-configuration-settings-in-lync-server-2013"></a>在 Lync Server 2013 中刪除現有的 A/V Edge Server 設定集合集合
...
當您安裝 Lync Server 時，系統會為您建立全域 A/V Edge 設定的集合。 無法刪除此全域集合。 不過，您可以使用 Windows PowerShell 和 Remove-CsAVEdgeConfiguration Cmdlet 「重設」全域集合;這只是表示全域集合中的所有屬性值都會重設為其預設值。 例如，如果您已將 MaxTokenLifetime 屬性設定為16小時，該屬性將會重設為預設值8小時。
...
如需詳細資訊，請參閱 [Remove-CsAVEdgeConfiguration](https://technet.microsoft.com/library/Gg398786(v=OCS.15)) Cmdlet 的 [說明] 主題。

<div>

## <a name="to-reset-the-global-collection"></a>重設全域集合
...
## <a name="to-remove-a-collection-from-the-site-scope"></a>從網站範圍中移除集合
