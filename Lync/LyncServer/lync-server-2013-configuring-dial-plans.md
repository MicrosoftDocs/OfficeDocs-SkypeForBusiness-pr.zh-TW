...
# <a name="configuring-dial-plans-in-lync-server-2013"></a>在 Lync Server 2013 中設定撥號對應表
...
Lync Server 2013 撥號方案是一組命名的正常化規則，可將命名位置、個別使用者或連絡人物件的電話號碼翻譯，以用於手機授權及呼叫路由。

<div>


> [!NOTE]  
> 如需詳細資訊，請參閱規劃檔中的<A href="lync-server-2013-dial-plans-and-normalization-rules.md">Lync Server 2013 中的撥號方案和正常化規則</A>。
