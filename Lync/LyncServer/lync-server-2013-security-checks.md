...
description: Lync Server 2013：安全性檢查。
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48551459"
---
# <a name="security-checks-in-lync-server-2013"></a>Lync Server 2013 中的安全性檢查
...
定期審核安全性，例如防火牆規則、使用者權限、群組成員資格、委派權力等等。
