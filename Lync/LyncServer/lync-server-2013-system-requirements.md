...
---
# <a name="system-requirements-for-lync-server-2013"></a>Lync Server 2013 的系統需求
...
## <a name="in-this-section"></a>本章節內容
  ...
  - [Lync Server 2013 中系統管理工具的系統需求](lync-server-2013-system-requirements-for-administration-tools.md)
