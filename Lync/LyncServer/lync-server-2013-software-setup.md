...
# <a name="software-setup-for-lync-server-2013"></a>Lync Server 2013 的軟體安裝
...
## <a name="in-this-section"></a>本章節內容
  ...
  - [設定 Lync Server 2013 的檔案儲存空間](lync-server-2013-configure-dfs-file-storage.md)

  - [針對 Lync Server 2013 （選用） 的預先要求憑證](lync-server-2013-request-certificates-in-advance-optional.md)

  - [將 Lync Server 2013 的 IIS 設定](lync-server-2013-configure-iis.md)

  - [安裝 Lync Server 2013 的 Windows PowerShell 3.0](lync-server-2013-installing-windows-powershell-3-0.md)
