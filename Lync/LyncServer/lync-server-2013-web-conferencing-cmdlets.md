...
description: Lync Server 2013： Web 會議 Cmdlet。
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
會議和線上會議是 Microsoft Lync Server 2013 中的重要元素。 CsConferencingConfiguration 和 CsConferencingPolicy Cmdlet 是使用 Windows PowerShell 管理會議的主要系統管理工具。

<div>

## <a name="web-conferencing-cmdlets"></a>Web Conferencing Cmdlets

[New-CsClientPolicy](https://technet.microsoft.com/library/Gg425949(v=OCS.15))和[Set-CsClientPolicy](https://technet.microsoft.com/library/Gg398300(v=OCS.15)) Cmdlet 提供其他方式來設定及管理 Lync Server 2013。
