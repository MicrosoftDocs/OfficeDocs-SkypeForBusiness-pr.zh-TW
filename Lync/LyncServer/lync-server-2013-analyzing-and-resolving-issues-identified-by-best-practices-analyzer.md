...
description: 分析和解決最佳做法分析器所識別的問題。
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48561899"
---
# <a name="analyzing-and-resolving-issues-identified-by-best-practices-analyzer-in-lync-server-2013"></a>分析和解決 Lync Server 2013 中的最佳做法分析程式所識別的問題
...
最佳做法分析程式不會變更您的環境以解決問題。 它只會偵測可能的問題，並顯示如何解決問題的相關資訊。 如果您找出需要解決的問題，則必須判斷適當的解決方案。 本節中的主題可協助您找出並解決一些最重要的潛在問題。

<div>

## <a name="in-this-section"></a>本章節內容

  - [Lync Server 2013 中環境測試的問題](lync-server-2013-issues-with-the-environment-test.md)
