...
# <a name="manufacturers-table-in-lync-server-2013"></a>Lync Server 2013 中的 manufacturers 表格
...
Manufacturers 表格是一種支援資料表。 每一筆記錄會儲存一部裝置 （電話機） 製造商的相關資訊。
