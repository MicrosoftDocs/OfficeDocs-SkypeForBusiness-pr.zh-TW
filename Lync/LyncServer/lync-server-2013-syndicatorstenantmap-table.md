...
# <a name="syndicatorstenantmap-table-in-lync-server-2013"></a>Lync Server 2013 中的 SyndicatorsTenantMap 表格
...
SyndicatorsTenantMap 資料表僅供內部使用。 此表格是在 Microsoft Lync Server 2013 中推出。
