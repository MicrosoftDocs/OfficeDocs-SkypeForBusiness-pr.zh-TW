...
# <a name="configuring-dial-in-conferencing-in-lync-server-2013"></a>在 Lync Server 2013 中設定撥入會議
...
本節將引導您完成 Lync Server 2013 電話撥入式會議的設定。
...
## <a name="in-this-section"></a>本節內容
  ...
  - [確認 Lync Server 2013 已指派地區的撥號方案](lync-server-2013-make-sure-dial-plans-have-assigned-regions.md)
