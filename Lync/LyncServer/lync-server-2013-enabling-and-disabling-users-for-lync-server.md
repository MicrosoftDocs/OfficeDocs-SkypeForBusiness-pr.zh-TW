...
# <a name="enabling-and-disabling-users-for-lync-server-2013"></a>啟用和停用使用者的 Lync Server 2013
...
您可以啟用、 暫時停用或移除 Lync Server 2013 的 Active Directory 使用者。

<div>

## <a name="in-this-section"></a>本章節內容

  - [新增並啟用 Lync Server 2013 的使用者帳戶](lync-server-2013-add-and-enable-user-account-for-lync-server.md)

  - [停用或重新啟用 Lync Server 2013 的使用者帳戶](lync-server-2013-disable-or-re-enable-user-account-for-lync-server.md)

  - [移除 Lync Server 2013 中的使用者帳戶](lync-server-2013-remove-a-user-account-from-lync-server.md)
