...
## <a name="in-this-section"></a>本章節內容
  ...
  - [委派 Lync Server 2013 的管理控制權](lync-server-2013-delegating-administrative-control-of-lync-server.md)
  ...
  - [在 Lync Server 2013 中管理增強型9-1-1 與位置服務](lync-server-2013-managing-enhanced-9-1-1-and-the-location-service.md)
  ...
  - [Lync Server 2013 中的監控和健康情況設定](lync-server-2013-monitoring-and-health-configuration.md)
