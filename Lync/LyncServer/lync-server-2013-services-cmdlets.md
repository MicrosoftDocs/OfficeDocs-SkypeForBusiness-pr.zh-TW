...
隨附于 Microsoft Lync Server 2013 的伺服器角色和服務 Cmdlet 可讓您傳回已安裝在 Lync Server 2013 部署中之各個元件的相關資訊。 此外，這些 Cmdlet 可讓您輕鬆地停止並啟動 Lync Server 服務。

<div>

## <a name="services-cmdlets"></a>服務 Cmdlet

以下是直接與管理服務相關的 Cmdlet 清單：
