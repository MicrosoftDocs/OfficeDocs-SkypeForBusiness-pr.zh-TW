...
description: Lync Server 2013：支援的硬體。
ms.reviewer: ''
ms.author: v-lanac
author: lanachin
f1.keywords:
...
ms.locfileid: "48575259"
---
# <a name="supported-hardware-for-lync-server-2013"></a>Lync Server 2013 的支援硬體
...
Lync Server 2013 硬體需求會根據伺服器角色、拓撲、儲存需求和特定部署案例而有所不同。
