...
## <a name="step-1-install-the-office-365-moodle-plugin"></a>步驟 1: 安裝 Office 365 Moodle 外掛程式
...
*還沒有 Moodle 網站嗎？* 您可能會想要查看 Azure 存放庫上[](https://github.com/azure/moodle)的 Moodle, 讓您可以快速地在 azure 上部署 Moodle 實例, 並根據您的需求加以自訂。

## <a name="step-2-configure-the-connection-between-the-office-365-plugin-and-azure-active-directory"></a>步驟 2: 設定 Office 365 外掛程式與 Azure Active Directory 之間的連線
...
## <a name="step-4-deploy-your-microsoft-teams-app"></a>步驟 4: 部署您的 Microsoft 團隊應用程式
