...
使用者可以從 Teams 頻道和交談的雲端儲存服務上傳及分享檔案。 Teams 中的雲端儲存選項目前包括 Dropbox、Box、 ShareFile、 Google Drive、和 [Egnyte](https://helpdesk.egnyte.com/hc/requests/new)。 開啟貴組織要使用的雲端儲存空間提供者的開關。
