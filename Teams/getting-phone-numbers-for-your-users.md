...
## <a name="show-phone-numbers-for-your-organization"></a>顯示貴組織的電話號碼

![](media/teams-logo-30x30.png) **使用 microsoft [團隊管理中心**] 顯示 Microsoft 團隊標誌的圖示 

在左側導覽中，移至 [**語音** > **電話號碼**] 來查看貴組織的號碼，包括位置、編號類型及狀態資訊。
  
## <a name="what-else-do-you-need-to-know-about-users-phone-numbers"></a>關於使用者的電話號碼，您還需要知道什麼？
