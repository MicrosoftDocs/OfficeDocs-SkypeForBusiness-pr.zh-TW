...
f1.keywords:
- CSH
description: Microsoft Teams中的撥號對應表和路由
ms.openlocfilehash: 1d99b5edef1cf6c4440a218097933e4ff5843f1d
ms.sourcegitcommit: 4847f24e8c644336d2b2f48aa09e2cf91360e4dd
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 04/06/2022
ms.locfileid: "64686711"
---
# <a name="overview"></a>概觀

本節中的文章說明Microsoft Teams中的撥號對應表和通話路由。 
...
本節中的文章適用于連線到公用交換電話網路 (PSTN) 的所有選項：通話方案、電信業者連線和直接路由。 如需所有 PSTN 連線選項的詳細資訊，請參閱 [PSTN 連線選項](pstn-connectivity.md)。

如果您選擇 [通話方案] 或 [電信業者連線，大部分的通話路由是由 Microsoft 或您的提供者負責。 不過，直接路由需要額外步驟來設定通話路由。 
...
請注意，您可以將直接路由線上語音路由原則指派給通話方案，並電信業者連線使用者。 舉例來說，您可能會想要這樣做，讓使用者能夠直接撥入通話中心。 您可以設定直接路由主幹到話務中心。
