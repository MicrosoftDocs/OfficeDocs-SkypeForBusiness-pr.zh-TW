...
在考慮使用 Microsoft 365 群組或建立小組時，請考慮該小組將用於哪些人員、誰應該擁有存取權，以及小組預期會達到哪些結果。 特別注意的是，您所建立的頻道數量會隨著內容散佈太多的頻道而逐漸遭到溢出 () 。
...
## <a name="teams-respects-microsoft-365-groups-naming-policy-in-private-preview"></a>團隊會尊重私人預覽版中的 Microsoft 365 群組命名原則 () 
