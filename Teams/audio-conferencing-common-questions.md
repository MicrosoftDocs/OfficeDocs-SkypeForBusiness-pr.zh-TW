...
舉例來說，當人們在路上，而且無法使用膝上型電腦或行動裝置上的 Microsoft Teams 應用程式參加會議時，撥入會議是一項好處。 但在其他情況下，使用電話參加 Teams 會議會比在電腦上使用應用程式更好：
...
擁有撥入號碼和會議 ID 的任何人都可以加入 Teams 會議，除非會議召集人鎖定會議。
  
無論您是使用電話或 Teams 應用程式撥入電話，您都可以聽到通話中的其他所有人，而且他們能聽到您的聲音。 如果會議召集人不想聽到會議出席者的聲音，可以將會議出席者設為靜音。
...
當您購買音訊會議授權時，會指派本機撥入號碼給您。 撥入號碼會包含在會議邀請中。 這些當地號碼僅適用于您的組織。 指派給貴組織的電話和該號碼是由組織內啟用音訊會議的使用者共用。 這表示由使用者 A 和另一個使用者 B 排程的 Teams 會議都會有相同的撥入號碼。
...
|**會議出席者**|**會議結束時間**|
|:-----|:-----|
|使用者已使用 Teams 應用程式加入，或已撥入會議。  <br/> |如果 24 小時後出席者清單沒有變更，會議便會結束。  <br/> |
...
若要瞭解會議限制的相關資訊，請參閱 [會議和通話](limits-specifications-teams.md#meetings-and-calls)。
...
Teams 使用者會被隨機指派會議識別碼。 使用者無法保留或設定只有他們可以使用的靜態會議 ID。
...
Teams 使用者可以在 Outlook 和 Outlook 網頁版 中排程會議，找到指派給他們的會議 ID。 此外，使用者可以在設定之後傳送給他們的電子郵件中找到會議 ID。
...
Teams 使用者可以在設定之後傳送給他們的電子郵件中找到 PIN。
...
當使用者獲派 **音訊會議** 授權，且使用者在 Outlook 或 Outlook 網頁版 中建立新的 Teams 會議時，撥入電話號碼和會議 ID 會自動新增至會議邀請。
