...
是，免付費電話號碼（服務號碼）只能在部分國家/地區使用。 如需可用的號碼清單，請參閱[音訊會議與通話方案的國家和地區可用性](country-and-region-availability-for-audio-conferencing-and-calling-plans/country-and-region-availability-for-audio-conferencing-and-calling-plans.md)。
...
商務用 Skype 和 Microsoft 團隊使用者將會隨機指派會議 Id，而且無法保留或設定只有他們可以使用的靜態會議 ID。 
...
## <a name="how-does-a-user-access-or-change-hisher-pin"></a>使用者如何存取或變更自己的 PIN？

[商務用 Skype] 或 [Microsoft 團隊] 使用者可以在設定之後，在要傳送給他們的電子郵件中找到 PIN。
...
## <a name="how-does-a-user-schedule-and-start-a-meeting-when-all-attendees-will-be-using-a-phone-to-dial-in"></a>如果所有出席者都要使用電話撥入，使用者如何排程及開始會議？

排程將由所有出席者使用電話撥入加入的會議，與排程一般線上會議並無不同。 不過，有兩種方式可以讓所有參與者都使用電話撥入的會議：
