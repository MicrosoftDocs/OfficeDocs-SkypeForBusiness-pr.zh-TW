...
## <a name="enhance-your-service-overview"></a>加強您的服務概覽
...
當您看到改善服務的機會時，請花時間進行。 您可以在 Microsoft 團隊和我們的[實施階段](deploy-chat-teams-channels-microsoft-teams-landing-page.md)重新[參與部署聊天、團隊、頻道和應用程式](deploy-chat-teams-channels-microsoft-teams-landing-page.md)，並將相同的指導方針套用至結束。 當進行小的增量變更時，您不太可能需要完整完成所有的活動和工作，但是您應該務必評估每個活動和工作，讓您能夠在成功的結果中為自己提供最佳機會。
