...
layout: HubPage
hide_bc: true
title: Microsoft Teams 技術文件
ms.reviewer: ''
ms.author: kenwith
audience: admin
manager: serdars
author: kenwith
description: Microsoft Teams 技術文件
ms.topic: hub-page
...
ms.locfileid: "41834403"
---
<div id="main" class="v2">
    <div class="container">
        <h1>Microsoft Teams 技術文件</h1>
        <P> </p>
        <ul class="pivots">
            <li>
                <a href="#home"></a>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>歡迎使用 Teams</h3>
                                                <P>取得 Teams 的概觀，並找到身為 Teams 系統管理員或 IT 專業人員的您所需的技術指導方針</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>從商務用 Skype 升級至 Teams</h3>
                                                <P>尋找可探索您通往 Teams 的最佳路徑的指導方針和工具</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>海報：Teams 架構和電話語音解決方案</h3>
                                                <P>取得 Teams IT 架構和電話解決方案的可列印圖例</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <li>
                                ...
                                <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>在組織中擴大 Teams</h3>
                                                <P>尋找適用您的產業 (包括醫療保健、第一線員工、零售、政府和教育機構) 的自訂解決方案</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Teams 技術社群</h3>
                                            <p>加入 Teams 技術社群來發問並獲得解答，以及閱讀 Teams 部落格</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <a href="https://docs.microsoft.com/microsoftteams/platform/overview"> <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Teams 開發人員平台</h3>
                                            <p>了解 Microsoft Teams 開發人員平台，以及它如何讓您建立實用且功能強大的應用程式</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
