---
title: '適用于企業的 Microsoft 365 應用程式 '
ms.author: tonysmit
author: tonysmit
manager: serdars
ms.reviewer: mikedav
...
如果您已購買適用于[企業方案的 Microsoft 365 應用程式](https://products.office.com/en/business/office-365-proplus-business-software)，以下是您需要購買才能取得更多團隊功能的附加元件授權。
