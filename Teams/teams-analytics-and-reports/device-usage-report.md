...
ms.collection:
- M365-collaboration
description: 瞭解如何在系統管理中心Teams裝置使用方式報告Microsoft Teams，以瞭解貴組織的使用者如何Teams。
appliesto:
- Microsoft Teams
