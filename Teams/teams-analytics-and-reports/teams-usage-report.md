...
1. 在 Microsoft [團隊管理中心] 的左導覽中, 按一下 [**分析] & 報表**], 然後在 [**報表**] 底下, 選取 [**團隊使用方式**]。
2. 在 [**日期範圍**] 底下, 選取一個範圍, 然後按一下 [**執行報表**]。

[![團隊系統管理中心] 中的 [團隊使用方式] 報告螢幕擷取畫面 (含標注])[(../media/teams-reports-teams-usage-with-callouts.png "團隊系統管理中心] 中的 [團隊使用方式] 報告螢幕擷取畫面 (含標注"))
