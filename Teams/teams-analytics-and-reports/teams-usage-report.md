...
ms.collection:
- M365-collaboration
description: 瞭解如何使用 Microsoft Teams 系統管理中心的 Teams 使用方式報告，以取得貴組織中的 Teams 活動概觀。
appliesto:
- Microsoft Teams
...
ms.locfileid: "69436689"
---
# <a name="microsoft-teams-usage-report"></a>Microsoft Teams 使用方式報告

Microsoft Teams 系統管理中心的 Teams 使用方式報告提供 Teams 使用方式活動的概觀，包括作用中使用者和頻道的數量，讓您可以快速查看組織中有多少使用者正在使用 Teams 進行通訊和共同作業。 您可以檢視團隊的使用資訊，包括每個團隊中的使用中使用者和頻道、來賓和訊息數目。
