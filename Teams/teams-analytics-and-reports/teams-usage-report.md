...
2. 在 **[日期範圍**」 下，選取範圍，然後按一下 [ **執行報表**> 。
    ...
    ![系統管理中心Teams使用狀況報表的螢幕擷取畫面Teams圖](../media/teams-reports-teams-usage-with-callouts1.png "系統管理中心Teams使用狀況報表的螢幕擷取畫面Teams圖")
