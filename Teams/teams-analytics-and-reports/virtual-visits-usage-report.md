...
ms.locfileid: "62929412"
---
# <a name="microsoft-teams-virtual-visits-usage-report"></a>Microsoft Teams虛擬訪問使用方式報告

**這是預覽功能**。

系統管理中心中的虛擬Microsoft Teams使用方式報告，提供您Teams虛擬流覽活動概觀。 您可以透過[Bookings](../expand-teams-across-your-org/bookings-virtual-visits.md) App 和[EHR Microsoft Teams電子](../expand-teams-across-your-org/healthcare/teams-in-hc.md#virtual-visits-and-electronic-healthcare-record-ehr-integration)健康記錄 (查看) 活動。

若要查看報表，您必須是全域系統管理員或Teams管理員。

報表包含下列定位停駐點。 您在報告中看到的資訊取決於您是否擁有 Bookings App、Teams EHR 連接器或兩者都有授權。

|選項 卡 |描述  |
|---------|---------|
|**[虛擬訪問](#virtual-visits)**     |顯示虛擬訪問的總數，以及使用 Bookings App 排定的Teams，以及從 EHR 系統進行的 EHR 整合會議。         |
...
>
>如果您想要關閉貴組織的報表，您可以在頁面右上角的 設定中關閉報表。****
...
|**6**   |您可以將報表匯出為 CSV 檔案，進行離線分析。 選取 **匯出Excel**，然後在下載選項卡上，選擇下載以在報表準備就緒時下載報表。|
...
|**5**   |您可以將報表匯出為 CSV 檔案，進行離線分析。 選取 **匯出Excel**，然後在下載選項卡上，選擇下載以在報表準備就緒時下載報表。|
### <a name="ehr"></a>EHR
