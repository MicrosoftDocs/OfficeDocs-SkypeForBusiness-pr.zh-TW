...
4.    具有相關識別碼 「f45e9a25-9f94-46e7-a457-84f5940efde9」的現有通話 3。 PSTN 使用者 1 與使用者 2 Teams通話中。 Teams使用者 2 轉接 (視) 或TEAMS PSTN 使用者， 通話類型 Dr_Out_User_Transfer 45a1da7c-9e97-481a-8a05-3fe19a9a77e0，共用關聯識別碼 f45e9a25-9f94-46e7-a457-84f5940efde9。
...
CSV 的第一列包含欄名。 所有日期都是 UTC，且 [採用 ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) 格式。
...
除非特定國家/地區法規禁止保留該期間的資料，否則 (從目前日期起) 150 天內匯出資料。
...
> | 2 | 顯示名稱 | `nvarchar(128)` | 使用者或通話機器人的名稱 (例如，通話佇列或自動) 自動Microsoft 365 系統管理中心 |
