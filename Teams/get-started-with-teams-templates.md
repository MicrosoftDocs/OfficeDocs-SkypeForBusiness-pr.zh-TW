...
| 教育 -<br>課程小組 | `https://graph.microsoft.com/beta/`<br>`teamsTemplates('educationClass')` | 應用程式：<ul><li>OneNote課程筆記本 (釘到一般 **)** </li><li>作業應用程式 (釘到的一般 **)**</li></ul> 小組屬性：<ul><li>小組可見度設定為 **HiddenMembership (** 無法) </li></ul> |
| 教育 -<br>教職員團隊 | `https://graph.microsoft.com/beta/`<br>`teamsTemplates('educationStaff')` | 應用程式：<ul><li>OneNote已釘 (到一 **般卷)**</li></ul> |
|教育 -<br>PLC 小組 |`https://graph.microsoft.com/beta/`<br>`teamsTemplates('educationProfessionalLearningCommunity')` | 應用程式：<ul><li>OneNotePLC 筆記本 (釘到一般 **)**</ul></li>|
