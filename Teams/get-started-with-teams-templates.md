...
| 教育 -<br>課程小組 | `https://graph.microsoft.com/v1.0/`<br>`teamsTemplates('educationClass')` | 應用程式：<ul><li>OneNote課程筆記本 (釘到的一 **般)** </li><li>作業應用程式 (釘到的一 **般)**</li></ul> 小組屬性：<ul><li>小組可見度設定為 **HiddenMembership (** 無法) </li></ul> |
| 教育 -<br>教職員團隊 | `https://graph.microsoft.com/v1.0/`<br>`teamsTemplates('educationStaff')` | 應用程式：<ul><li>OneNote教職員筆記本 (釘到一 **般)**</li></ul> |
...
|品質和安全性 |`com.microsoft.teams.`<br>`template.QualitySafety`|頻道： <ul><li>一般<li>公告</li><li>第 1 行</li><li>第 2 行</li><li>第 3 行</li><li>安全</li><li>訓練課程</li><li>維護</li><li>有趣的專案</li></ul> 應用程式： <ul><li>Wiki</li></ul>|
