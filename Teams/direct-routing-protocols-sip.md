...
> [!NOTE]
> SIP 標頭在所使用的 SIP URI 中不包含 userinfo。 根據 [RFC 3261，區段 19.1.1](https://tools.ietf.org/html/rfc3261#section-19.1.1)，URI 的 userinfo 部分是選用的，當目的地主機沒有使用者概念，或當主機本身是被識別的資源時，可能會遺失。 如果 @ 符號出現在 SIP URI 中，則使用者欄位不得為空白。
