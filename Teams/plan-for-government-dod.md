...
ms.locfileid: "54339471"
---
# <a name="plan-for-office-365-government---dod-deployments"></a>規劃Office 365 政府版 - DoD 部署
...
此Office 365 政府版 - DoD 環境提供符合美國政府雲端服務需求的規範。 除了享受這些功能之外，Office 365還受益于下列功能，這些功能是 DoD Office 365 政府版獨一無二：
...
您可以針對美國政府客戶Office 365 政府版 DoD 方案，Office 365 政府版資格[要求](https://products.office.com/government/compare-office-365-government-plans#EligibilityRequirements)。 [](https://products.office.com/government/compare-office-365-government-plans)
...
|    |     |
|-----------|------------|
| ![描繪決策點的圖示](media/audio_conferencing_image7.png) <br/>決策點|<ul><li>決定 Office 365 政府版 - DoD 是否適合貴組織。</li><li>確認您的組織符合資格要求。</li></ul> |
...
|    |     |
|-----------|------------|
| ![描繪決策點的圖示](media/audio_conferencing_image7.png) <br/>決策點|<ul><li>決定是否需要修改任何預設 Office 365 政府版 - DoD 安全性設定，先解決以先瞭解您進行的任何變更的影響。</li></ul> |
...
為了配合我們的政府雲端客戶需求，Teams方案中的 Teams - DoD Office 365 政府版 與 Teams Enterprise差異。 請參閱下表，瞭解哪些功能可供使用。
