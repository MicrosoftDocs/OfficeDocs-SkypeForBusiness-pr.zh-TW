...
ms.locfileid: "62763666"
---
# <a name="microsoft-teams-certified-devices"></a>Microsoft Teams認證的裝置

Microsoft Teams裝置認證計畫可確保通過認證的裝置符合高標準，在整個 Teams 體驗Teams音訊、視視、使用者介面和使用者介面 (有較高的) 。 Microsoft 和 OEM 合作夥伴正積極合作，確保裝置符合所有認證需求，包括安全性、音訊和視Teams體驗，以及協助工具。
