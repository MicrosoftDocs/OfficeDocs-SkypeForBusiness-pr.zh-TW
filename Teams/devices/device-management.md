...
ms.locfileid: "58636997"
---
# <a name="manage-your-devices-in-microsoft-teams"></a>在 Microsoft Teams

您可以從系統管理中心Microsoft Teams管理組織中Microsoft Teams裝置。 您可以為貴組織查看及管理裝置庫存，以及執行更新、重新開機及監控裝置診斷等工作。 您也可以建立組式設定檔，並將設定檔指派給裝置或裝置群組。
...
有關管理員角色在 Teams 中Teams，請參閱使用 Teams[系統管理員角色來管理Teams。](../using-admin-roles.md)

## <a name="what-devices-can-you-manage"></a>您可以管理哪些裝置？

您可以管理任何通過認證並註冊的裝置，Teams。 使用者第一次在裝置上Teams裝置。 有關可管理的認證裝置清單，請參閱：
...
若要管理裝置，請在系統管理中心的左側導[Microsoft Teams，前往](https://admin.teams.microsoft.com)裝置，然後選取裝置類型。  每種類型的裝置都有各自的區段，可讓您個別管理它們。

## <a name="manage-teams-rooms-devices"></a>管理Teams 會議室裝置

您可以使用系統管理Teams，來查看及遠端系統管理Teams 會議室裝置。 Teams系統管理中心可讓您一目了然地查看哪些裝置健康，哪些裝置需要注意，並讓您專注于特定裝置，以查看有關裝置健康情況、會議績效、通話品質及周邊設備的詳細資訊。 

以下是您可以執行一些操作，以管理您的Teams 會議室裝置。 Teams 會議室裝置，可以在 Microsoft Teams [系統管理中心](https://admin.teams.microsoft.com)找到  >  **** Teams 會議室。

若要瞭解如何管理您的Teams 會議室裝置的詳細資訊，請參閱[管理Microsoft Teams 會議室。](../rooms/rooms-manage.md)
...
## <a name="manage-phones-collaboration-bars-teams-displays-and-teams-panels"></a>管理電話、共同Teams條、Teams面板 

在 Teams系統管理中心中，您可以查看及管理在貴組織Teams中註冊的電話、共同Teams、Teams顯示，以及Teams面板。 每個裝置的資訊包括裝置名稱、製造商、型號、使用者、狀態、動作、上次顯示和歷程記錄。 您可以自訂該視圖以顯示符合您需求的資訊。

如果您已經註冊Teams，Teams就會自動在 Microsoft Intune中註冊電話、共同合作橫條圖、Teams和麵板。 註冊裝置之後，即會確認裝置合規性，並且將條件式存取原則適用于裝置。

以下是一些如何管理電話、共同Teams顯示，以及Teams面板的範例。  
...
### <a name="use-configuration-profiles-in-teams"></a>在檔案中Teams
...
1. 在左側流覽中，前往裝置>選取Teams組>**類型**。 例如，選取面板Teams組設定檔的裝置  >    >  ****，為面板Teams設定檔。
2. 按一下 [新增 **]**。
...
1. 在左側流覽中，前往裝置>選取Teams類型。 例如，若要將組Teams設定檔指派給面板裝置，請選取 Teams ****  >  **裝置**。
