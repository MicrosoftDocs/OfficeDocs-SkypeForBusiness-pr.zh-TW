...
- [網站就緒](#site-readiness)：確認您的部署位置 (空間) 部署需求。
...
- 專用資源帳戶
- 電源供應 (面板通常支援 Power over 乙太網路， (PoE+) 電源。 請參閱 OEM 檔，以尋找任何裝置特定的電源需求。) 
...
>
>- 如果您已經在安裝 Teams 面板的會議空間中部署 Microsoft Teams 會議室，則資源帳戶已經有 [Microsoft Teams 會議室授權](../rooms/rooms-licensing.md)。 在這種情況下，您不需要購買個別的 Microsoft Teams 會議室標準版授權來部署面板。 系統管理員以與 Microsoft Teams 會議室相同的認證，以相同的空間，以登錄至面板裝置。
>
