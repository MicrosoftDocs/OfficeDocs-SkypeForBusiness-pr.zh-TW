...
若要深入瞭解這些功能及其使用方法，請參閱使用Microsoft Teams[面板](use-teams-panels.md)。

## <a name="partners-certified-for-teams-panels"></a>合作夥伴已Teams面板

若要深入瞭解合作夥伴通過面板Teams，請參閱[目前認證的Teams面板](teams-ip-phones.md#certified-teams-panels)。
...
根據在面板中部署Teams的會議空間數量，從其中一個經過認證的合作夥伴取得Teams[裝置](#partners-certified-for-teams-panels)。 請流覽合作夥伴的網站，深入瞭解裝置和採購選項。
...
若要設定Microsoft 365面板Teams資源帳戶，建議您購買Microsoft Teams 會議室標準版[授權](#license-requirement)。 若要瞭解如何建立資源帳戶並指派授權給資源帳戶，請參閱使用資源帳戶[Microsoft 365 系統管理中心。](resource-account-ui.md)
...
若要管理您的Teams面板裝置，在系統管理中心的左側導Microsoft Teams，請前往 Teams **裝置**  >  **窗格**。 您可以在這裡變更裝置組調設定檔、管理更新、重新開機裝置、新增和移除裝置標記等等。 詳細資訊，請參閱在 Teams 中[管理您的Teams](device-management.md)。
