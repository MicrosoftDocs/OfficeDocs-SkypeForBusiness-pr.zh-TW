...
ms.locfileid: "58972991"
---
# <a name="usb-audio-and-video-devices-certified-for-microsoft-teams"></a>USB 音訊和視Microsoft Teams

周邊認證計畫可確保 USB 周邊 (耳機、喇叭、網路) 等 USB 周邊設備提供豐富的音訊或視音訊品質。 認證裝置 (即&即) 即用即用，不需要額外Microsoft Teams通話商務用 Skype。 這些產品為使用者和系統管理員提供了很好的體驗。

若要探勘測試並認證Microsoft Teams的裝置，請前往 Teams[商店](https://products.office.com/microsoft-teams/across-devices/devices)。

有關使用電話控制支援Teams，請參閱在 Teams 中控制[Teams。](https://support.office.com/article/Control-calls-using-a-headset-in-Teams-65d6e104-444d-4013-b8c2-f11317dd69a8)
...
從 Teams 升級至之前通過認證的裝置時，使用者商務用 Skype。  所有通過認證的裝置都支援Microsoft Teams商務用 Skype使用者，只有一些差異。  認證也會提供特定裝置類別的進一步指定。

- **商務用 Skype升級Teams認證** 在此層級通過認證的裝置最初已通過 商務用 Skype。 Microsoft 已與裝置製造商合作，以提供最佳Teams整合體驗，而不對原始硬體進行任何變更。 當 *不在通話* 中時，Teams切換按鈕做為按鈕，並可能隨著時間包含更多函數。  此類別中的裝置可能會將Teams認證徽章放在行銷資料上。
...
- **進階版開啟麥克風Office** 所有耳機都經過測試，可提供清楚的音訊，但開啟辦公室和其他吵雜環境帶來更大的挑戰。 具有此指定名稱的耳機會聽到耳機使用者的聲音，但無法傳送其相鄰使用者的聲音。
...
- 啟用用戶端Teams或按下按鈕以回應通知，例如 (加入會議) 。
- 專為擴充性設計的認證 (新裝置/用戶端功能，以透過) 。
...
- 音訊裝置 (例如耳機和喇叭) 提供：
  - 使用 PC 或 Mac 裝置時的基本通話控制。 基本控制項包括接聽/掛斷、靜音/取消靜音和音量控制。
...
|聚                 |出航者 4320                                               |8/6/2021        |已認證Microsoft Teams                           |
|聚                 |出航者 4310                                               |8/6/2021        |已認證Microsoft Teams                           |
...
|EPOS/Sennheiser      |調整 200 系列耳機                                  |3/19/2021       |已認證Microsoft Teams                           |
|聚                 |遠航者焦點 2 耳機                                    |3/11/2021       |已認證Microsoft Teams                           |
|Jabra                |Evolve2 30 耳機                                         |3/1/2021        |已認證Microsoft Teams                           |
|微軟            |Surface Headphones 2+                                      |2/26/2021       |已認證Microsoft Teams                           |
|聚                 |Studio P15 影片欄                                       |2/1/2021        |已認證Microsoft Teams                           |
|聚                 |同步 40 個喇叭                                       |1/19/2021       |已認證Microsoft Teams                           |
|聚                 |使用 Poly BT600 USB 加密狗同步處理 40+ 部喇叭           |1/19/2021       |已認證Microsoft Teams                           |
|Yealink              |UH34 Dual/Mono 頭戴式耳機                                     |12/23/2020      |已認證Microsoft Teams                           |
|Yealink              |MP50 USB 電話                                             |12/23/2020      |已認證Microsoft Teams                           |
|Yealink              |WH67 DECT 耳機                                          |12/23/2020      |已認證Microsoft Teams                           |
|Yealink              |WH66 Dual/Mono DECT 耳機                                |12/23/2020      |已認證Microsoft Teams                           |
|Yealink              |WH63 DECT 耳機                                          |12/23/2020      |已認證Microsoft Teams                           |
|Yealink              |WH62 Dual/Mono DECT 耳機                                |12/23/2020      |已認證Microsoft Teams                           |
|EPOS/Sennheiser      |調整 100 系列耳機                                  |12/22/2020      |已認證Microsoft Teams                           |
|戴爾                 |Pro身歷聲耳機 - UC350                                 |12/21/2020      |商務用 Skype升級至 Microsoft Teams      |
|戴爾                 |Pro身歷聲耳機 - UC150                                 |12/21/2020      |商務用 Skype升級至 Microsoft Teams      |
|聯想               |Pro有線 VoIP 身歷聲耳機                              |12/21/2020      |商務用 Skype升級至 Microsoft Teams      |
|聚                 |Savi Office 7320                                           |12/18/2020      |已認證Microsoft Teams                           |
|聚                 |Savi Office 7310                                           |12/18/2020      |已認證Microsoft Teams                           |
...
|戴爾                 |C3422WE 監視器                                            |12/11/2020      |已認證Microsoft Teams                           |
|戴爾                 |C2722DE 監視器                                            |12/11/2020      |已認證Microsoft Teams                           |
|戴爾                 |C2422HE 監視器                                            |12/11/2020      |已認證Microsoft Teams                           |
|聚                 |使用 Poly BT600 USB 加密狗同步處理 20 + 喇叭          |11/9/2020       |已認證Microsoft Teams                           |
|聚                 |同步 20 部喇叭                                       |11/9/2020       |已認證Microsoft Teams                           |
|Jabra                |Evolve 65t 頭戴式耳機                                         |10/31/2020      |商務用 Skype升級至 Microsoft Teams      |
...
|Jabra                |演進 80 耳機                                          |8/23/2020       |商務用 Skype升級至 Microsoft Teams      |
|Jabra                |Evolve 40 頭戴式耳機                                          |8/23/2020       |商務用 Skype升級至 Microsoft Teams      |
|Jabra                |Evolve 30 II 頭戴式耳機                                       |8/23/2020       |商務用 Skype升級至 Microsoft Teams      |
|Jabra                |Evolve 20 頭戴式耳機                                          |8/23/2020       |商務用 Skype升級至 Microsoft Teams      |
|EPOS/Sennhesier      |COMMAND 260 USB PTT                                        |8/20/2020       |商務用 Skype升級至 Microsoft Teams      |
...
|Jabra                |Evolve 75 耳麥                                          |7/31/2020       |商務用 Skype升級至 Microsoft Teams      |
...
|Jabra                | 使用 Jabra Link 370 USB 加密狗使用 750 喇叭說話     | 5/21/2020       | 已Microsoft Teams                         |
...
| 聚                | Savi 8220 UC                                              | 4/20/2020      | 商務用 Skype升級至 Microsoft Teams     |
| 聚                | Savi 8240 Office                                          | 4/20/2020      | 商務用 Skype升級至 Microsoft Teams     |
| 聚                | Savi 8240 UC                                              | 4/20/2020      | 商務用 Skype升級至 Microsoft Teams     |
| 聚                | Savi 8245 Office                                          | 4/20/2020      | 商務用 Skype升級至 Microsoft Teams     |
| 聚                | Savi 8245 UC                                             | 4/20/2020      | 商務用 Skype升級至 Microsoft Teams     |
...
| 羅技            | Zone Wireless                                             | 4/8/2020       | 已Microsoft Teams                          |
...
| 聚                | 4210 Office                                       | 03/05/2020     | 已Microsoft Teams                          |
| 聚                | 出航者 4210 UC                                           | 03/05/2020     | 商務用 Skype升級至 Microsoft Teams     |
| 聚                | 4220 Office                                       | 03/05/2020     | 已Microsoft Teams                          |
| 聚                | 出航者 4220 UC                                           | 03/05/2020     | 商務用 Skype升級至 Microsoft Teams     |
| 聚                | 5200 Office                                       | 03/05/2020     | 已Microsoft Teams                          |
| 聚                | 出航者 5200 UC                                           | 03/05/2020     | 商務用 Skype升級至 Microsoft Teams     |
| 聚                | Blackwire 3310-M                                          | 03/05/2020     | 已認證Microsoft Teams                          |
| 聚                | Blackwire 3315-M                                          | 03/03/2020     | 已認證Microsoft Teams                          |
| 聚                | Blackwire 3320-M                                          | 03/05/2020     | 已認證Microsoft Teams                          |
| 聚                | Blackwire 3325-M                                          | 03/05/2020     | 已認證Microsoft Teams                          |
| 聚                | Calisto 3200-M                                            | 01/27/2020     | 已認證Microsoft Teams                          |
| Cresron            | CCS- MIC                                               | 12/18/2019     | 已認證Microsoft Teams                          |
| 森海塞爾          | SP 30T                                                    | 12/05/2019     | 已認證Microsoft Teams                          |
| Polycom             | Elara                                                     | 11/06/2019     | 已認證Microsoft Teams                          |
| Polycom             | Studio 音效欄                                           | 10/18/2019     | 已認證Microsoft Teams                          |
| Yealink             | UVC30                                                     | 10/18/2019     | 已認證Microsoft Teams                          |
| Jabra               | PanaCast                                                  | 08/14/2019     | 已認證Microsoft Teams                          |
