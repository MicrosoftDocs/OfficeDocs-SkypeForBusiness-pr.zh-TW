---
title: 設定 teams Android 裝置使用者介面Microsoft
ms.author: dstrome
author: dstrome
manager: serdars
audience: ITPro
...
ms.locfileid: "69392432"
---
# <a name="set-microsoft-teams-android-devices-user-interface"></a>設定 teams Android 裝置使用者介面Microsoft
...
在此影像中，使用者帳戶已獲指派[Microsoft Teams 共用裝置授權](/microsoftteams/teams-add-on-licensing/teams-shared-device-license)。 常見區域電話主要用於撥打和接聽電話。 因此，撥號鍵台會顯示在顯示器上：
...
> [!NOTE]
> 指派給使用者帳戶的授權必須至少與您想要的使用者介面擁有相同的授權權利。 **Microsoft Teams 共用裝置** 授權只允許常用的區域電話使用者介面。 **Teams 會議室** 授權可讓會議室和常用的區域電話使用者介面。 E3 或 E5 授權支援所有登入模式。
...
1. 啟動遠端Windows PowerShell會話，並使用下列 Cmdlet 連線至 Microsoft Teams：
...
## <a name="impact-on-microsoft-teams-admin-center"></a>影響Microsoft Teams 系統管理中心
...
與使用者介面偵測一樣，Teams 手機會根據指派給帳戶登入手機的授權進行分類。 例如，如果獲指派 **Microsoft Teams 共用裝置** 授權的帳戶登入電話，則該電話會同時顯示在預設的 [**所有電話**] 區段以及 [**共用區域電話**] 區段中。
