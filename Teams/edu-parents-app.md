...
- 如需有關設定監護人的指導方針，請參閱 [在 Teams 中與授課者聯繫](https://support.microsoft.com/topic/connect-with-educators-in-teams-ec2430c3-952a-4ba4-9891-1d1cab577960)。
...
- 授課者可以按一下監護人的電話號碼，在 Teams 中撥打他們。
...
1. 安裝最新的 Microsoft Teams PowerShell 模組預覽。
...
家長 App 預設為關閉，因此班級團隊擁有者必須透過 Teams 系統管理中心才能在班級團隊中看到它。 在 Teams 系統管理中心使用 [ [允許被發行者封鎖的應用程式](manage-apps.md#allow-the-apps-that-are-blocked-by-the-developers)] 開啟 [家長] 應用程式。
