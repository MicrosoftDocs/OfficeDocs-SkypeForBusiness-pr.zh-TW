...
- Teams監護人連絡人資料會使用 學校資料同步處理 (SDS) 在 SIS 中保持在最新狀態。
...
- 您需要學校資料同步處理 (SDS) 以填入每個學生的家長和監護人的 **相關連絡** 資訊。
...
### <a name="teams-admin-center---policies"></a>Teams系統管理中心 - 原則
...
> [!NOTE]
>家長和監護人在家長功能中被歸類為外部使用者，這表示他們沒有完整的租使用者許可權。 他們只能存取新增的聊天或聊天，以及在聊天中共用的檔案、影像及其他內容。
>
