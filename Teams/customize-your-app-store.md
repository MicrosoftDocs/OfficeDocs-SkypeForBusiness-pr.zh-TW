...
* 使用 Teams 用戶端預設佈景主題
* 選擇圖片。 當您選取背景圖片時，您可以上傳您所選擇的檔案。 背景應為 1212x100 像素，否則將會縮放成該大小。 不應大於 5 MB。 支援的格式為 .svg、.png 和 .jpg。
* 選擇自訂背景。 當您選取 **[選擇自訂色彩]** 時，色彩選擇器隨即會開啟。 調整色彩選擇器縮放，以選取您想要的顏色。

背背景影像或色彩會做為 Teams 租用戶應用程式目錄中頂端橫幅的背景。
