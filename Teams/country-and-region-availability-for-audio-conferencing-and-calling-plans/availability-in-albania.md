...
- Phone System
- Calling Plans
description: 以下是適用于商務用 Skype的 Microsoft 365 和 Office 365 服務，以及適用于阿爾巴尼亞的 Microsoft Teams。
ms.openlocfilehash: 84a439d3ea508ec766498c6c4ac1d1c97aa62148
ms.sourcegitcommit: a6f4c459b9c8154814a8a5b098bde1e374348c99
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 07/05/2022
ms.locfileid: "66616215"
---
# <a name="availability-in-albania"></a>阿爾巴尼亞的可用性

[尋找其他國家或地區](country-and-region-availability-for-audio-conferencing-and-calling-plans.md)，或深入了解音訊會議與通話方案的適用國家/地區。

以下是適用于商務用 Skype的 Microsoft 365 和 Office 365 服務，以及適用于阿爾巴尼亞的 Microsoft Teams。
  
## <a name="audio-conferencing"></a>音訊會議

|**功能**|**詳細資料**|
|:-----|:-----|
|音訊會議是否可供購買？  <br/> |是的。 每分鐘付費  <br/> |
