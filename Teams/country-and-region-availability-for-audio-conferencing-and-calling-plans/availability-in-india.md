...
以下是適用于商務用 Skype 和適用于印度的 Microsoft 團隊的 Office 365 服務。
...
|**功能**|**詳細資料**|
|:-----|:-----|
|您可以在哪一或哪些主要城市取得付費電話號碼？  <br/> |<ul><li>Chennai <li>孟買<li>其他[要求的](../manage-phone-numbers-for-your-organization/contact-pstn-service-desk.md)城市</ul> |
|是否有付費電話號碼？  <br/> |是  <br/> |
