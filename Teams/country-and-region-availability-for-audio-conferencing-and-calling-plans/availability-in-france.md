...
- Phone System
- Calling Plans
description: 以下是適用于法國的 商務用 Skype 和 Microsoft Teams 適用的 Microsoft 365 和 Office 365 服務。
...
---
# <a name="availability-in-france"></a>法國的可用性

[尋找其他國家或地區](country-and-region-availability-for-audio-conferencing-and-calling-plans.md)，或深入了解音訊會議與通話方案的適用國家/地區。

以下是適用于法國的 商務用 Skype 和 Microsoft Teams 適用的 Microsoft 365 和 Office 365 服務。
...
|:-----|:-----|
|音訊會議是否可供購買？  <br/> |是  <br/> |
|是否會自動為音訊會議指派電話號碼？  <br/> |是，適用於：<br/><ul><li> 巴黎</ul> 如果您想要專屬的電話號碼，請參閱[取得商務用 Skype 和 Microsoft Teams 的服務電話號碼](../getting-service-phone-numbers.md)。  <br/> |
...
|可以撥打法國進階號碼的撥出電話嗎？ <br/> | 是的，使用通訊點數每分鐘支付一次時，完全支援。 <br/> |
...
|**功能**|**詳細資料**|
|:-----|:-----|
|哪些首都/首要城市能提供您付費電話號碼？  <br/> | <ul><li>憤怒 <li>  波爾多 <li>  Carcassonne <li>  第戎 <li>  格勒諾布爾 <li>  Le Havre <li>  里爾 <li>  里昂 <li>  馬賽 <li>  蒙彼利埃 <li>  南特 <li>  好 <li>  巴黎 <li>  蘭斯 <li>  雷恩 <li>  Saint-Etienne <li>  斯特拉斯堡 <li>  土倫 <li>  圖盧茲 </ul> |
|有提供付費電話號碼嗎？  <br/> |是  <br/> |
|是否提供免付費電話號碼？  <br/> |是  <br/> |
