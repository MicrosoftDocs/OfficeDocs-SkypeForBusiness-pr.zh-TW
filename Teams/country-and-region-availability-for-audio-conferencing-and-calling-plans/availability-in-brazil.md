...
以下是適用于巴西的商務用 Skype 和 Microsoft Teams 的 Microsoft 365 和 Office 365 服務。
...
|:-----|:-----|
|音訊會議是否可供購買？  <br/> |是  <br/> |
|是否會自動為音訊會議指派電話號碼？  <br/> |是，適用於：<br/><ul><li> 聖保羅</ul>如果您想要專屬的電話號碼，請參閱[取得商務用 Skype 和 Microsoft Teams 的服務電話號碼](../getting-service-phone-numbers.md)。  <br/> |
