...
以下是適用于商務用 Skype 和適用于宏都拉斯的 Microsoft 團隊版 Office 365 服務。
...
|**功能**|**詳細資料**|
|:-----|:-----|
|您可以在哪一或哪些主要城市取得付費電話號碼？  <br/> |Tegucigalpa （[根據要求](../manage-phone-numbers-for-your-organization/contact-pstn-service-desk.md)） <br/> |
