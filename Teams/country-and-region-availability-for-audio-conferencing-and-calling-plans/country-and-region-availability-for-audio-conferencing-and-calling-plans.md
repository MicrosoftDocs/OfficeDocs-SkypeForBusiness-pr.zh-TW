...
> [!IMPORTANT]
> 沒有任何資源會包含音訊會議的所有撥入號碼清單。 若要找出您所在的區域或國家/地區是否有可用的撥入電話號碼，請移至 [商務用 Skype 系統管理中心] > [語音] > [電話號碼]，然後依序按一下 [新增] 和 [新增服務號碼]。 使用 [國家/地區]、[州/地區] 和 [城市] 的清單來篩選搜尋。 如果您正在尋找免付費服務號碼，請 **從** 州/地區清單中選取免 **付費** 。
...
與電話系統一起使用時，通話方案可讓使用者撥打及接聽電話。 您先取得使用者 (訂閱) 電話號碼 (而不是) 指派給使用者的服務號碼，然後指派通話方案。 可用的通話方案有兩種：**國內** 與 **國內及國際**。 如需詳細資訊，請參閱[電話系統和通話方案](../calling-plan-landing-page.md)。
