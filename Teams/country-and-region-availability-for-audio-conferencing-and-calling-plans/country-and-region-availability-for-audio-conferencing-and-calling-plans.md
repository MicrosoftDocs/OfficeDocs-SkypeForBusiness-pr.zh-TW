...
> [!IMPORTANT]
> 沒有任何資源會包含音訊會議的所有撥入號碼清單。 若要找出您所在的區域或國家/地區是否有可用的撥入電話號碼，請移至 [商務用 Skype 系統管理中心] > [語音] > [電話號碼]，然後依序按一下 [新增] 和 [新增服務號碼]。 使用 [國家/地區]、[州/地區] 和 [城市] 的清單來篩選搜尋。 如果您要尋找免付費服務號碼， **請從省** /市/區清單中選取免 **付費** 。
