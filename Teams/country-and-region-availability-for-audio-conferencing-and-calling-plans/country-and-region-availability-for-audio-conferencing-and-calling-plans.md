...
- LIL_Placement
- seo-marvel-mar2020
description: 瞭解國家/地區電話系統是否提供音訊會議、電話系統、通話方案、通訊信用額度，以及免付費和免付費電話號碼。
ms.openlocfilehash: ab534a020e91caaa6f9608857d6de76f5505b899
ms.sourcegitcommit: 8f999bd2e20f177c6c6d8b174ededbff43ff5076
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 01/15/2022
ms.locfileid: "62056073"
---
...
驗證其中一個 商務用 Skype 或 Microsoft Teams 服務是否可用之後，您即會看到 商務用 Skype 和 Microsoft Teams 附加元件授權[，](../teams-add-on-licensing/microsoft-teams-add-on-licensing.md)來協助您購買授權，並將授權指派給使用者。
...
> [!CAUTION]
> 撥打免付費或免費電話號碼可能無法，因為部分免付費號碼只能在國家/地區內特定國家/地區內運作。 例如，如果您從美國撥出到巴西的免付費號碼，通話可能不會成功，因為通話不是從巴西國內或巴西的特定地區撥打。 撥打免付費號碼的能力會因撥打免付費號碼的限制而差異很大。 很抱歉，我們無法控制這種行為，因此您的體驗可能會視撥打的免費電話號碼和免付費號碼的限制而有所差異。
...
使用 電話系統，您可以使用付費或免付費號碼 (自動回應和通話佇列，) 接聽貴組織的來電。 當您為使用者新增通話方案時，他們可以使用 商務用 Skype 處理基本的通話控制工作，例如撥打和接聽來電、轉接通話，以及將通話靜音和取消靜音。 **電話系統** 使用者在通訊錄中按一下名稱，商務用 Skype就會打電話給該人員。 若要撥打和 **接聽電話系統，** 使用者可以使用他們的行動裝置、膝上型電腦或 PC 耳機，或許多 IP 電話之一，商務用 Skype。
...
除了取得個別使用者的電話號碼之外，也可以搜尋及取得電話或免付費電話號碼等服務，例如音訊會議 (會議) 、自動語音機和通話佇列。 這些電話號碼稱為服務號碼。
...
如果您沒有設定通訊信用額度，並指派授權給使用者，而且您組織的 (視您的通話方案或音訊會議方案或您的國家/地區) 而用完，他們將無法撥打電話或撥出會議。 若要深入了解 (包括建議的金額)，請參閱[什麼是通訊點數？](../what-are-communications-credits.md)
