...
> - [土克斯及開科斯群島](availability-in-turks-and-caicos-islands.md)
...
**如果您要尋找所有國家/地區的試算表，請下載並儲存 [雲端語音功能的國家/地區可用性試算表](https://download.microsoft.com/download/d/b/6/db6992c5-ec9a-4b02-8742-59df17dd90a7/country-and-region-availability-(v-19OCT2021)-(en-us).xlsx)**。

***

在您確認其中一個 Teams 服務是否可供使用之後，您可以看到 [Microsoft Teams 附加](../teams-add-on-licensing/microsoft-teams-add-on-licensing.md) 元件授權，以協助您購買授權並將它們指派給使用者。
...
貴組織內的人員有時會需要透過電話來加入會議。 Teams 包含音訊會議功能，僅適用于此情況！ 人員可以使用電話撥入會議，而不是使用行動裝置或電腦上的 Teams 應用程式。 當您決定要為組織安排音訊會議時，請為組織中即將排程/主持 **音訊** 會議的每個人員購買一個音訊會議授權。
  
透過音訊會議，您的使用者可以使用免付費電話號碼和免付費電話號碼撥入會議。 組織若已啟用音訊會議功能，系統便會自動將下列國家/地區的付費電話號碼當作共用的音訊會議號碼來指派給組織。 您可以從其他城市將專用付費和免付費電話號碼指派給貴組織。

> [!IMPORTANT]
> 沒有任何資源會包含音訊會議的所有撥入號碼清單。 若要瞭解您所在的地區或國家/地區是否有可用的撥入電話號碼，請移至 Teams 系統 **管理中心**  >  **語音**  >  **電話號碼**，按一下 [**新增**]，然後按一下 [**新增服務號碼]**。 使用 [國家/地區]、[州/地區] 和 [城市] 的清單來篩選搜尋。 如果您要尋找免付費服務號碼，請從 **[州/地區**] 清單中選取 **免付費** 服務。
...
在音訊會議中，[*撥號給我*] 功能可用來讓其他人加入撥入式會議。 使用本文中的下拉式清單來搜尋國家/地區，並查看這項功能是否可使用。

> [!CAUTION]
> 無法撥打免付費或免費電話號碼，因為部分免付費電話號碼只能從特定國家/地區或國家/地區內運作。 例如，如果您從美國撥出到巴西的免付費電話號碼，通話可能無法成功，因為通話並非來自巴西境內或巴西的特定地區。 撥出到免付費號碼的功能會根據撥打的免付費號碼限制而有大幅差異。 很抱歉，我們無法控制此行為，因此，您的體驗可能會因撥打的免付費電話號碼和免付費電話號碼的限制而有所不同。
  
您可以使用 [通訊點](../what-are-communications-credits.md)數，從會議撥出到全球其他未列于下方的國家/地區。 對於這些使用者，您必須 [為組織設定通訊點](../set-up-communications-credits-for-your-organization.md)數。

### <a name="phone-system"></a>電話系統

使用 [電話系統]，您可以建立自動語音應答和通話佇列， (使用付費或免付費電話號碼) 來接聽組織的來電。 當您為使用者新增通話方案時，他們可以使用 Teams 來處理基本的撥號控制工作，例如撥打和接聽電話、轉接電話，以及靜音和取消靜音通話。 **電話系統** 使用者按一下通訊錄中的名稱，Teams 就會撥打電話給那個人。 若要撥打和接聽電話， **電話系統** 使用者可以使用行動裝置、配備膝上型電腦或電腦的耳機，或是可搭配 Teams 使用的眾多 IP 手機之一。
...
### <a name="toll-and-toll-free-phone-numbers-for-services"></a>服務的免付費電話號碼

除了取得個別使用者的電話號碼，您也可以搜尋及取得電話會議網) 橋 (、自動語音應答和通話佇列等服務的付費或免付費電話號碼。 這些電話號碼稱為服務號碼。
  
以下是一份首都和主要城市的清單，您可以從這份清單中取得可與音訊會議和通話方案搭配使用的付費服務號碼。 您可以使用 **Teams 系統管理中心**，從這些位置取得付費服務號碼。
  
如果您想要取得付費或免付費服務號碼，您可以參閱 [取得服務電話號碼](../getting-service-phone-numbers.md)。 如果您已經有要從其他提供者移轉的付費或免付費服務號碼，請參閱 [管理貴組織的電話號碼](../manage-phone-numbers-for-your-organization/manage-phone-numbers-for-your-organization.md)。
...
如果您未設定通訊點數並指派授權給使用者，而且貴組織 (通話方案或音訊會議方案或您的國家/地區) ，您的組織通話分鐘數不足，他們將無法撥打電話或從會議撥出。 若要深入了解 (包括建議的金額)，請參閱[什麼是通訊點數？](../what-are-communications-credits.md)

## <a name="related-topics"></a>相關主題

[取得 Microsoft Teams 的服務電話號碼](../getting-service-phone-numbers.md)
