...
以下是適用于葡萄牙的商務用 Skype 和 Microsoft Teams 的 Microsoft 365 和 Office 365 服務。
...
|:-----|:-----|
|音訊會議是否可供購買？  <br/> |是  <br/> |
|是否會自動為音訊會議指派電話號碼？  <br/> |是，適用於：<br/><ul><li> 里斯本</ul>如果您想要專用電話號碼，請參閱取得 [服務電話號碼](../getting-service-phone-numbers.md)。  <br/> |
