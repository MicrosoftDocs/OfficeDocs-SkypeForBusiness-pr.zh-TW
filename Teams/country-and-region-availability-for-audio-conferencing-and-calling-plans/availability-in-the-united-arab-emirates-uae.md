...
- Phone System
- Calling Plans
description: 以下是適用于商務用 Skype 和適用于阿拉伯聯合大公國的 Microsoft 團隊的 Microsoft 365 和 Office 365 服務。
ms.openlocfilehash: 09e2fc5402966157cd1f3fc4acc1030abd5a82b4
ms.sourcegitcommit: 1c2359f10ad5f5ec10dc52508ef4774c04b631ab
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 05/14/2020
ms.locfileid: "44230531"
---
# <a name="availability-in-the-united-arab-emirates-uae"></a>阿拉伯聯合大公國（UAE）的可用性

[尋找其他國家或地區](country-and-region-availability-for-audio-conferencing-and-calling-plans.md)，或深入了解音訊會議與通話方案的適用國家/地區。

以下是適用于商務用 Skype 和適用于阿拉伯聯合大公國的 Microsoft 團隊的 Microsoft 365 和 Office 365 服務。
