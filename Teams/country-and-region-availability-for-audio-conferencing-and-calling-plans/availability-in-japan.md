...
|:-----|:-----|
|音訊會議是否可供購買？  <br/> |是  <br/> |
|是否會自動為音訊會議指派電話號碼？  <br/> |是，適用於：<br/><ul><li> 東京</ul> 如果您想要專屬的電話號碼，請參閱[取得商務用 Skype 和 Microsoft Teams 的服務電話號碼](../getting-service-phone-numbers.md)。  <br/> |
...
> [!IMPORTANT]
> 若要刪除由 SoftBank (提供的) 使用者 (，請) 與 SoftBank 聯繫。
> 若要更新由 SoftBank (提供的) 使用者 (的緊急位址資訊) 請直接與 SoftBank 聯繫。
