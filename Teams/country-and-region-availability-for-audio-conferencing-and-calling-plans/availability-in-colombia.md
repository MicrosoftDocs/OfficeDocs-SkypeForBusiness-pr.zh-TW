...
ms.locfileid: "37570501"
---
# <a name="availability-in-colombia"></a>哥倫比亞中的可用性

[尋找其他國家或地區](country-and-region-availability-for-audio-conferencing-and-calling-plans.md)，或進一步瞭解音訊會議與通話方案的國家/地區可用性。

以下是適用于商務用 Skype 的 Office 365 服務，以及哥倫比亞適用的 Microsoft 團隊。
...
|:-----|:-----|
|音訊會議是否可供購買？  <br/> |是的  <br/> |
|是否會自動為音訊會議指派電話號碼？  <br/> |是，適用于：<br/><ul><li> 波哥大</ul>如果您需要專用的電話號碼，請參閱[取得商務用 Skype 和 Microsoft 團隊的服務電話號碼](/microsoftteams/getting-service-phone-numbers)。  <br/> |
...
|**功能**|**詳細資料**|
|:-----|:-----|
|您可以在哪一或哪些主要城市取得付費電話號碼？  <br/> | <ul><li>波哥大 <li>  Medellin </ul> |
|是否有付費電話號碼？  <br/> |是的  <br/> |
