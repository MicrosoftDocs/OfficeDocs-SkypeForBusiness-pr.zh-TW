...
- Phone System
- Calling Plans
description: 以下是適用于商務用 Skype 和 Microsoft 團隊（適用于巴拉圭）的 Microsoft 365 和 Office 365 服務。
ms.openlocfilehash: 608b1f9afbb191d8b78d42c886a6459c32aaaa9a
ms.sourcegitcommit: 1c2359f10ad5f5ec10dc52508ef4774c04b631ab
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 05/14/2020
ms.locfileid: "44230341"
---
# <a name="availability-in-paraguay"></a>巴拉圭中的可用性

[尋找其他國家或地區](country-and-region-availability-for-audio-conferencing-and-calling-plans.md)，或深入了解音訊會議與通話方案的適用國家/地區。

以下是適用于商務用 Skype 和 Microsoft 團隊（適用于巴拉圭）的 Microsoft 365 和 Office 365 服務。
