...
以下是適用于商務用 Skype 和適用于越南的 Microsoft 團隊的 Microsoft 365 和 Office 365 服務。
...
|**功能**|**詳細資料**|
|:-----|:-----|
|哪些首都/首要城市能提供您付費電話號碼？  <br/> |<ul><li>河內（[根據要求](../manage-phone-numbers-for-your-organization/contact-pstn-service-desk.md)）<li>Ho Chi 胡志明市（[根據要求](../manage-phone-numbers-for-your-organization/contact-pstn-service-desk.md)）</ul>  <br/> |
