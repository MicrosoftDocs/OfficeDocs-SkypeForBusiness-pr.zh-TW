...
以下是適用于奈及利亞的商務用 Skype 和 Microsoft 團隊版 Office 365 服務。
...
|**功能**|**詳細資料**|
|:-----|:-----|
|您可以在哪一或哪些主要城市取得付費電話號碼？   | Lagos （[根據要求](../manage-phone-numbers-for-your-organization/contact-pstn-service-desk.md)） <br/> |
