...
- Phone System
- Calling Plans
description: 以下是適用于 benin 的 商務用 Skype 和 Microsoft Teams 適用的 Microsoft 365 和 Office 365 服務。
ms.openlocfilehash: de9d0251b34ff06ef8da5add7bc727b8b0223716
ms.sourcegitcommit: a6f4c459b9c8154814a8a5b098bde1e374348c99
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 07/05/2022
ms.locfileid: "66616232"
---
# <a name="availability-in-benin"></a>Benin 中的可用性

[尋找其他國家或地區](country-and-region-availability-for-audio-conferencing-and-calling-plans.md)，或深入了解音訊會議與通話方案的適用國家/地區。

以下是適用于 benin 的 商務用 Skype 和 Microsoft Teams 適用的 Microsoft 365 和 Office 365 服務。
