...
以下是適用于商務用 Skype 的 Office 365 服務和適用于烏拉圭的 Microsoft 團隊。
...
|**功能**|**詳細資料**|
|:-----|:-----|
|您可以在哪一或哪些主要城市取得付費電話號碼？  <br/> | 蒙特維多（[根據要求](../manage-phone-numbers-for-your-organization/contact-pstn-service-desk.md)） <br/> |
