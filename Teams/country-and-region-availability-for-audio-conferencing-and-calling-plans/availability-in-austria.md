...
- Phone System
- Calling Plans
description: 以下是適用于奧地利的 商務用 Skype 和 Microsoft Teams 適用的 Microsoft 365 和 Office 365 服務。
ms.openlocfilehash: 94eeaaa6693f96936a590ab7e2611d1c5753f30d
ms.sourcegitcommit: 173bdbaea41893d39a951d79d050526b897044d5
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/07/2022
ms.locfileid: "67271658"
---
# <a name="availability-in-austria"></a>奧地利的可用性

[尋找其他國家或地區](country-and-region-availability-for-audio-conferencing-and-calling-plans.md)，或深入了解音訊會議與通話方案的適用國家/地區。

以下是適用于奧地利的 商務用 Skype 和 Microsoft Teams 適用的 Microsoft 365 和 Office 365 服務。
...
|:-----|:-----|
|音訊會議是否可供購買？  <br/> |是  <br/> |
|是否會自動為音訊會議指派電話號碼？  <br/> |是，適用於：<br/><ul><li>維也納 </ul>如果您想要專用電話號碼，請參閱 [取得服務電話號碼](../getting-service-phone-numbers.md)。  <br/> |
