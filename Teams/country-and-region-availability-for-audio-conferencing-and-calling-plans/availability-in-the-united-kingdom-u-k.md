...
|:-----|:-----|
|音訊會議是否可供購買？  <br/> |是的  <br/> |
|是否會自動為音訊會議指派電話號碼？  <br/> |是, 適用于: <br/><ul><li> 位於</ul>如果您需要專用的電話號碼, 請參閱[取得商務用 Skype 和 Microsoft 團隊的服務電話號碼](/microsoftteams/getting-service-phone-numbers)。  <br/> |
...
|:-----|:-----|
|通話方案可供購買嗎？  <br/> |是的  <br/> |
|通話方案可用的分鐘數。 |每個行事曆月提供四個方案選項: <ul><li>120分鐘國內通話方案 </li><li>240分鐘國內通話方案</li></li><li>1200分鐘國內通話方案 </li></li><li>國內和國際通話方案: 1200 分鐘 (國內) 或-600 分鐘的國際通話 (在行事曆月份中先達到)</li></li> 
|可以撥出電話給津貼號碼嗎？ <br/> | 部分支援: 共用成本數位的呼叫 (首碼44843、44844、44845、44870、44871、44872) 都支援使用通訊點數來每分鐘支付。  不支援呼叫449XX 的首碼。 <br/> |
...
|**功能**|**詳細資料**|
|:-----|:-----|
|您可以在哪一或哪些主要城市取得付費電話號碼？  <br/> |<ul><li>Birmingham <li>  Bolton <li>  Bournemouth <li>  Bradford <li>  Brighton <li>  Bristol <li>  Coventry <li>  凸 <li>  Leeds <li>  Leicester <li>  Liverpool <li>  位於 <li>  曼徹斯特 <li>  Newcastle <li>  Nottingham <li>  Plymouth <li>  Sheffield <li>  Stoke-Trent <li>  Teesside (Middlesbrough) </ul> |
|是否有付費電話號碼？  <br/> |是的  <br/> |
