...
- Phone System
- Calling Plans
description: 以下是適用于德國的商務用 Skype 和 Microsoft Teams 的 Microsoft 365 和 Office 365 服務。
ms.openlocfilehash: 2bf89b622423610e35d2e118c2a5ab1f51ce7c0b
ms.sourcegitcommit: 01087be29daa3abce7d3b03a55ba5ef8db4ca161
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 03/23/2021
ms.locfileid: "51118101"
---
# <a name="availability-in-germany"></a>德國的可用性

[尋找其他國家或地區](country-and-region-availability-for-audio-conferencing-and-calling-plans.md)，或深入了解音訊會議與通話方案的適用國家/地區。

以下是適用于德國的商務用 Skype 和 Microsoft Teams 的 Microsoft 365 和 Office 365 服務。
...
|:-----|:-----|
|音訊會議是否可供購買？  <br/> |是  <br/> |
|是否會自動為音訊會議指派電話號碼？  <br/> |是，適用於：<br/><ul><li> 慕尼克</ul>如果您想要專屬的電話號碼，請參閱[取得商務用 Skype 和 Microsoft Teams 的服務電話號碼](../getting-service-phone-numbers.md)。  <br/> |
...
|:-----|:-----|
|可以購買通話方案嗎？  <br/> |是  <br/> |
|通話方案可用的通話分鐘數。 |每個日曆月提供四種方案選項： <ul><li>120 分鐘的國內通話方案 </li><li>240 分鐘的國內通話方案</li></li><li>1200 分鐘的國內通話方案 </li></li><li>國內和國際通話方案：1200 分鐘的國內通話或 600 分鐘的國際通話 (以在一個日曆月份內第一次撥打) </li></li>|
...
|**功能**|**詳細資料**|
|:-----|:-----|
|哪些首都/首要城市能提供您付費電話號碼？  <br/> |<ul> <li>法蘭克福  <li> 慕尼克 </ul> <br/> |
|有提供付費電話號碼嗎？  <br/> |是  <br/> |
|是否提供免付費電話號碼？  <br/> |是  <br/> |
