...
- Phone System
- Calling Plans
description: 以下是適用于關島Microsoft 365 Office 365和商務用 Skype Microsoft Teams和Microsoft Teams服務。
ms.openlocfilehash: 2e0b73580602b0771d0bf950e165e7de566aae6d
ms.sourcegitcommit: 9ef6e36eeba7db70971f4eb1a45f0ded394b1fe6
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 01/25/2022
ms.locfileid: "62192094"
---
# <a name="availability-in-guam"></a>關島的可用性

[尋找其他國家或地區](country-and-region-availability-for-audio-conferencing-and-calling-plans.md)，或深入了解音訊會議與通話方案的適用國家/地區。

以下是適用于關島Microsoft 365 Office 365和商務用 Skype Microsoft Teams和Microsoft Teams服務。
