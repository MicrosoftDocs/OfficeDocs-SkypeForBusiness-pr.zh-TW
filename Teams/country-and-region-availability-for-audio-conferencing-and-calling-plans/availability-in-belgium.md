...
- Phone System
- Calling Plans
description: 以下是適用于比利時的 商務用 Skype 和 Microsoft Teams 適用的 Microsoft 365 和 Office 365 服務。
ms.openlocfilehash: 31277c977f35f1ff07fce42708edccee69b380c2
ms.sourcegitcommit: 173bdbaea41893d39a951d79d050526b897044d5
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 08/07/2022
ms.locfileid: "67268638"
---
# <a name="availability-in-belgium"></a>比利時的可用性

[尋找其他國家或地區](country-and-region-availability-for-audio-conferencing-and-calling-plans.md)，或深入了解音訊會議與通話方案的適用國家/地區。

以下是適用于比利時的 商務用 Skype 和 Microsoft Teams 適用的 Microsoft 365 和 Office 365 服務。
...
|:-----|:-----|
|音訊會議是否可供購買？  <br/> |是  <br/> |
|是否會自動為音訊會議指派電話號碼？  <br/> |是，適用於：<br/><ul><li> 布魯塞爾</ul>如果您想要專屬的電話號碼，請參閱[取得商務用 Skype 和 Microsoft Teams 的服務電話號碼](../getting-service-phone-numbers.md)。  <br/> |
...
|**功能**|**詳細資料**|
|:-----|:-----|
|哪些首都/首要城市能提供您付費電話號碼？  <br/> | <ul><li>布魯日<li>  布魯塞爾 <li>Charleroi <li>  根特 <li>  老爺子 <li>  納裡 </ul> |
|有提供付費電話號碼嗎？  <br/> |是  <br/> |
|是否提供免付費電話號碼？  <br/> |是  <br/> |
   
 如果您想要取得音訊會議、自動語音應答和通話佇列的付費電話號碼和免付費電話號碼，請參閱[取得 商務用 Skype 和 Microsoft Teams 的服務電話號碼](../getting-service-phone-numbers.md)。
