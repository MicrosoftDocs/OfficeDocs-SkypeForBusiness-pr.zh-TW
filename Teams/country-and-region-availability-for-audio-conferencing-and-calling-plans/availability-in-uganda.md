...
- Phone System
- Calling Plans
description: 以下是適用于烏干達的 商務用 Skype 和 Microsoft Teams 適用的 Microsoft 365 和 Office 365 服務。
ms.openlocfilehash: 4e08fc79479db944188acf9e7516a5b999aa65e6
ms.sourcegitcommit: 0dda332951df3b946097d90a4923eb191fd86b4c
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 07/14/2022
ms.locfileid: "66789968"
---
# <a name="availability-in-uganda"></a>在烏干達的可用性

[尋找其他國家或地區](country-and-region-availability-for-audio-conferencing-and-calling-plans.md)，或深入了解音訊會議與通話方案的適用國家/地區。

以下是適用于烏干達的 商務用 Skype 和 Microsoft Teams 適用的 Microsoft 365 和 Office 365 服務。
