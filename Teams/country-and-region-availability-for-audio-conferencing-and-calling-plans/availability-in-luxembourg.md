...
以下是適用于商務用 Skype 和 Microsoft 團隊提供的 Office 365 服務。
...
|:-----|:-----|
|音訊會議是否可供購買？  <br/> |是的  <br/> |
|是否會自動為音訊會議指派電話號碼？  <br/> |是, 適用于:<br/><ul><li> 盧森堡</ul> 如果您需要專用的電話號碼, 請參閱[取得商務用 Skype 和 Microsoft 團隊的服務電話號碼](/microsoftteams/getting-service-phone-numbers)。  <br/> |
...
|**功能**|**詳細資料**|
|:-----|:-----|
|您可以在哪一或哪些主要城市取得付費電話號碼？  <br/> |盧森堡  <br/> |
|是否有付費電話號碼？  <br/> |是的  <br/> |
