...
---
# <a name="get-started-with-teams-templates-in-the-admin-center"></a>在系統管理中心Teams範本開始使用
...
Teams範本是專為業務需求或專案所設計之小組結構的預先建立定義。 使用預先建建的範本或建立您自己的範本。 Teams範本，您可以利用不同主題的頻道，快速建立豐富的共同合作空間，並預先安裝 App 以使用任務關鍵型內容和服務。 Teams範本提供預先定義的小組結構，可協助您輕鬆建立整個組織的一致團隊。 目前，您可以從範本或 Microsoft Teams建立[Graph。](get-started-with-teams-templates.md)
...
範本會包含及支援小組中的大部分屬性。 但目前不支援一些屬性和功能。 下表提供包含哪些內容的快速摘要，以及範本中未包含Teams摘要。

| **由範本支援的Teams屬性** | **範本尚未支援Teams屬性** |
| ------------------------------------------------ | -------------------------------------------------------- |
| 範本類型 | 團隊成員資格 |
| 團隊名稱 | 小組圖片 |
| 團隊描述 | 頻道設定 |
...
|上載員工|`com.microsoft.teams.template.OnboardEmployees` | 頻道： <ul><li>一般</li> <li>公告</li> <li>員工聊天</li> <li>訓練</li></ul>應用程式：<ul><li>Wiki</li><li>社區</li><li>Planner</li><li>員工構想</li></ul>|
