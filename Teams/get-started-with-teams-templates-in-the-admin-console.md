...
ms.collection:
- M365-collaboration
description: 瞭解小組範本，以及如何在Microsoft Teams系統管理中心管理它們。
f1.keywords:
- CSH
ms.custom:
...
>
> - GCC環境中的小組範本不支援敏感度標籤。 [從範本建立團隊] 流程中的敏感度標籤選項不會套用至團隊。

## <a name="overview"></a>概觀

Microsoft Teams中的小組範本是針對業務需求或專案所設計的團隊結構定義。 身為系統管理員，您可以使用範本，在組織中輕鬆部署一致的團隊。 透過範本，您的使用者可以使用預先定義的設定、頻道和應用程式，快速建立豐富的共同作業空間。

您可以在Microsoft Teams系統管理中心或使用 PowerShell 管理小組範本。 您可以使用我們預先建立的範本，您也可以 [建立自己的自訂範本](#create-your-own-team-templates)。 您也可以[套用範本原則](#apply-team-template-policies)來控制哪些範本可供使用者在 Teams 中使用。

本文提供您在Teams系統管理中心使用小組範本的概觀。 您將瞭解範本支援的屬性、我們提供的預先建置範本、範本大小限制、如何建立及管理範本等等。

> [!NOTE]
> 您的使用者可以在 Teams 應用程式中[，從預先建立或自訂的團隊範本建立團隊](https://support.microsoft.com/office/create-a-team-from-a-template-a90c30f3-9940-4897-ab5b-988e69e4cd9c)。 開發人員也可以使用 Microsoft Graph，以程式設計方式從預先建立的團隊範本建立團隊。 若要深入瞭解，請[參閱使用 Microsoft Graph 使用小組範本開始](get-started-with-teams-templates.md)。
...
> [!NOTE]
> 我們會在未來版本的 Microsoft Teams 中新增更多範本功能，因此請返回查看支援屬性的最新資訊。

## <a name="pre-built-team-templates-in-the-teams-admin-center"></a>Teams系統管理中心預先建立的團隊範本

以下是 Teams 系統管理中心中預先建立的團隊範本。 預先建立的範本是我們為特定產業建立的範本。 若要檢視這些範本，請在Teams系統管理中心的左側導覽中，移至 **Teams**  >  **Team 範本]**。
...
如需詳細資訊，請參閱[Teams的限制和規格](limits-specifications-teams.md)。
...
若要檢視小組範本，請在Teams系統管理中心的左側導覽中，移 **至 Teams**  >  **Team 範本]**。 選取範本以查看更多詳細資料，包括其中包含的頻道和應用程式。
...
若要控制使用者在建立[團隊](https://support.microsoft.com/office/create-a-team-with-team-templates-702a2977-e662-4038-bef5-bdf8ee47b17b)時Teams中看到的範本，您可以設定範本原則，並將範本指派給組織中的使用者和群組。 若要深入瞭解，請參閱[在系統管理中心Teams管理小組範本](templates-policies.md)。
