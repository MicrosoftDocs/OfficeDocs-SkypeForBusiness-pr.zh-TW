...
- [**指派給**](#service-telephone-numbers)服務的服務號碼，例如音訊 [會議](deploy-audio-conferencing-teams-landing-page.md)、 [自動語音](plan-auto-attendant-call-queue.md)服務或 [通話佇列](plan-auto-attendant-call-queue.md)。
...
- 有關管理運算子電話號碼連線，請參閱使用運算子[連線。](operator-connect-configure.md#set-up-phone-numbers)
...
Microsoft 提供兩種服務電話號碼類型 ：付費和免付費，可指派給音訊會議、自動語音服務或通話佇列等服務。 服務號碼的並行通話容量高於使用者號碼。 服務號碼的可用性會依國家/地區及號碼類型 (無論是付費或免付費號碼) 。 每一個國家/地區的 Microsoft 電話授權會決定該號碼可用於哪些專案。
...
> [!NOTE]
> 如果您需要取得超過此數目的電話號碼，請電話[電話號碼服務中心](https://pstnsd.powerappsportals.com/)。