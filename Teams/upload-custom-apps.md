...
1. 關閉全域應用程式設定原則中 **Upload自訂應用程式** 設定。 若要執行此動作：
...
1. 選 **取 [Upload**]，按一下 **[Upload**]，選取您從開發人員收到的應用程式套件，然後選取 [**開啟]**。
...
:::image type="content" source="media/custom-app-lifecycle-discovery.png" alt-text="顯示針對組織發佈的自訂應用程式Teams市集的螢幕擷取畫面" lightbox="media/custom-app-lifecycle-discovery.png":::
