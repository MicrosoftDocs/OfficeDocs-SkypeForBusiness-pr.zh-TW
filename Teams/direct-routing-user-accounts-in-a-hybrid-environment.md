...
  
**此環境支援下列組合:**
- **案例 1:** 商務用 Skype 內部部署中的使用者帳戶, 將會使用商務用 Skype 用戶端與企業語音
- **案例 2:** 商務用 Skype online 中的使用者帳戶, 且會使用商務用 Skype 用戶端搭配混合式語音連接
- **案例 3:** 商務用 Skype online 中使用 Microsoft 團隊授權的使用者帳戶, 並將使用團隊用戶端
