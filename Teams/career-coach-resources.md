...
ms.locfileid: "69242567"
---
# <a name="resources-for-career-coach-in-microsoft-teams"></a>Teams 中 [職涯教練] 的資源Microsoft

下列適用于 IT 系統管理員、教職員和學生的資源將協助您透過 Microsoft Teams 規劃您的職涯教練實作。
...
| [Microsoft適用于 IT 的 Teams 程式集](https://www.youtube.com/watch?v=MfDB7VenWuA&list=PLXtHYVsvn_b_JeDjgD5XdkyHTDXdYgPGn) | 說明 Teams 規劃和部署之設定選項和考慮的 YouTube 影片。 |
| [開始使用 Teams Microsoft系統管理訓練](ITAdmin-readiness.md) | 適用于 Teams 新手之 IT 系統管理員的訓練資料集合。 |
| [Microsoft Teams 教育版](Teams-quick-start-edu.yml) | 適用于 IT 系統管理員Teams 教育版的快速入門手冊。 |
| [在 Teams 系統管理中心Microsoft管理應用程式](manage-apps.md) | 應用程式使用案例指南，以及如何使用 Teams 系統管理中心管理應用程式。 |
...
使用下列適用于教育教職員的資源來開始使用職涯教練，並Microsoft Teams。
...
| [Microsoft Teams 概觀](https://support.microsoft.com/teams) | 適用于授課者和學生的Microsoft Teams 快速入門手冊。 |
| [Microsoft Teams 開始使用單頁頁面](https://download.microsoft.com/download/8/f/1/8f187ed2-a4b8-4269-b756-744c2e81a423/teams-for-education-getting-started-1-pager.pdf) | 摘要Microsoft Teams 快速入門手冊的一頁易於共用的檔。 |
...
使用下列資源讓學生開始使用職業教練，並Microsoft Teams。
...
| [使用學生Office 365遠端學習](https://support.microsoft.com/topic/remote-learning-with-office-365-for-students-eea3ee92-ba42-4217-90d4-155f9a5477e4) | 瞭解Microsoft Teams 的基本概念和秘訣，以獲得成功的遠端學習體驗。 |
...
| [Teams 教育版 中的深入解析](https://support.microsoft.com/topic/educator-s-guide-to-insights-in-microsoft-teams-27b56255-90c0-47aa-bac3-1c9f50157181) | Microsoft Teams 中深入解析的授課者指南，以追蹤學生的 Teams 活動，例如作業繳交和課程交談中的參與度。 |
