...
今天是貴組織正式升級為Teams通訊和共同合作解決方案的日子。 在 Microsoft Teams系統管理中心中，將共存模式設定為 Teams **切換**。  (在系統管理中心，請前往全組織 **設定** Teams 升級 .) 使用者會收到他們的 商務用 Skype 用戶端中已升級至  >  **** Teams 的通知。
