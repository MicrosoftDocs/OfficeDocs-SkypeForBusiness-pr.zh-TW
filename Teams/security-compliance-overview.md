...
| 資訊保護功能 | Office 365 商務基本版 | Office 365 商務版 | Office 365 企業版 E1 | Office 365 企業版 E3/E4 | Office 365 企業版 E5 |
|-----------------------------------|--------------------------------|-----------------------------|--------------------------|-----------------------------|--------------------------|
|              壓縮              |               -                |              -              |            -             |             是的             |           是的            |
|        就地 eDiscovery        |               -                |              -              |            -             |             是的             |           是的            |
|        高級 eDiscovery        |               -                |              -              |            -             |              -              |           是的            |
|            法律封存             |               -                |              -              |            -             |             是的             |           是的            |
|     合規性內容搜尋     |               -                |             是的             |           是的            |             是的             |           是的            |
|      審核與報告       |              是的               |             是的             |           是的            |             是的             |           是的            |
|       條件式存取\*        |              是的               |             是的             |           是的            |             是的             |           是的            |
...
<a name="location-of-data-in-teams"></a>團隊中的資料位置
-------------------------

團隊中的資料位於與您的 Office 365 租使用者相關聯的地理區域中。 目前, 團隊支援澳大利亞、加拿大、法國、印度、日本、英國、美洲、APAC 及 EMEA 地區。 

> [!IMPORTANT]
> 團隊目前在澳大利亞、加拿大、法國、印度、日本和英國提供的資料是派駐給新的租使用者。 新的租使用者定義為任何沒有租使用者登入團隊中的使用者的租使用者。 澳大利亞、印度和日本的現有租使用者將繼續將其小組資料儲存在 APAC 區域中。 加拿大中的現有租使用者將繼續將其資料儲存在美洲。 在華北和英國, 現有的租使用者將繼續將其資料儲存在 EMEA 地區。
