...
以下是在 Teams 電話 中設定Microsoft 365。 其他詳細資訊的連結可在每個步驟的結尾提供。

## <a name="step-1-make-sure-that-teams-phone-is-available-in-your-country-or-region"></a>步驟 1：確定Teams 電話國家/地區提供
...
貴組織內的人員有時會需要透過電話來加入會議。 Microsoft Teams音訊會議功能， 使用者可以使用電話Teams會議，而不是在行動裝置Teams或 PC 上使用 Teams 應用程式。
