...
## <a name="step-1-make-sure-that-phone-system-is-available-in-your-country-or-region"></a>步驟 1: 確認您的國家或地區有可用的電話系統
...
## <a name="step-3-get-phone-numbers-for-your-users"></a>步驟 3: 為您的使用者取得電話號碼
...
## <a name="step-4-get-service-phone-numbers-audio-conferencing-call-queues-auto-attendants"></a>步驟 4: 取得服務電話號碼 (音訊會議、通話佇列、自動語音應答)
...
## <a name="step-5-if-you-want-to-set-up-calling-plans"></a>步驟 5: 如果您要設定通話方案

如果您已按照上述步驟進行, 就表示您已購買並指派電話系統和授權, 以及通話方案 (步驟 2), 以及為使用者取得的電話號碼 (步驟 3), 因此您的通話方案已部分設定。 請依照下列三個程式完成您的通話方案設定。
...
## <a name="step-9-assign-service-phone-numbers-audio-conferencing-call-queues-auto-attendants"></a>步驟 9: 指派服務電話號碼 (音訊會議、通話佇列、自動語音應答)
...
## <a name="step-10-set-up-communications-credits-for-your-organization"></a>步驟 10: 為您的組織設定通訊點數
...
2. 在系統管理中心的左側導覽中, 移至 [**帳單** > **訂閱** > **附加** > 元件**購買附加**元件], 然後選擇 [ ** **  > **立即購買**]。
