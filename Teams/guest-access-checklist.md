...
## <a name="--step-1-configure-settings-in-azure-ad-business-to-business"></a>□步驟 1: 設定 Azure AD 企業對企業中的設定
...
## <a name="-step-3-enable-guest-access-at-the-tenant-level"></a>□步驟 3: 啟用租使用者層級的來賓存取權
...
## <a name="--step-4-configure-sharing-in-office-365"></a>□步驟 4: 在 Office 365 中設定共用 
...
## <a name="-step-5-verify-sharing-setting-in-sharepoint"></a>□步驟 5: 驗證 SharePoint 中的共用設定
...
## <a name="-step-6-enable-specific-settings-for-channels"></a>□步驟 6: 啟用頻道的特定設定 
