...
## <a name="accessibilit-pour-microsoft-teams-et-skype-entreprise"></a>Entreprise Microsoft Teams Skype協助工具
...
將取消描述加上 détaillée des fonctionnalités d'accessibilité de Microsoft Teams et de Skype Entreprise， nous vous invitons à lire ce qui suit suit.
...
Microsoft Teams簡介取消 fonction"la main" qui permettra à toute personne 參與者 à une réunion Microsoft Teams d'方格取消訊號 visuel indiquant qu'elle a quelque 選擇 à À堄， utile à tous les utilisateurs qui souhaitent participer pleinement aux discussion de la réunion， y 包含 les personnes souffrant de les de a 假釋.
...
SkypeEntreprise dans Office 365 prend également en charges fonctionnalités d'accessibilité. Pour les personnes qui utilisent des lecteurs d'écran， l'interface utilisateur de Skype Entreprise peut être parcourue à l'aide du clavier， et des pages d'aide sont fournies pour expliquer：
...
Lorsque vous utilisez Skype Entreprise， les 功能表互動ifs de réponse peuvent être ralentis， accélérés et redémarrés， et et les utilisateurs peuventchoisir de sauter des messages， et Microsoft Teams prend en charge le réglage de la vitesse de la boête vocale. Microsoft Teams TTY Skype entreprise prennent en charge les appels texts (TTY) 。
...
Afin d'offrir la meilleure expérience possible à tous nos clients， Microsoft 建議 une assistance 技術 pour les questions liées à l'accessibilité par l'intermédiaire de son bureau de réponse aux questions des personnes illeées. L'équipe d'assistance du Answer Desk Accessibilité est formée à l'utilisation de nombreuses 技術 d'assistance populaires et peut offrir une assistance en français par téléphone ou par chat： [<span class="underline">https://support.microsoft.com/fr-fr/accessibility/disability-answer-desk</span>](https://support.microsoft.com/fr-fr/accessibility/disability-answer-desk) .

## <a name="dclarations-de-conformit--la-norme-en-301-549"></a>Déclarations de conformité à la norme EN 301 549

Pour aider ses clients à évaluer l'accessibilité， Microsoft 建議取消檔 qui décrit 批註 Skype Entreprise et Microsoft Teams se conforment à la norme européenne EN 301 549 相對 aux exigences d'accessibilités aux marchés publics des produits et services liés aux TIC (Technologies de l'Information et la Communication) en Europe. 取消複製 en 301 549 sont 聯點 en 附件。
