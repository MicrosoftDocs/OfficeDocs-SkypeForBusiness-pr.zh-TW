...
> [!NOTE]
> 在2020年2月，我們已開啟私人頻道的法律封存或案例封存 (私人通道聊天會儲存在使用者信箱中，一般通道聊天會儲存在該小組的群組信箱) 中。 如果已有合法保留使用者信箱，保留原則現在會自動套用至儲存在該信箱中的私人通道訊息。 系統管理員不需要採取進一步的動作，就能開啟此功能。 在專用通道中共用的檔案的法定保留也受到支援。
...
|案例  |保留內容  |
|---------|---------|
|**Microsoft 團隊在1:1 聊天、1：許多或群組聊天、私人頻道交談等中， (的使用者聊天內容。 )**     |使用者信箱         |
|**Microsoft 團隊頻道聊天 (不包括私人頻道)**    |小組使用的群組信箱         |
|**Microsoft 團隊內容 (例如 Wiki、檔案)**     |小組使用的 SharePoint 網站         |
|**Microsoft 團隊私人頻道檔案**     |私人的專用 SharePoint 網站     |
