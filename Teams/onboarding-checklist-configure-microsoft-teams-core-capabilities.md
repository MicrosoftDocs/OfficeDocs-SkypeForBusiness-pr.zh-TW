...
| pplx-2  | 驗證已針對租使用者啟用團隊 | 預設會為所有組織開啟團隊。 檢查 Microsoft 365 系統管理中心的 [**服務] & [增益集**] 頁面，確認已為您的租使用者啟用小組，並視需要啟用團隊。 | | [在 Microsoft 365 或 Office 365 中設定 Microsoft 團隊](office-365-set-up.md) |
