...
## <a name="step-1-find-out-if-audio-conferencing-is-available-in-your-countryregion"></a>步驟 1: 瞭解您的國家/地區是否提供音訊會議
<a name="__top"> </a>
...
## <a name="step-3-get-service-numbers-for-your-conferencing-bridges"></a>步驟 3: 取得會議橋的服務號碼
<a name="__top"> </a>
...
## <a name="step-4-assign-a-service-number-to-the-conferencing-bridge"></a>步驟 4: 將服務號碼指派給會議橋
<a name="__top"> </a>
...
## <a name="step-5-set-the-default-and-alternate-languages-for-a-conferencing-bridge"></a>步驟 5: 設定會議橋接器的預設及備用語言
...
## <a name="step-6-set-your-conferencing-bridge-settings"></a>步驟 6: 設定您的會議橋設定
<a name="__top"> </a>
...
## <a name="step-7-assign-dial-in-phone-numbers-for-users-who-lead-meetings"></a>步驟 7: 為領導會議的使用者指派撥入電話號碼
