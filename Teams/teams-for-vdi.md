...
目前，Teams視音訊/視 (AV) 的 VDI Windows虛擬桌面、Citrix 和 V Azure 通過認證。 請閱閱本節的資訊，以確保您符合正確功能的所有需求。
...
|平台|解決 方案|
|----|---|
|![代表 Microsoft 的標誌](media/microsoft-logo.png)| <a href="/azure/virtual-desktop/teams-on-wvd" target="_blank">Windows虛擬桌面</a> |
...
### <a name="windows-virtual-desktop"></a>Windows虛擬桌面
...
- [在Microsoft Teams桌面Windows使用](/azure/virtual-desktop/teams-on-wvd)
