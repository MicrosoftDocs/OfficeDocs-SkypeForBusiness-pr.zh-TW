...
您的Microsoft 365或Office 365組織系統管理員、技術主管和支援人員負責推動高品質的使用者體驗。 這包括確保您的網路準備好支援Teams、Teams使用者，以及有效疑難排解和解決可能的問題。
...
- [使用記錄檔案疑難排解Microsoft Teams](log-files.md)



| | |
|---|---|
| ![描繪決策點的圖示](media/audio_conferencing_image7.png) <br/>決策點|<ul><li>您是否參與所有可能參與部署及支援Teams？</li><li>您是否已開發訓練計畫，以隨著升級進行而加入其他員工？</li></ul> |
| ![描繪後續步驟的圖示](media/audio_conferencing_image9.png)<br/>後續步驟|<ul><li>確認 IT 員工擁有他們所需的資訊。</li><li>發佈新功能時，請重新檢查您的訓練和準備計畫。</li></ul>|

準備好 IT 員工以準備Teams，請確認您的環境符合所有[先決條件](upgrade-plan-journey-prerequisites.md)。