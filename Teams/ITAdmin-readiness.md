...
| | |  |
|---------|---------|---------|
|[**Teams**](https://aka.ms/MicrosoftTeamsforIT) IT 的基本功能 - MicrosoftMicrosoft"it Teams"影片系列將說明您 – 系統管理員 – 如何推出、設定及管理Teams。     |[**支援使用Microsoft Teams**](support-remote-work-with-teams.md#support-remote-workers-using-microsoft-teams)遠端工作人員 - 取得您所需的指引 ，包括訓練連結，以支援在家工作的使用者。         |[**管理 IT 團隊共同合作**](/learn/paths/m365-manage-team-collaboration)- 瞭解如何使用Teams，促進組織內部跨應用程式和裝置之間的團隊合作與溝通。         |
...
| 單元 4：部署Microsoft Teams 會議室 (56：36 分鐘)  | [視訊](https://www.youtube.com/watch?v=IJZPczMAsEM) | [甲板](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/rooms/module-4-deployment.pdf?raw=true) |
| 單元 5：32：27 Microsoft Teams 會議室 (32：27 開始)  | [視訊](https://www.youtube.com/watch?v=Q_6F6CNcpxI) | [甲板](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/rooms/module-5-starting-and-configuring-teams-rooms.pdf?raw=true) |
...
<p>下表包含全面訓練的連結，PowerPoint 套用 PDF 格式) 的 (、包含 Teams 顯示器、Teams 手機、Android 版 Teams 會議室 和 Teams 面板的 Microsoft Teams Android 裝置。  
...
| 資料外 (DLP) 策略Microsoft Teams                     | 瞭解如何新增新Microsoft Teams至現有的 DLP 策略，以及如何建立新策略，無論是根據範本或完全自訂群組織的資料保護需求。                        | [TeamsDLP 指南](https://aka.ms/teamsdlpguide)         |
...
| 在 Teams 管理中心管理Microsoft Teams和來賓存取         | 瞭解如何為貴組織設定Microsoft Teams及來賓存取權。                                                                                                                              | [管理Teams和來賓存取指南](https://aka.ms/TeamsandGuestAccessInteractiveGuide)    |
...
| 為第一Microsoft Teams員工進行配置                           | 瞭解如何為第一線員工Microsoft Teams及部署正確的工作環境。                                                                                                                  | [第一Microsoft Teams工作人員指南的組組](https://aka.ms/ConfigFLWInteractiveGuide)              |
| 前線員工身分識別：授權 IT、主管和前線員工                    | 瞭解如何將使用者Microsoft Teams現有的人力資源系統、設定輕量委派身分識別管理，以及為使用共用裝置的人設定簡化的登錄和順暢的轉換。                                                                                                                  | [前線員工身分識別指南](https://aka.ms/FLWIdentityIG)              |
| 部署Microsoft Teams 會議室                           | 瞭解如何在系統管理中心建立及設定帳戶Microsoft Teams 會議室管理裝置Microsoft Teams帳戶。                                                                                                                  | [部署Microsoft Teams 會議室](https://aka.ms/teamsroomslab)              |
