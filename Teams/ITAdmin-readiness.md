...
| ------------ | -------------------- | -------------------- |
| [Microsoft 技術 - IT YouTube 頻道的 Teams 基本功能](https://aka.ms/MicrosoftTeamsforIT) | [影片](https://www.youtube.com/watch?v=MfDB7VenWuA&list=PLXtHYVsvn_b_JeDjgD5XdkyHTDXdYgPGn) ：10：13 分鐘 (It 的 Teams 基本) <br>[影片：部署&](https://www.youtube.com/watch?v=o2mlsUubIO4&list=PLXtHYVsvn_b_JeDjgD5XdkyHTDXdYgPGn&index=2) Teams - 簡介 (8：22 分鐘)   <br>[影片：安全性與合規性](https://youtu.be/91lHNKVVvQ4) (12：42 分鐘) <br>[影片：在](https://www.youtube.com/watch?v=Km4T4hMM__k) 10：54 分鐘 (Teams 安全性和合規性控制) ||
...
<p>下表包含全面影片訓練的連結，以及隨附的 PowerPoint (在 Microsoft Teams 會議室) PDF 格式的幻燈片組。  
