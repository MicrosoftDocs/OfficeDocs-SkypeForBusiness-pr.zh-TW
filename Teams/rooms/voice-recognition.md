...
- 在文字記錄中編輯演講者的名稱。
- 變更文字記錄中單字的演講者，或變更文字記錄中所有語音的演講者 (但不要變更) 。
- 變更會議中列出的人員之演講者識別。
...
語音設定檔資料可用於任何使用智慧型喇叭的會議。 請參閱[Teams和](../meeting-policies-in-teams.md#allow-transcription) [PowerShell 會議 Cmdlet，](/powershell/module/skype/set-csteamsmeetingpolicy?view=skype-ps)以瞭解會議設定的資訊。
