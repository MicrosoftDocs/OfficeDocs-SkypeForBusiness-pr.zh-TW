...
|AllowTranscription|使用者和會議室Teams必填專案。|**True** 和 **False**|
||||

在系統管理Teams中，設定 **允許抄寫** 政策。 設定為 **關閉**。
