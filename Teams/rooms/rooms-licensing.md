...
Microsoft 有兩個專用的 SKUs，可針對會議室裝置 (例如 Microsoft Teams 會議室、Microsoft Surface Hub 和 Microsoft Teams) 共同操作線等，針對會議授權會議和通話。
...
|為會議室提供電話號碼，然後撥打或接聽會議室的來電，或使用電話號碼加入音訊會議  | 使用直接路由：Microsoft Teams 會議室標準版或進階版<br/>沒有直接路由：國內或國際通話方案<br/>Microsoft 365 Business Voice  |商務用 Skype Server標準 CAL  <br/> 商務用 Skype Server加 CAL  |
...
|Microsoft Teams 會議室Managed Services | Microsoft Teams 會議室進階版 ||
| |||
