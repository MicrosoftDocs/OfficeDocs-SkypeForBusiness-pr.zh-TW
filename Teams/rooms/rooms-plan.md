...
| 工作                       | 誰可能正在執行工作           | 指派給 | 此內容的連結 |
|----------------------------|----------------------------------------|-------------|-----------------------|
| 庫存空間            | 設施 / AV 小組/IT 專案小組 |             | [會議室庫存和功能規劃](#room-inventory-and-capability-planning) |
| 規劃功能          | IT 專案小組                        |             | [會議室庫存和功能規劃](#room-inventory-and-capability-planning) |
| 裝置選取範圍           | IT 專案小組/AV 小組              |             | [裝置選取範圍](#device-selection) |
| 採購                | IT 專案小組/AV 小組              |             | [採購](#procurement) |
| 網站整備             | 設施 / AV 小組/IT 專案小組 |             | [網站整備](rooms-deploy.md#site-readiness) |
| 服務整備          | IT 專案小組                        |             | [服務整備](rooms-deploy.md#service-readiness) |
| 設定              | IT 專案小組                        |             | [設定與部署](rooms-deploy.md#configuration-and-deployment) |
...
**專業秘訣 –** 現在是開始收集您所選擇之Microsoft Teams 會議室解決方案相關資訊的好時機。
...
| &nbsp; | &nbsp; |
|---|---|
| ![出貨元件。](../media/audio_conferencing_image7.png) <br/>決策點|<ul><li>您會將元件直接運送至網站或分機設備嗎？</li><li>如果您決定使用一個) ，誰將管理 (分站？</li></ul> |
