...
ms.locfileid: "67271368"
---
# <a name="partner-management-for-customers"></a>客戶的合作夥伴管理

Teams 會議室受管理 (TRM) 服務中的合作夥伴管理可讓客戶順暢地將存取權和責任委派給一或多個合作夥伴組織。 合作夥伴只能管理獲指派管理的會議室。
...
1. 以受管理的服務系統管理員身分登入Teams 會議室管理的入口網站。
...
1. 以 MMR 系統管理員身分登入 TRM-MTM 入口網站。
1. 流覽 [移至 **合作夥伴>設定]。**
1. 選取您要移除的合作夥伴。
...
|功能|許可|**MMR 管理員**|**網站潛在客戶**|**網站技術**|**合作夥伴系統管理員**|
| :- | :- | :- | :- | :- | :- |
|房間|檢視| &#10004;|&#10004;|&#10004;|&#10004;|
||修改|&#10004;|&#10004;|&#10004;|&#10004;|
||重設金鑰|&#10004;||||
...
透過委派的存取功能，合作夥伴不會獲得 TRM 服務入口網站以外的任何其他許可權。 不過，TRM 服務中衍生自其他 Microsoft 產品的任何資料，都視為 TRM 服務中的資料。 例如，雖然通話品質報告衍生自 Teams 通話品質資料，但 TRM 入口網站中的任何資料都在許可權範圍中。 
