...
> [!NOTE]
> 下列程式是建立安裝媒體以將新裝置Microsoft Teams 會議室影像。 根據預設，現有的裝置會從更新Windows和市Windows自動更新。
...
1. 從系統管理帳戶登錄主機 (請參閱系統管理 [模式和裝置管理](rooms-operations.md#AdminMode)) 。
