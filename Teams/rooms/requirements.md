...
ms.locfileid: "58234218"
---
# <a name="microsoft-teams-rooms-requirements"></a>Microsoft Teams 會議室需求

Microsoft Teams 會議室不同的會議室大小。 Teams 會議室會議室的大小及使用方式，使用各種經過認證的音訊和視音訊周邊設備。 選取適當的核心裝置和主機，結合適合空間的麥克風、喇叭、相機和顯示器，您可以將 Microsoft Teams 會議室 部署到任何大小的空間，從小型空間到大型會議空間和會議室。  您可以在[裝置展示](https://products.office.com/microsoft-teams/across-devices)中取得可用於設定會議室的所有經認證音訊和視訊週邊設備的完整集合。
...
>
> Microsoft Teams 會議室不支援舊版平台 (例如 Lync Server 2013)。 Microsoft Teams 會議室 21Vianet 或 DoD 環境Microsoft 365或 Office 365中不支援此功能。
>
...
所有目前的 Microsoft Teams 會議室裝置和套件組合可在[會議室系統產品展示](https://products.office.com/microsoft-teams/across-devices/devices/category?devicetype=20&page=1&filterIds=)中取得。
  ...
  |主控台|處理器|RAM|磁碟|
  |:-----|:-----|:-----|:-----|
  |[使用 Intel NUC 的 Cresron Flex UC-M130-T](https://crestron.com/Products/Workspace-Solutions/Unified-Communications/Crestron-Flex-Tabletop-Conferencing-Systems/UC-M130-T)|Core i5|8 GB |128 GB |
  |[使用 Intel NUC 的 Cresron Flex UC- B130-T](https://crestron.com/Products/Workspace-Solutions/Unified-Communications/Crestron-Flex-Wall-Mount-Conferencing-Systems/UC-B130-T)|Core i5|8 GB |128 GB |
  |[使用 Intel NUC 的 Cresron Flex UC-B140-T](https://crestron.com/Products/Workspace-Solutions/Unified-Communications/Crestron-Flex-Wall-Mount-Conferencing-Systems/UC-B140-T)|Core i5|8 GB |128 GB |
  [使用 Intel NUC 的 Cresron Flex UC-C140-T](https://www.crestron.com/Products/Workspace-Solutions/Unified-Communications/Crestron-Flex-Integrator-Kits/UC-C140-T)|Core i7|8 GB |128 GB|
  |[使用 Intel NUC 的 Cresron Flex UC-M150-T](https://crestron.com/Products/Workspace-Solutions/Unified-Communications/Crestron-Flex-Tabletop-Conferencing-Systems/UC-M150-T)  + [CCS- MIC](https://www.crestron.com/Products/Audio/Microphones/Wired-Microphones/CCS-UCA-MIC-KIT)|Core i7|8 GB |128 GB |
  |[使用 Intel NUC 的 Cresron Flex UC-MX150-T](https://www.crestron.com/Products/Workspace-Solutions/Unified-Communications/Crestron-Flex-Tabletop-Conferencing-Systems/UC-MX150-T)|Core i5|8 GB |128 GB |
   [使用 Intel NUC 的 Cresron Flex UC-B160-T](https://crestron.com/Products/Workspace-Solutions/Unified-Communications/Crestron-Flex-Wall-Mount-Conferencing-Systems/UC-B160-T)|Core i7|8 GB |128 GB|
  |[使用 Intel NUC 的 Cresron Flex UC-C160-T](https://crestron.com/Products/Workspace-Solutions/Unified-Communications/Crestron-Flex-Integrator-Kits/UC-C160-T)|Core i7|8 GB|128 GB|
  |[使用 UC 簡報傳送器 (UC-PR) ASUS PC 的 Cresron Flex UC-MMX30-T](https://www.crestron.com/Products/Workspace-Solutions/Unified-Communications/Crestron-Flex-Tabletop-Conferencing-Systems/UC-MMX30-T)|Core i5|8 GB |128 GB |
  ...
  |[使用 ASUS PC 的 Cresron Flex UC-B30-T](https://www.crestron.com/Products/Workspace-Solutions/Unified-Communications/Crestron-Flex-Wall-Mount-Conferencing-Systems/UC-B30-T)|Core i5|8 GB |128 GB |
   ...
   |[使用 ASUS PC 的 Cresron Flex UC-MX50-T](https://www.crestron.com/Products/Workspace-Solutions/Unified-Communications/Crestron-Flex-Tabletop-Conferencing-Systems/UC-MX50-T)|Core i5|8 GB |128 GB |
   |[使用 ASUS PC 的 Cresron Flex UC-MX70-T](https://www.crestron.com/Products/Workspace-Solutions/Unified-Communications/Crestron-Flex-Tabletop-Conferencing-Systems/UC-MX70-T)|Core i5|8 GB |128 GB |
  ...
  |[使用 Logitech TAP 的Dell OptiPlex 7080](https://www.dell.com/work/shop/cty/pdp/spd/optiplex-7080-xe-teams) | Core i7 |16 GB |128 GB|
...
|[Aver VB342+ 相機聲音鍵](https://www.averusa.com/products/conference-camera/vb342plus) | 聲音橫條：0.0.0000.97|
...
|[哈德利畫布](https://www.huddly.com/blog/say-hello-to-huddly-canvas-our-latest-ai-technology-for-content-capture-and-enhancement/) | 1.3.25 |  &#x2714; |
...
|[Jabra Panacast 50 影片吧](https://www.jabra.com/business/video-conferencing/jabra-panacast-50)|1.9.3|
...
|[Shure Intellimix P300 Audio Conferencing Processor](https://www.shure.com/products/mixers/p300)+</br></br> [舒爾 MXA 310 表格陣列麥克風 ](https://www.shure.com/products/microphones/mxa310) +</br></br> [MXN5W-C 天花板喇叭](https://www.shure.com/products/loudspeakers/mxn5)| P300 DSP：4.1.11 </br> MXA310 表格陣列麥克風：4.1.41 </br> MXN5W-C 喇叭：1.0.4 |
|[Shure Intellimix P300 Audio Conferencing Processor](https://www.shure.com/products/mixers/p300) + </br></br> [舒爾 MXA 910 與 Intellimix Ceiling Array 麥克風](https://www.shure.com/products/microphones/mxa910) +</br></br> [MXN5W-C 天花板喇叭](https://www.shure.com/products/loudspeakers/mxn5)| P300 DSP：4.1.11 </br> MXA910 Ceiling Array 麥克風：4.1.41 </br> MXN5W-C 喇叭：1.0.4 |
|[舒爾 MXA 710 2ft 表格線性陣列麥克風](https://www.shure.com/products/microphones/mxa710) + </br></br> [Shure Intellimix P300 Audio Conferencing Processor](https://www.shure.com/products/mixers/p300) +</br></br> [MXN5-C 天花板喇叭](https://www.shure.com/products/loudspeakers/mxn5)| MXA710 2ft 表格線性陣列麥克風：1.2.0 </br> P300 DSP：4.4.8 </br> MXN5-C 喇叭：1.1.1 |
|[舒爾 MXA 710 4ft 牆式線性陣列麥克風](https://www.shure.com/products/microphones/mxa710) + </br></br> [Shure Intellimix P300 Audio Conferencing Processor](https://www.shure.com/products/mixers/p300) +</br></br> [MXN5-C 天花板喇叭](https://www.shure.com/products/loudspeakers/mxn5)| MXA710 4ft 牆麵線性陣列麥克風：1.2.0 </br> P300 DSP：4.4.8 </br> MXN5-C 喇叭：1.1.1 |
|[使用 Intellimix Ceiling Array 麥克風的舒爾 MXA 910](https://www.shure.com/products/microphones/mxa910) + </br> [舒爾 Intellimix Room Software](https://www.shure.com/products/software/intellimix_room) +</br> [Cresron UC-C100-T](https://www.crestron.com/Products/Workspace-Solutions/Unified-Communications/Crestron-Flex-Integrator-Kits/UC-C100-T)| 舒爾 Intellimix 會議室軟體：3.0.4.14 </br> 具有 Intellimix Ceiling Array 麥克風的舒爾 MXA 910：4.4.11 </br> 舒爾 MXN5-C 喇叭：1.2.1 </br> Cresron UC-C100-T：WINDOWS IOT 19h2/20h2 OS 版本與 4.8.31.0 的三維應用程式版本 </br> BIOS：ASUS Tek 電腦 INC 9934 8/27/2020 </br> CPU：i5-9500T CPU </br> 實體記憶體：8 GB RAM |
...
|[QSC Q-SYS Core 8 Flex 處理器](https://www.qsc.com/solutions-products/q-sys-ecosystem/processing/core-8-flex/) +</br> [QSC PTZ 20x60 相機](https://www.qsc.com/solutions-products/q-sys-ecosystem/video/ptz-ip-conference-cameras/) +</br> [Sennheiser TCC2 天花板麥克風](https://sennheiser.com/tcc2) +</br> [QSC 天花板喇叭 AD-C6T-LP](https://www.qsc.com/solutions-products/loudspeakers/installed/passive/ceiling-mount/acousticdesign-series/ad-c6t-lp/) |QSC PTZ IP 20x60 相機：9.0 </br> QSC Q-SYS Core 8-Flex：Q-SYS Designer 9.0.1-2104.002 </br> QSC Q-SYS Nano：Q-SYS Designer 9.0.1-2104.002 </br> Sennheiser TCC2 天花板麥克風：TCC2 - 1.5.1 Dante 1.2.0 </br> SPA 系列 EnergyStar 功放：N/A </br> 聲音設計系列喇叭：N/A|
|[QSC Q-SYS Core Nano 處理器](https://www.qsc.com/solutions-products/q-sys-ecosystem/processing/core-nano/) +</br> [QSC PTZ 20x60 相機](https://www.qsc.com/solutions-products/q-sys-ecosystem/video/ptz-ip-conference-cameras/) +</br> [Sennheiser TCC2 天花板麥克風](https://sennheiser.com/tcc2) +</br> [QSC 天花板喇叭 AD-C6T-LP](https://www.qsc.com/solutions-products/loudspeakers/installed/passive/ceiling-mount/acousticdesign-series/ad-c6t-lp/) |QSC PTZ IP 20x60 相機：9.0 </br> QSC Q-SYS Core 8-Flex：Q-SYS Designer 9.0.1-2104.002 </br> QSC Q-SYS Nano：Q-SYS Designer 9.0.1-2104.002 </br> Sennheiser TCC2 天花板麥克風：TCC2 - 1.5.1 Dante 1.2.0 </br> SPA 系列 EnergyStar 功放：N/A </br> 聲音設計系列喇叭：N/A|
|[QSC PTZ IP 12x72 相機](https://www.qsc.com/solutions-products/q-sys-ecosystem/video/ptz-ip-conference-cameras/) +</br> [QSC Q-SYS NV-32-H 處理器](https://www.qsc.com/solutions-products/q-sys-ecosystem/processing/nv-32-h-core-capable/) +</br> [Sennheiser TCC2 天花板麥克風](https://sennheiser.com/tcc2) +</br> [QSC EnergyStar Power功放 SPA2-60](https://www.qsc.com/solutions-products/power-amplifiers/installed/non-network/low-power-applications/spa-series/spa2-60/)或[QSC CX-Q 2K4 網路功放](https://www.qsc.com/solutions-products/q-sys-ecosystem/audio-network-amplifiers/cx-q-series/cx-q-2k4/)器 +</br> [Q-SYS NS 系列網路交換 NS-1108P Netgear M4250-10G2XF](https://www.qsc.com/solutions-products/q-sys-ecosystem/networking/ns-series-network-switches/) +</br> [聲音設計系列喇叭](https://www.qsc.com/solutions-products/loudspeakers/installed/passive/surface-mount/acousticdesign-series/) +</br> QSC Q-Sys I/O USB 橋接器 |QSC PTZ IP 12x72 相機：9.0 </br> Q-SYS Designer 9.0.1-2104.002 </br> TCC2 - 1.5.1 Dante 1.2.0 </br> QSC EnergyStar Power功放 SPA2-60：N/A </br> QSC CX-Q 2K4 網路功放器：N/A </br> Q-SYS NS 系列網路切換 NS-1108P Netgear M4250-10G2XF：N1100v6.4.2.8 </br> 聲音設計系列喇叭：N/A </br> QSC Q-Sys I/O USB 橋接器：Q-SYS Designer Software 9.0.1|
