...
| \<UserAccount\>                             | 容器                   | 第一個&#x2776; | 認證參數的容器。 登入位址、Exchange 位址或電子郵件地址通常相同，例如 RainierConf <span></span> @contoso.com。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| \<SkypeSignInAddress\>                      | 字串&#x2777;             |                | 主機 SfB 或 Teams 裝置帳戶的登入名稱。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
| \<NoiseSuppressionDefault\>                 | 布林值&#x2777;            | 第一個&#x2776; | 依預設已啟用、True。 如果為 false，這只會關閉 Microsoft AI 型噪音抑制 (NS) 。 如果 HW 內建噪音抑制功能，Microsoft NS 會在開啟時串聯。 如果系統管理員只想要使用 OEM 提供的 NS，則應關閉 Microsoft AI 型 NS。
...
1. 移至Microsoft Teams 會議室主機上的 Windows 設定。
2. 輸入系統管理員密碼。
