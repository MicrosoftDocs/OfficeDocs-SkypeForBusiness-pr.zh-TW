...
| \<CortanaWakewordEnabled\>                  | 布林值&#x2777;            | 第一&#x2776; | 設定為 true 以啟用Cortana「嗨，Cortana」。 除非您的國家/地區支援 Cortana服務，而且您連接的音訊周邊設備支援Cortana。 預設值為 False。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| \<SendLogs\>                                | 容器                   | 第一&#x2776; |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
...
7. 顯示的值是在 XML 設定檔中設定之裝置實例路徑。 在 XML 中指定路徑時，請將 (&) 取代為 `&amp;` 。
