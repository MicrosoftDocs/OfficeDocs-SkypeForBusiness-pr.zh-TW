...
當餘額低於您設定觸發金額時，自動充電會自動超過您的餘額。 我們建議您使用自動加價，這樣您就不必記得手動新增資金。 當您的餘額達到觸發金額時，系統會自動新增資金。 如果您沒有選擇自動充值，則您的餘額風險會低於零。 此時，您和您的使用者將無法撥打免付費電話或國際電話。
...
您也可以以登錄帳戶並進入帳單訂閱新增訂閱Microsoft 365 系統管理中心  >  **查看**  >  **資訊**。
