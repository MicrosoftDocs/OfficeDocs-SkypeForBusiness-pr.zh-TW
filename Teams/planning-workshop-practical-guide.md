...
description: 規劃工具、研討會和入門套件，協助組織開始使用Microsoft Teams。
...
- [取得Teams技術訓練](itadmin-readiness.md)

    使用這些技術訓練資源來教育自己、教導其他人或舉辦研討會。
...
[適用于您帳戶的 IT 系統管理員Teams](ITAdmin-readiness.md)

[採用工具](adopt-tools-and-downloads.md)

[商務用 Skype升級Teams研討會](https://www.microsoft.com/microsoft-365/partners/intelligentcommunications/skype-for-business-teams)
