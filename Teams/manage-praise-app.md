...
Microsoft 團隊中的稱讚應用程式可協助使用者向組織或教室的成員顯示感謝。 您可以選擇一組徽章以供選擇，以及建立您自己徽章的選項，稱讚旨在協助您辨識小組使用者在團隊使用者所做的大量工作（從教育者到第一線員工）所做的工作。 若要深入瞭解，請參閱 [將稱讚傳送給其他人](https://support.microsoft.com/office/send-praise-to-people-50f26b47-565f-40fe-8642-5ca2a5ed261e)。
