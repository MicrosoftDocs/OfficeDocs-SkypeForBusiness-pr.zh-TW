...
> [!NOTE]
> 系統管理員必須擁有 Teams 授權才能存取此功能。 如果您嘗試在沒有 Teams 授權的情況下存取此功能，就會收到錯誤訊息。

Microsoft Teams 中的稱讚應用程式可協助使用者向組織或教室的成員表示感謝。 精選徽章集供您選擇，以及建立您自己的徽章選項，稱讚的設計可協助識別 Teams 使用者從教育人員到前線工作人員等各種工作所付出的投入。 若要深入瞭解，請查看傳送 [稱讚給人員](https://support.microsoft.com/office/send-praise-to-people-50f26b47-565f-40fe-8642-5ca2a5ed261e)。

管理員可以從 Microsoft Teams 系統管理中心控制哪些徽章可供其組織使用。 在左側流覽中，前往 **Teams 應用程式>管理應用程式**。 在應用程式清單中，按一下 [ **稱讚**，然後選取 **[設定**> 。  您可以在這裡選擇啟用預設和內建徽章集，以及建立自訂徽章。
...
內建套件是 Microsoft 針對稱讚應用程式所設計的徽章集合。 系統管理員無法編輯這些集。 預設徽章集已啟用，且可在稱讚應用程式中使用。 若要變更預設集或任何徽章集的可用性，請切換至開啟或關閉對應開關。 

<a name="default-badges"></br></a>

### <a name="default-badges"></a>預設徽章

預設徽章集是專為協助 Teams 使用者識別其同儕在工作之外所完成的工作所設計。
...
3. 上傳徽章影像。 公認的檔案類型為 。Png。 影像檔案必須小於 40 KB，最大尺寸為 216 X 216 圖元。
...
>
> 完成對徽章選取範圍進行變更後，請務必選取 **提交**。 貴組織可能需要幾個小時的時間才能使用這些變更。
...
例如，紅色色彩的十六進位值為 #FF0000因為紅色設定為可能的最高值，因此 FF，而綠色和藍色則分別設定為最低可能值 00。

若要探索不同的色彩及其十六進位值，請查看 [Bing 色彩選擇器](https://www.bing.com/search?q=color+picker)。
...
內建徽章組無法修改，因此當啟用內建集時，集合中所有的徽章會新到稱讚應用程式。 如果您想要從內建集新增特定徽章，並排除其他徽章，請重新建立您想要做為自訂徽章的徽章。 您可以下載徽章影像，然後從下表的內建集尋找徽章的文字和背景色彩。
...
|徽章名稱        |影像檔案  |文字色彩 | 背景色彩 |
|------------------|------------|---------- |--------|
|通信     |[通訊 PNG](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/raw/live/Teams/downloads/praise-app/sel-edu-set/communication-badge.png)|#FFFFFF    |#173B65|
