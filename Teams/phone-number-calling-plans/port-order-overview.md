...
- 商務用 Skype混合式電話號碼。 如果您想要移轉這些數位，請以電子郵件傳送給我們 <ptn@microsoft.com> 。
...
- **完整埠** 這是當您將目前服務提供者的所有號碼移轉至Teams。 當系統要求您轉接電話號碼時，您必須包含帳單電話號碼 (BTN) 以及您帳戶上所有其他電話號碼。 
    ...
    例如，假設您的 BTN 是  *+1 425-555-1234，*  而您想要將 25 個電話號碼全部 (*+1 425-555-1235 到 1259*) 。 當您按照下列指示傳送號碼時，請輸入 **：+14255551234 - +1425551259**。
...
- 請確定您提供的帳戶資訊與手機電信公司記錄中完全相同。 資訊不一致是錯誤和延遲您埠訂單最常見的原因。 確認下列專案為 True：
