...
支援 [北美試算表的費率中心和涵蓋矩陣](https://www.microsoft.com/download/details.aspx?id=102534) 會列出我們支援的費率中心。 當您收到新的電話號碼，或將現有提供者的電話號碼移轉到 Teams時，請下載試算表，並使用它來尋找費率中心。 如果您不知道您的費率中心，您可以根據您的地區代碼 (NPAs) NXX (前) 網際網路上查看。
如果您收到新的號碼，但我們沒有您要求的數位，我們會嘗試從相同的費率中心為您提供數位。
