...
如需取得團隊的詳細資訊, 請參閱[如何取得 Microsoft 團隊的存取權？](https://support.office.com/article/How-do-I-get-access-to-Microsoft-Teams-fc7f1634-abd3-4f26-a597-9df16e4ca65b)

> [!NOTE]
> 團隊也適用于非盈利性組織。 小組將于7月17日開始推出美國政府雲端共同體 (GCC), 並在2018年8月結束後供所有符合資格的客戶使用。 我們正致力於將 Microsoft 團隊推向其他美國政府群 (GCC 高級版和 DoD) 即將推出。 請參閱 Microsoft 團隊博客中的[](https://techcommunity.microsoft.com/t5/Microsoft-Teams-Blog/Microsoft-Teams-will-be-available-July-17-for-the-US-Government/ba-p/209976)詳細資訊。

> [!NOTE]
> 從2018年10月1日起, 新500的 Office 365 客戶將會 onboarded 給小組, 且無法存取商務用 Skype Online。 已在使用商務用 Skype Online 的租使用者將能夠繼續進行 (包括預配新使用者), 直到他們完成向小組的轉換。 若要深入瞭解, 請參閱[Microsoft 團隊現在是會議的主要客戶, 以及 Office 365 中的通話](https://support.microsoft.com/help/4465277/microsoft-teams-now-the-primary-client-for-meetings-and-calling)。
...
所有支援的訂閱者案都有資格存取團隊 web 用戶端、桌面用戶端和行動應用程式。

團隊不是以獨立服務的形式提供。

> [!TIP]
> 若要管理使用者層級授權, 請參閱[管理使用者對 Microsoft 團隊的存取權](user-access.md)。
