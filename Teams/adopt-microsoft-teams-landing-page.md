---
title: 採用 Microsoft Teams
ms.reviewer: karuanag
description: 瞭解可協助您規劃及部署組織中 Microsoft Teams 的採用資源。
ms.topic: overview
author: serdarsoysal
ms.author: serdars
manager: serdars
...
ms.locfileid: "51118482"
---
# <a name="adopt-microsoft-teams"></a>採用 Microsoft Teams

> [!NOTE]
> 如需轉換至遠端學習和資源以協助您開始使用的概觀，請參閱我們的[遠端學習首頁](https://www.microsoft.com/education/remote-learning)。

如果您想要從聊天、teams &頻道和會議開始推出 Teams，請使用我們的規範性開始使用指南 ，此指南是專為[](get-started-with-teams-quick-start.md)快速啟動和執行所設計。 如果您是一個擁有混合式或內部部署商務用 Skype 組態的大型組織，或您想要推出語音功能 (例如 Microsoft 365 或 Office 365 通話方案或電話系統) ，您可以從我們的快速入門手冊開始，但您需要下方的進一步指引，位於進一步採用指南[下方。](#deeper-adoption-guidance)
...
根據您的環境，採用計畫可能簡單而複雜。 針對大型部署，請逐步執行下列指南，以確保貴組織能夠順暢地轉換至 Teams。
