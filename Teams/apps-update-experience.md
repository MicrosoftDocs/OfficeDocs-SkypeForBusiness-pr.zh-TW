...
ms.locfileid: "68912792"
---
# <a name="role-of-an-admin-in-upgrading-teams-apps"></a>系統管理員在升級 Teams 應用程式中的角色
...
在組織內建立和部署的自訂應用程式可供租使用者或組織中的使用者使用。 Teams 系統管理員會在組織開發人員提供新版本時，將自訂應用程式更新為新版本。 如需詳細資訊，請參閱 [系統管理員如何管理自訂應用程式](custom-app-overview.md)。
