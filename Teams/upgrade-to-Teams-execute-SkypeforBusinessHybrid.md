...
> [!NOTE]
> 使用 商務用 Skype Server 2019 和 商務用 Skype Server 2015 未來的累積更新，您將能夠執行步驟 1 (將使用者移動到 商務用 Skype Online) 和步驟 2 (將使用者升級至 Teams) 。 2019 年 2019 商務用 Skype Server之後，將會提供詳細資訊。
