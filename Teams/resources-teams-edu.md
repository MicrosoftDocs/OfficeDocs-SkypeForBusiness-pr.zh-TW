...
description: 教育系統管理員可以瞭解在 Microsoft Teams中可用的資源，以啟用遠端學習。
...
使用電子郵件、海報Microsoft Teams講義，以及您現在可免費使用的更多資源，讓學校對課程感到興奮。 您也可以使用充滿橫幅、GIF 和影片的新數位工具套件，與線上和整個校園的學生聯繫。 今天開始使用！
...
- 請流覽[Teams](https://www.microsoft.com/en-us/education/products/teams/default.aspx)教育版頁面，以觀看訓練、影片和互動式示範
- 在 Teams 系統管理中心Microsoft 365[](https://portal.office.com/adminportal/home#/Settings/ServicesAndAddIns)開啟 (以系統管理員Office 365登錄) 
