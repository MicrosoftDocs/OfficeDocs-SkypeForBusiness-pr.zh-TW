...
- 如果您想要編輯自訂原則，請選取該原則，然後選擇 [Edit] （**編輯**）。 
    ...
    [即時事件]![策略設定的螢幕擷取畫面](../media/teams-live-events-policies.png "Microsoft [團隊管理中心] 的 [即時事件] 原則設定螢幕擷取畫面") 
...
## <a name="step-4-set-up-a-video-distribution-solution-for-live-events-in-teams"></a>步驟4：在團隊中設定即時事件的視頻發佈方案
