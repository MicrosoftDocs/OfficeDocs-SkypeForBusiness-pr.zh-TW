...
- enabler-strategic
description: 在 Teams中設定即時事件，包括設定您的網路、指派授權、啟用即時活動功能和排程，以及視音訊發佈解決方案。
appliesto:
- Microsoft Teams
...
2. 執行下列其中一個選項：
    ...
    ![即時事件策略設定螢幕擷取畫面。](../media/teams-live-events-policies.png "Microsoft Teams 系統管理中心即時活動原則設定的螢幕擷取畫面")
...
**在 Teams 以外購買和設定您的解決方案** 運用 Microsoft 信任的視訊傳遞合作夥伴，獲得擴大視訊傳遞的專家協助。 您必須先購買並設定 SDN/eCDN 解決方案，才能與 Teams 一起使用視Teams。
...
- **Riverbed** 是網路優化的產業標準，正在將加速解決方案延伸到 Microsoft Teams Stream。  現在Microsoft 365客戶可以放心地加速 365 流量，包括 Teams 和 Stream，以及其他領先企業 SaaS 服務，隨時隨地提升員工生產力。 Teams Riverbed 的世界級支援與持續投資的所有保證，輕鬆設定，就可以啟用快速處理和 Stream 加速功能。
