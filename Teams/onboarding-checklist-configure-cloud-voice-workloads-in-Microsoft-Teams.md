...
ms.locfileid: "60828466"
---
# <a name="configure-cloud-voice-workloads-in-microsoft-teams"></a>在用戶端中設定Microsoft Teams
...
| 2  | 驗證您的使用者清單和啟用通話計畫的部署頻次 | 檢查您是否有適用于通話方案之業務單位或網站的清單，Teams。 使用目標與關鍵結果模型，找出哪些使用者將適用通話方案。 我們建議您以網站為基礎工作，這樣您才能專注于資源。<br/><br/> 在啟用計畫中，識別您將啟用的使用者， (試驗、網站 1、網站 2 等等) 。 | | [具有通話方案的電話系統](calling-plan-landing-page.md) |
