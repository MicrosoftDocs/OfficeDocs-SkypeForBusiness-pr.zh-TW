...
| 否 | 活動或工作 | 描述 | 完成？ | 其他資訊 |
|----|---------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 1  | 判斷貴組織位置是否提供通話方案功能 | Microsoft 提供電話系統和城市通話方案。 <br/><br/>請參閱通話方案涵蓋之國家/地區的最新清單之額外資訊列中的指引。 您可以選取某個國家/地區，以查看是否提供通話方案及通訊信用額度。 | | [音訊會議與通話方案的適用國家/地區](country-and-region-availability-for-audio-conferencing-and-calling-plans/country-and-region-availability-for-audio-conferencing-and-calling-plans.md) |
| 2  | 驗證您的使用者清單及啟用通話計畫的部署頻次 | 檢查您是否有適用于通話方案之業務單位或網站的清單，Teams。 使用目標與關鍵結果模型，找出哪些使用者將適用通話方案。 建議您以網站為基礎工作，這樣您才能專注于資源。<br/><br/> 在啟用計畫中，找出您將啟用的使用者， (試驗、網站 1、網站 2 等專案) 。 | | [具有通話方案的電話系統](calling-plan-landing-page.md) |
...
| 9  | 選擇性：設定與 商務用 Skype | 如果貴組織從 商務用 Skype Teams。 <br/><br/>互通性可讓商務用 Skype Teams使用者彼此聊天和通話。 <br/><br/>您現有的部署和您預定的部署策略Teams您的計畫。 審查互通性選項、需求和限制，並據此設定原則。 <br/><br/>**注意：** 只有在貴組織仍託管線上使用者時，才能商務用 Skype這些步驟。 | | [Microsoft Teams商務用 Skype互通性](./teams-and-skypeforbusiness-coexistence-and-interoperability.md) <br/><br/>[快速入門手冊：設定 Microsoft Teams 中的通話方案](./configuring-teams-calling-quickstartguide.md) |
