...
:::image type="content" source="media/app-permission-policies-gcc.png" alt-text="在 GCC 和 Dod 中應用程式權限原則的螢幕擷取畫面。" lightbox="media/app-permission-policies-gcc.png":::
...
1. 在 **[Teams 應用程式**  >  **管理應用程式**] 頁面上，選取 **[全組織應用程式設定]**。 然後您就可以在面板中設定您要的設定。
