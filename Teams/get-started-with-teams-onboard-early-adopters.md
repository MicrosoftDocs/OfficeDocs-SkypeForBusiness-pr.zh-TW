...
Teams 桌面用戶端為 Windows 和 Mac 使用者提供最佳的整體體驗。 若要深入了解，請參閱[取得 Teams 用戶端 (桌面用戶端)](./get-clients.md#desktop-clients) 和 [Microsoft Teams 應用程式的硬體需求](./hardware-requirements-for-the-teams-app.md)。
