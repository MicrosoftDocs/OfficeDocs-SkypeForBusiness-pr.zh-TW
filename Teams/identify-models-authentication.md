...
|**混合式設定（已同步或聯合身分識別模型）**     |<ul><li>針對 Office 365 的 MFA</li><li>Azure MFA 模組（ADFS 整合）</li><li>物理或虛擬智慧卡（ADFS 整合）</li></ul>         |注意：您可以使用[AZURE AD 身分識別提供者相容性](https://www.microsoft.com/download/details.aspx?id=56843)檔的其他 MFA 解決方案         |
