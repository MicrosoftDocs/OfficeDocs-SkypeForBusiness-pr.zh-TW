...
---
# <a name="powershell-script-sample---reset-the-autostart-setting-in-teams"></a><span data-ttu-id="79832-103">PowerShell 腳本範例 - 重設自動啟動設定Teams</span><span class="sxs-lookup"><span data-stu-id="79832-103">PowerShell script sample - Reset the autostart setting in Teams</span></span>

<span data-ttu-id="79832-104">使用此腳本可依據Teams重設自動啟動設定。</span><span class="sxs-lookup"><span data-stu-id="79832-104">Use this script to reset the Teams autostart setting on a per-user basis.</span></span> <span data-ttu-id="79832-105">這包括使用者或應用程式所設定Teams值。</span><span class="sxs-lookup"><span data-stu-id="79832-105">This includes any values set by the user or the Teams app.</span></span> <span data-ttu-id="79832-106">根據預設，Teams安裝之後，系統會自動啟動使用者登錄其電腦。</span><span class="sxs-lookup"><span data-stu-id="79832-106">By default, Teams automatically starts when a user logs in to their computer after it's installed.</span></span>

<span data-ttu-id="79832-107">如果您已經部署 Teams，並想要設定在安裝後自動啟動 Microsoft Teams 群組原則[設定](../msi-deployment.md#use-group-policy-recommended)以停用 Teams 自動啟動，您必須先將群組原則設定為您想要的值，然後執行此腳本。</span><span class="sxs-lookup"><span data-stu-id="79832-107">If you've already deployed Teams and want to set the [Prevent Microsoft Teams from starting automatically after installation Group Policy setting](../msi-deployment.md#use-group-policy-recommended) to disable Teams autostart, you'll need to first set the Group Policy setting to the value you want, and then run this script.</span></span>

<span data-ttu-id="79832-108">在Teams使用者啟動自動啟動設定之後，使用群組原則無法停用自動啟動設定。</span><span class="sxs-lookup"><span data-stu-id="79832-108">After Teams is started for a user, the autostart settings can't be disabled by using Group Policy.</span></span>

## <a name="sample-script"></a><span data-ttu-id="79832-109">範例腳本</span><span class="sxs-lookup"><span data-stu-id="79832-109">Sample script</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="79832-110">相關主題</span><span class="sxs-lookup"><span data-stu-id="79832-110">Related topics</span></span>

- [<span data-ttu-id="79832-111">使用 MSI 安裝 Teams</span><span class="sxs-lookup"><span data-stu-id="79832-111">Install Teams using MSI</span></span>](../msi-deployment.md)
- [<span data-ttu-id="79832-112">使用 Teams 部署Microsoft 365 Apps 企業版</span><span class="sxs-lookup"><span data-stu-id="79832-112">Deploy Teams with Microsoft 365 Apps for enterprise</span></span>](/deployoffice/teams-install)