...
---
# <a name="powershell-script-sample---reset-the-autostart-setting-in-teams"></a><span data-ttu-id="e00f5-103">PowerShell 腳本範例-重設小組中的自動啟動設定</span><span class="sxs-lookup"><span data-stu-id="e00f5-103">PowerShell script sample - Reset the autostart setting in Teams</span></span>

<span data-ttu-id="e00f5-104">使用此腳本來重設每位使用者的 [團隊自動啟動] 設定。</span><span class="sxs-lookup"><span data-stu-id="e00f5-104">Use this script to reset the Teams autostart setting on a per-user basis.</span></span> <span data-ttu-id="e00f5-105">這包括使用者或團隊 app 所設定的任何值。</span><span class="sxs-lookup"><span data-stu-id="e00f5-105">This includes any values set by the user or the Teams app.</span></span> <span data-ttu-id="e00f5-106">根據預設，當使用者在安裝後登入其電腦時，小組會自動啟動。</span><span class="sxs-lookup"><span data-stu-id="e00f5-106">By default, Teams automatically starts when a user logs in to their computer after it's installed.</span></span>

<span data-ttu-id="e00f5-107">如果您已部署團隊，並想要設定 [ [避免 Microsoft 團隊在安裝後自動啟動](../msi-deployment.md#use-group-policy-recommended) ]，以停用團隊自動啟動，您必須先將 [群組原則] 設定設為您想要的值，然後執行此腳本。</span><span class="sxs-lookup"><span data-stu-id="e00f5-107">If you've already deployed Teams and want to set the [Prevent Microsoft Teams from starting automatically after installation Group Policy setting](../msi-deployment.md#use-group-policy-recommended) to disable Teams autostart, you'll need to first set the Group Policy setting to the value you want, and then run this script.</span></span>

<span data-ttu-id="e00f5-108">在團隊開始為使用者之後，就無法使用 [群組原則] 停用「自動啟動」設定。</span><span class="sxs-lookup"><span data-stu-id="e00f5-108">After Teams is started for a user, the autostart settings can't be disabled by using Group Policy.</span></span>

## <a name="sample-script"></a><span data-ttu-id="e00f5-109">範例腳本</span><span class="sxs-lookup"><span data-stu-id="e00f5-109">Sample script</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="e00f5-110">相關主題</span><span class="sxs-lookup"><span data-stu-id="e00f5-110">Related topics</span></span>

- [<span data-ttu-id="e00f5-111">使用 MSI 安裝 Teams</span><span class="sxs-lookup"><span data-stu-id="e00f5-111">Install Teams using MSI</span></span>](../msi-deployment.md)
- [<span data-ttu-id="e00f5-112">使用適用于企業的 Microsoft 365 應用程式部署團隊</span><span class="sxs-lookup"><span data-stu-id="e00f5-112">Deploy Teams with Microsoft 365 Apps for enterprise</span></span>](https://docs.microsoft.com/deployoffice/teams-install)
