...
manager: serdars
description: 了解如何註冊免費、即時且由講師帶領的訓練課程，以全面了解 Microsoft Teams。
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>開始使用 Teams</h3>
                        <p>從聊天和會議到使用小組和頻道，使用者都將離開本次工作階段，帶有滿懷信心使用 Teams 的基礎。</p>
                        <p><i>對象：使用者</i></p>
                    </div>
                </div>
            </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>探索 Teams 中的團隊和頻道</h3>
                        <p>了解您如何簡化專案和工作群組共同作業。</p>
                        <p><i>對象：使用者</i></p>
                    </div>
                </div>
            </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>了解使用 Teams 全面提升的方式</h3>
                        <p>了解在日常工作中最佳化和組織 Teams 的創意方法。</p>
                        <p><i>對象：使用者</i></p>
                    </div>
                </div>
            </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Teams 教育版 - 網路演討會</h3>
                        <p>了解在高等教育中如何使用 Teams。</p>
                        <p><i>對象：職員、學生、學者、研究人員、IT 專業人員</i></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>升級規劃研討會</h3>
                        <p>規劃並實行成功的 Teams 升級</p>
                        <p><i>對象：IT 專業人員、採用管理經理</i></p>
                    </div>
                </div>
            </div>
        </div>
