...
出席者將能透過 Android 和 iOS Teams，透過桌面、web 和 Teams加入 (的) 。

> [!Note]
> 「主要會議」或換句話說，完全互動使用者數目的目前限制容量為 1000 人，GCC網路研討會。
...
- 無法使用音訊會議加入僅供檢視會議室。
- 在 CVI 服務中Microsoft Teams 會議室使用雲端視 (間) 聊天室。
- 無法分享他們的音訊或視訊。
- 無法查看或參與會議聊天。
...
- 僅支援只能觀看的出席者受下列大廳政策支援：'只有您'、'我的組織人員與來賓'、'我的組織與信任組織的人，以及來賓'，以及'所有人'。 如果您使用的大廳政策不支援只有 View 的出席者，則只有 View 的出席者會遭到會議拒絕。 
