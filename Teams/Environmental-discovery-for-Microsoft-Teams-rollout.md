...
> | 關鍵字 | 自動回應 | 註解 |
> |---|---|---|
> | 如何 (或如何) 遷移範圍中的使用者 <br/>在 office 中時存取團隊？ <br/>選取 [所有適用的]。 | <input type="checkbox"> 路由 NAT 連線 <br/> <input type="checkbox"> Proxy 伺服器 <br/> <input type="checkbox"> 公用 Wi-Fi <br/> <input type="checkbox"> 受管理的 (不是公用) Wi-Fi <br/> <input type="checkbox"> ExpressRoute <br/>&nbsp;&nbsp; &nbsp; (Microsoft 對等)  ||
