...
> | Exchange 是否已部署？ <br/>針對內部部署和混合式部署，請確定 <br/>您會注意到批註中的版本與 CU 詳細資料 <br/>左欄. | <input type="checkbox">是的，Microsoft 365 <br/> <input type="checkbox">是，混合式 ( <br/>&nbsp;&nbsp; &nbsp;Microsoft 365 或 <br/>&nbsp;&nbsp; &nbsp;Office 365)  <br/> <input type="checkbox">是，內部部署 <br/> <input type="checkbox">是、線上、專用 <br/>&nbsp;&nbsp; &nbsp; (Microsoft)  <br/> <input type="checkbox">是、託管、專用 <br/>&nbsp;&nbsp; &nbsp; (協力廠商)  <br/> <input type="checkbox">是、託管、共用 <br/>&nbsp;&nbsp; &nbsp; (協力廠商)  <br/> <input type="checkbox">否，其他 | |
> | 已部署 SharePoint 嗎？ <br/>針對內部部署和混合式部署，請確定 <br/>您會注意到批註中的版本與 CU 詳細資料 <br/>左欄. | <input type="checkbox">是的，Microsoft 365 <br/> <input type="checkbox">是，混合式 ( <br/>&nbsp;&nbsp; &nbsp;Microsoft 365 或 <br/>&nbsp;&nbsp; &nbsp;Office 365)  <br/> <input type="checkbox">是，內部部署 <br/> <input type="checkbox">是、線上、專用 <br/>&nbsp;&nbsp; &nbsp; (Microsoft)  <br/> <input type="checkbox">是、託管、專用 <br/>&nbsp;&nbsp; &nbsp; (協力廠商)  <br/> <input type="checkbox">是、託管、共用 <br/>&nbsp;&nbsp; &nbsp; (協力廠商)  <br/> <input type="checkbox">否，其他 | |
> | 商務用 OneDrive 是否已部署？ | <input type="checkbox">是的 <br/> <input type="checkbox">不 | |
> | 您是否已部署任何其他協力廠商平臺 <br/>現在還在使用中嗎？ 如果是，請記下的使用者數目 <br/>這些平臺及其中的使用詳細資料 <br/>[批註] 欄。 | <input type="checkbox">Cisco WebEx <br/> <input type="checkbox">寬 <br/> <input type="checkbox">其他 (指定 <br/>&nbsp;&nbsp; &nbsp;[批註] 欄。 )  | 使用者數目： <br/>詳細資料|
...
> | 目前的形式及功能 <br/>目前正在使用中嗎？ | <input type="checkbox">立即訊息和目前狀態 (IM/P) <br/> <input type="checkbox">會談 <br/> <input type="checkbox">聯盟 <br/> <input type="checkbox">會議錄製 <br/> <input type="checkbox">Microsoft 音訊會議 <br/> <input type="checkbox">協力廠商音訊會議 (記事<br/>&nbsp;&nbsp; &nbsp; [批註] 欄中的詳細資料。 )  <br/> <input type="checkbox">呼叫方案 (先前的 PSTN 通話)  <br/> <input type="checkbox">組織自動語音應答 <br/> <input type="checkbox">通話佇列 | |
> | 您已明確封鎖任何 Skype <br/>商務用的線上功能 <br/>如果是，請記下 [批註] 欄中的詳細資料。 | <input type="checkbox">是的 <br/> <input type="checkbox">不 | |
> | 您使用的是哪一種方法，或打算使用它來 <br/>將電話系統 (先前的雲端 PBX) 連線至 <br/>PSTN？ <br/>選取 [所有適用的]。 | <input type="checkbox">呼叫方案 (先前的 PSTN 通話)  <br/> <input type="checkbox">內部部署 PSTN 連線能力 <br/>&nbsp;&nbsp; &nbsp; (利用現有的 Skype <br/>&nbsp;&nbsp; &nbsp;商務2015或 Lync Server <br/>&nbsp;&nbsp; &nbsp; 2013 部署)  <br/> <input type="checkbox">內部部署 PSTN 連線能力 <br/>&nbsp;&nbsp; &nbsp; 使用雲端連接器的 ()  | |
...
> | 目前使用的形式和功能 <br/>即刻? | <input type="checkbox">立即訊息和目前狀態 (IM/P)  <br/> <input type="checkbox">會談 <br/> <input type="checkbox">聯盟 <br/> <input type="checkbox">會議錄製 <br/> <input type="checkbox">持續聊天/群組聊天 <br/> <input type="checkbox">Microsoft 音訊會議 <br/>&nbsp;&nbsp; &nbsp; 在您的電腦上 (先前的電話撥入式會議)  <br/>&nbsp;&nbsp; &nbsp; 內部部署 Lync Server 或 <br/>&nbsp;&nbsp; &nbsp;商務用 Skype 部署 <br/> <input type="checkbox">協力廠商音訊會議 <br/>&nbsp;&nbsp; &nbsp; (記下批註中的詳細資料 <br/>&nbsp;[ &nbsp; &nbsp; 欄]。 )  <br/> <input type="checkbox">使用內部部署的企業語音 <br/>&nbsp; &nbsp; &nbsp;PSTN 連線能力 <br/> <input type="checkbox">先前的 PSTN 呼叫方案 (以前的 PSTN) 透過 <br/>&nbsp;&nbsp; &nbsp;與商務用 Skype Online 混合使用 | |
...
> | 選取您的邊緣角色所提供的 [服務]。 | <input type="checkbox">外部使用者存取 (公司使用者)  <br/> <input type="checkbox">遠端使用者存取 (匿名 <br/>&nbsp;&nbsp; &nbsp; 外部會議參與者)  <br/> <input type="checkbox">聯盟 <br/> <input type="checkbox">媒體轉送 | |
...
您可以使用下表來捕獲貴組織的網路詳細資料，以及您的使用者 (或) 連線至 Microsoft 365 和 Office 365 服務的方式。

> | 關鍵字 | 自動回應 | 註解 |
> |---|---|---|
> | 如何 (或如何) 遷移範圍中的使用者 <br/>在 office 中時存取團隊？ <br/>選取 [所有適用的]。 | <input type="checkbox">路由 NAT 連線 <br/> <input type="checkbox">Proxy 伺服器 <br/> <input type="checkbox">公用 Wi-fi <br/> <input type="checkbox">受管理的 (不是公開) Wi-fi <br/> <input type="checkbox">ExpressRoute <br/>&nbsp;&nbsp; &nbsp; (Microsoft 對等)  ||
