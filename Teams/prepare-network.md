...
<tr class="even">
<td>設定分割隧道 VPN</td>
<td><p>我們建議您為小組流量提供備用路徑，以繞過虛擬私人網路 (VPN) （通常稱為 <a href="https://docs.microsoft.com/windows/security/identity-protection/vpn/vpn-routing">分割隧道 VPN</a>）。 分割隧道意味著 Microsoft 365 或 Office 365 的流量不會透過 VPN，而是直接移至 Microsoft 365 或 Office 365。 略過您的 VPN 會對團隊品質產生正面影響，並減少從 VPN 裝置與組織網路的載入。 若要實現分割隧道 VPN，請與您的 VPN 廠商合作。</p>
<p>我們建議您避開 VPN 的其他原因：
<ul>
