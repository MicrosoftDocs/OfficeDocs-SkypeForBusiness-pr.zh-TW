...
ms.locfileid: "36184035"
---
# <a name="hardware-decoder-and-encoder-driver-recommendations"></a>硬體解碼器與編碼器驅動程式建議

Microsoft 支援所有的解碼器和編碼器, 但本文中所列的除外。

## <a name="hardware-decoder-driver-recommendations---intel"></a>硬體解碼器驅動程式建議-英特爾

下列作業系統、模型及驅動程式的組合不會因各種驅動程式問題而無法啟用硬體加速。

|作業系統           | Model (Device_id) | 驅動程式/範圍 |
|---------------------------|-------------------|--------------|
...
|Windows 7/Windows 8/Windows 8.1/Windows 10 | 同時 | [0.0.0.0]-[8.15.10.2753] |
...
|Windows 7/Windows 8/Windows 8.1/Windows 10 | 同時 | [9.17.10.2867] - [9.17.10.4459] |
|Windows 7/Windows 8/Windows 8.1/Windows 10 |0x1616 | [9.18.7.9] |
|Windows 7/Windows 8/Windows 8.1/Windows 10 | 同時 | [10.18.10.3431] - [10.18.10.4425] |
|Windows 7/Windows 8/Windows 8.1/Windows 10 | 同時 | [10.18.14.4280] |
...
|Windows 7/Windows 8/Windows 8.1/Windows 10 | 同時 |[10.18.15.4281] |
|Windows 7/Windows 8/Windows 8.1/Windows 10 | 同時 |[20.19.15.4390] - [20.19.15.4444] |
|Windows 10 | 同時 | [21.20.16.4541] |
|Windows 10 | 同時 | [22.20.16.4811] |
|Windows 10 | 同時 | [24.20.100.6293] |

## <a name="hardware-decoder-driver-recommendations---nvidia"></a>硬體解碼器驅動程式建議-Nvidia
...
|Windows 7/Windows 8/Windows 8.1/Windows 10 | 同時 | [8.17.11.9745], [8.17.12.5738] |
...
|Windows 10 | 同時 | [10.18.13.5891] - [10.18.13.6881] |
|Windows 10 | 同時 | [21.21.13.6909], [21.21.13.7570] |
|Windows 7 | 同時 | [21, 21, 13, 4201] |

## <a name="hardware-decoder-driver-recommendations---amd"></a>硬體解碼器驅動程式建議-AMD

針對舊版作業系統, 只會針對硬體加速啟用下列 Device_ids。

|作業系統           | Model (Device_id) |
|---------------------------|-------------------|
...
|作業系統           | Model (Device_id) | 驅動程式/範圍 |
|---------------------------|-------------------|--------------|
|Windows 7/Windows 8/Windows 8.1/Windows 10 | 同時 | [0.0.0.0] – [25.20.15017.1009] |

## <a name="hardware-encoder-driver-recommendations---intel"></a>硬體編碼器驅動程式建議-英特爾

下列作業系統、模型及驅動程式的組合不會因各種驅動程式問題而無法啟用硬體加速。

|作業系統           | Model (Device_id) | 驅動程式/範圍 |
|---------------------------|-------------------|--------------|
|Windows 7 | 同時 | [8.15.10.2200] - [8.15.10.2600] |
|Windows 7/Windows 8/Windows 8.1/Windows 10 | 同時 | [8.15.10.2653] - [8.15.10.2827] |
|Windows 7/Windows 8/Windows 8.1/Windows 10 | 同時 | [9.14.3.1176] - [9.14.3.1177] |
|Windows 7/Windows 8/Windows 8.1/Windows 10 | 同時 | [9.17.10.2800] - [9.17.10.9999] |
|Windows 7/Windows 8/Windows 8.1/Windows 10 | 同時 | [9.18.10.3222] |
|Windows 7 | 同時 | [9.18.10.3234] |
|Windows 7 | 同時 | [9.18.10.3272] |
|Windows 7 | 同時 | [10.18.10.3242] - [10.18.10.9999] |
|Windows 8/Windows 8.1/Windows 10 | 同時 | [10.18.10.0000] - [10.18.10.9999] |
|Windows 7/Windows 8/Windows 8.1/Windows 10 | 同時 | [10.18.14.4153] - [10.18.14.4161] |
|Windows 7/Windows 8/Windows 8.1/Windows 10 | 同時 | [10.18.14.4264] |
|Windows 7 | 同時 | [10.18.14.4578] |
|Windows 7 | 同時 | [10.18.14.4889] |
|Windows 7 | 同時 | [10.18.14.5057] |
|Windows 7/Windows 8/Windows 8.1/Windows 10 | 同時 | [20.19.15.4300] - [20.19.15.4444] |
|Windows 7 | 同時 | [20.19.15.4474] |

## <a name="hardware-encoder-driver-recommendations---nvidia"></a>硬體編碼器驅動程式建議-Nvidia

下列作業系統、模型及驅動程式的組合不會因各種驅動程式問題而無法啟用硬體加速。

|作業系統           | Model (Device_id) | 驅動程式/範圍 |
|---------------------------|-------------------|--------------|
|Windows 7/Windows 8/Windows 8.1/Windows 10 | 同時 | [0.0.0.0]-[21.21.13.7848] |

## <a name="hardware-encoder-driver-recommendations---amd"></a>硬體編碼器驅動程式建議-AMD
...
|Windows 7 | 同時 | [0.0.0.0]-[16.199.9999.9999] |
|Windows 7/Windows 8/Windows 8.1/Windows 10 | 同時 | [15.21.0.0] - [16.199.9999.9999] |
|Windows 7/Windows 8/Windows 8.1/Windows 10 | 同時 | [15.201.1101.0] |
|Windows 7/Windows 8/Windows 8.1/Windows 10 | 同時 | [21.19.137.1] |
