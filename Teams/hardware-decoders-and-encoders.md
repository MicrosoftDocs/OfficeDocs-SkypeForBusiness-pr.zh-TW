...
description: 列出因驅動程式問題而無法啟用硬體加速的作業系統、型號和驅動程式組合。
f1.keywords:
- CSH
ms.custom:
...
除了本文所列的解碼器和編碼器以外，Microsoft 支援所有解碼器和編碼器。

## <a name="hardware-decoder-driver-recommendations---intel"></a>硬體解碼器驅動程式建議 - Intel

下列作業系統、型號和驅動程式組合因各種驅動程式問題而無法啟用硬體加速。

|作業系統           | 型號 (Device_id)  | 驅動程式/範圍 |
|---------------------------|-------------------|--------------|
