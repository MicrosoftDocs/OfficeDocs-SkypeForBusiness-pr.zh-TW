...
- 會議開始時，召集人必須允許大廳的所有 PSTN 使用者加入會議。 例如，如果兩個 PSTN 參與者嘗試在會議開始之前加入會議，則他們會放在大廳中，並聆聽保留中的音樂，當會議召集人透過電話使用 PIN 加入時，會議將會開始，而召集人可以使用會議內命令 (按 *21) 來准許大廳的所有 PSTN 使用者。
