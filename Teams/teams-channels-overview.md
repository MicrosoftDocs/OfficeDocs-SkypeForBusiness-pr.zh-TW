...
- [技術提示：在 Microsoft Teams](https://youtu.be/WkAVgNKn0hs) 中建立 Teams 和頻道 (包括私人頻道) 的指引 (21：08 分鐘)

## <a name="membership-roles-and-settings"></a>成員資格、角色和設定

**團隊成員資格**

為您的整個組織啟用 Teams 時，團隊擁有者可以邀請與貴組織中共同作業的任何員工加入其團隊。 Teams 可讓團隊擁有者根據姓名輕鬆地在組織中新增人員。 根據貴組織的設定，組織外部人員可將來賓新增至您的團隊。 如需詳細資訊，請參閱 [Microsoft Teams 中的來賓存取](guest-access.md)。 
...
以下幾個實用案例可說明不同類型的使用者可如何設定其團隊、頻道和應用程式 (索引標籤/連接器/Bot)。 這可能有助於您與您的使用者社群開始一個有關 Teams 的交談。 當您思考如何在您組織中實作 Teams 時，請記住，您可以提供如何建構團隊的指導方針，不過，使用者可以自行控制管理方式。 這些只是協助團隊開始思考可能性的範例。
...
|物流     |倉儲營運<br></br>交通工具維護<br></br>司機名冊         |氣象服務<br></br>旅行/道路中斷<br></br>Planner<br></br>UPS Bot         |
...
您可以建立與組織結構一致的團隊。領導者最適合使用此服務來推動士氣、進行團隊特定審查、闡明員工到職到流程、討論工作力計畫，以及提高多樣化人力的可見度。  
