...
如果貴組織的使用者不超過 5000, 您可以建立組織範圍的小組。 組織範圍的團隊會提供自動方法, 讓組織中的每個人都成為單一小組共同作業的一部分。 如需詳細資訊 (包括建立及管理組織內小組的最佳做法), 請參閱[在 Microsoft 團隊中建立組織範圍的小組](create-an-org-wide-team.md)。
