...
ms.locfileid: "41708219"
---
# <a name="toll-free-dialing-restrictions-in-belarus"></a>在白俄羅斯中免付費電話撥號限制
...
|:-----|:-----|
|免費通話嗎？  <br/> |是  <br/> |
|撥號格式（s）  <br/> |8 820 XXXX XXXX  <br/> |
|國家/地區 ISO 代碼  <br/> |按照  <br/> |
|已覆蓋的島/地區  <br/> |不適用  <br/> |
|未涵蓋的島/區域  <br/> |不適用  <br/> |
|有線/固定線路可用性  <br/> |是  <br/> |
|行動網路可用性  <br/> |是  <br/> |
|批註、限制及存取問題  <br/> |從 Velcom、MTS 和生活的行動網路存取。  <br/> |
