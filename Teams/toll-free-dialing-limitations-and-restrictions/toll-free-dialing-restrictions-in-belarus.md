...
---
# <a name="toll-free-dialing-restrictions-in-belarus"></a>白俄羅斯免付費撥號限制
...
|:-----|:-----|
|免付費通話是否可用？  <br/> |是  <br/> |
|撥號格式 ()   <br/> |8 820 XXXX XXXX  <br/> |
|國家/地區 ISO 代碼  <br/> |BY  <br/> |
|涵蓋的島嶼/地區  <br/> |不適用  <br/> |
|未涵蓋的島嶼/地區  <br/> |不適用  <br/> |
|有線/固定線路可用性  <br/> |是  <br/> |
|行動網路可用性  <br/> |是  <br/> |
|批註、限制和存取問題  <br/> |從 Velcom、MTS 和 Life 存取行動網路。  <br/> |
