...
ms.locfileid: "41707608"
---
# <a name="toll-free-dialing-restrictions-in-ireland"></a>愛爾蘭免付費電話撥號限制
...
|國家/地區 ISO 代碼  <br/> |亦  <br/> |
|已覆蓋的島/地區  <br/> |所有 offshore （愛爾蘭共和國）都已涵蓋。  <br/> |
|未涵蓋的島/區域  <br/> |不適用  <br/> |
|有線/固定線路可用性  <br/> |是  <br/> |
|行動網路可用性  <br/> |是  <br/> |
|批註、限制及存取問題  <br/> |透過 Vodafone、O2 Digiphone、Meteor 和 H3G 行動網路進行存取。  <br/> |
