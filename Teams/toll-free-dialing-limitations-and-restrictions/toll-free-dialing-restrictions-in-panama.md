...
ms.locfileid: "41693488"
---
# <a name="toll-free-dialing-restrictions-in-panama"></a>巴拿馬中的免付費撥號限制
...
|:-----|:-----|
|免費通話嗎？  <br/> |是  <br/> |
|撥號格式（s）  <br/> | 00-800-XXX-XXXX <br/> |
|國家/地區 ISO 代碼  <br/> |賓夕法尼亞  <br/> |
|已覆蓋的島/地區  <br/> |不適用  <br/> |
|未涵蓋的島/區域  <br/> |不適用  <br/> |
|有線/固定線路可用性  <br/> |只從&amp;C W。  <br/> |
|行動網路可用性  <br/> |否  <br/> |
|批註、限制及存取問題  <br/> |客戶必須在免付費電話號碼之前撥打011（國際長途巴拿馬程式碼）。  <br/> |
