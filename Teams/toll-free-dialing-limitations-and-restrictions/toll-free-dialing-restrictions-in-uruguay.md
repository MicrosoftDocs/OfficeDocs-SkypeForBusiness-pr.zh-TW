...
ms.locfileid: "58636407"
---
# <a name="toll-free-dialing-restrictions-in-uruguay"></a>在阿根廷的免付費撥號限制
...
|:-----|:-----|
|免付費通話是否可用？  <br/> |是  <br/> |
|撥號格式 ()   <br/> |0004 019 XXXX  <br/> |
|國家/地區 ISO 代碼  <br/> |UY  <br/> |
|涵蓋的島嶼/地區  <br/> |不適用  <br/> |
|未涵蓋的島嶼/地區  <br/> |不適用  <br/> |
|有線/固定線路可用性  <br/> |是，除了來自Clro。  <br/> |
|行動網路可用性  <br/> |部分。 查看批註。  <br/> |
|批註、限制和存取問題  <br/> |行動存取：Airtime 會收費。 行動存取：可從 Ancel 和 Movistar 取得。  <br/> |
