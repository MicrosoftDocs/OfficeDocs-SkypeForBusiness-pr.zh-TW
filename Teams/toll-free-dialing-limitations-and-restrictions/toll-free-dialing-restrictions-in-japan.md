...
ms.locfileid: "37565442"
---
# <a name="toll-free-dialing-restrictions-in-japan"></a>日文免付費電話撥號限制
...
|:-----|:-----|
|免費通話嗎？  <br/> |是的  <br/> |
|撥號格式（s）  <br/> |00531 XX XXXX  <br/> |
|國家/地區 ISO 代碼  <br/> |JA-JP  <br/> |
|已覆蓋的島/地區  <br/> |不適用  <br/> |
|未涵蓋的島/區域  <br/> |不適用  <br/> |
|有線/固定線路可用性  <br/> |是的  <br/> |
|行動網路可用性  <br/> |部分. 請參閱批註。  <br/> |
|批註、限制及存取問題  <br/> |行動網路存取： NTT Docomo、Au （KDD）和 Softbank。  <br/> |
