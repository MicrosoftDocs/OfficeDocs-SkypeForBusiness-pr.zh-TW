...
ms.locfileid: "58608650"
---
# <a name="toll-free-dialing-restrictions-in-bosnia-and-herzegovina"></a>波士尼亞和黑塞哥維納的免付費撥號限制
...
|:-----|:-----|
|免付費通話是否可用？  <br/> |是  <br/> |
|撥號格式 ()   <br/> | 0800 XXXXX <br/> |
|國家/地區 ISO 代碼  <br/> |八  <br/> |
|涵蓋的島嶼/地區  <br/> |不適用  <br/> |
|未涵蓋的島嶼/地區  <br/> |不適用  <br/> |
|有線/固定線路可用性  <br/> |部分。 查看批註。  <br/> |
|行動網路可用性  <br/> |部分。 查看批註。  <br/> |
|批註、限制和存取問題  <br/> |可從 HT Eronet/Mostar、Telekom 公開/MTEL 和 BHT 固定與行動網路進行訪問。  <br/> |
