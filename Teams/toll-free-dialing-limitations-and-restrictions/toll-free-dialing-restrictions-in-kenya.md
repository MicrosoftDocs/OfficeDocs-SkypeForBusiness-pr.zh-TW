...
ms.locfileid: "41682400"
---
# <a name="toll-free-dialing-restrictions-in-kenya"></a>肯雅免付費電話撥號限制
...
|:-----|:-----|
|免費通話嗎？  <br/> |是  <br/> |
|撥號格式（s）  <br/> | 0 800 7XX XXX <br/> |
|國家/地區 ISO 代碼  <br/> |KE  <br/> |
|已覆蓋的島/地區  <br/> |不適用  <br/> |
|未涵蓋的島/區域  <br/> |不適用  <br/> |
|有線/固定線路可用性  <br/> |部分. 請參閱批註。  <br/> |
|行動網路可用性  <br/> |部分. 請參閱批註。  <br/> |
|批註、限制及存取問題  <br/> |已修正網路存取： Safaricom 和 Airtel。 行動網路存取： Safaricom、Airtel 和橙色。  <br/> |
