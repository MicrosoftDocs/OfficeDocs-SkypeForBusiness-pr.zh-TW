...
ms.locfileid: "58600978"
---
# <a name="toll-free-dialing-restrictions-in-kenya"></a>肯亞的免付費撥號限制
...
|:-----|:-----|
|免付費通話是否可用？  <br/> |是  <br/> |
|撥號格式 ()   <br/> | 0 800 7XX XXX <br/> |
|國家/地區 ISO 代碼  <br/> |科  <br/> |
|涵蓋的島嶼/地區  <br/> |不適用  <br/> |
|未涵蓋的島嶼/地區  <br/> |不適用  <br/> |
|有線/固定線路可用性  <br/> |部分。 查看批註。  <br/> |
|行動網路可用性  <br/> |部分。 查看批註。  <br/> |
|批註、限制和存取問題  <br/> |已修正網路存取：Safaricom 和 Airtel。 行動網路存取：Safaricom、Airtel 和 Orange。  <br/> |
