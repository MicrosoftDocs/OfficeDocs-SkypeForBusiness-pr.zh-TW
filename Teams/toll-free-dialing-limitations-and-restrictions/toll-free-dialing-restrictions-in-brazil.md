...
---
# <a name="toll-free-dialing-restrictions-in-brazil"></a>巴西免付費電話撥號限制
...
|:-----|:-----|
|免費通話嗎？  <br/> |是  <br/> |
|撥號格式（s）  <br/> | 0800-891-XXXX <br/>  0800 XXX XXXX <br/> |
|國家/地區 ISO 代碼  <br/> |<  <br/> |
|已覆蓋的島/地區  <br/> |不適用  <br/> |
|未涵蓋的島/區域  <br/> |不適用  <br/> |
|有線/固定線路可用性  <br/> |是  <br/> |
|行動網路可用性  <br/> |部分但在津貼比率中。 請參閱批註。  <br/> |
|批註、限制及存取問題  <br/> |行動裝置存取：沒有付費的 airtime。  <br/> |
