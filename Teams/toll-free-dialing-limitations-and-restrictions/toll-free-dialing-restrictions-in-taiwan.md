...
---
# <a name="toll-free-dialing-restrictions-in-taiwan"></a>臺灣免付費撥號限制
...
|:-----|:-----|
|免付費通話是否可用？  <br/> |是  <br/> |
|撥號格式 ()   <br/> |00 801 XXX XXX  <br/> |
|國家/地區 ISO 代碼  <br/> |TW  <br/> |
|涵蓋的島嶼/地區  <br/> |不適用  <br/> |
|未涵蓋的島嶼/地區  <br/> |不適用  <br/> |
|有線/固定線路可用性  <br/> | ITFS：KG Telecom = NO <br/> |
|行動網路可用性  <br/> |部分。 查看批註。  <br/> |
|批註、限制和存取問題  <br/> |無法從KG Telecom 存取有線電話。 行動存取：不收取空時費用。 行動存取：從KG Telecom 以外的所有行動網路存取。  <br/> |
