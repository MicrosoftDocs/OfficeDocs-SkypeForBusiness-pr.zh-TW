...
ms.locfileid: "37572897"
---
# <a name="toll-free-dialing-restrictions-in-taiwan"></a>臺灣免付費電話撥號限制
...
|:-----|:-----|
|免費通話嗎？  <br/> |是的  <br/> |
|撥號格式（s）  <br/> |00 801 XXX XXX  <br/> |
|國家/地區 ISO 代碼  <br/> |華文  <br/> |
|已覆蓋的島/地區  <br/> |不適用  <br/> |
|未涵蓋的島/區域  <br/> |不適用  <br/> |
|有線/固定線路可用性  <br/> | ITFS： KG 電信 = 否 <br/> |
|行動網路可用性  <br/> |部分. 請參閱批註。  <br/> |
|批註、限制及存取問題  <br/> |無法從 KG 電訊取得有線存取。 行動裝置存取：沒有付費的 airtime。 針對行動裝置存取：從所有行動網路存取，除了 KG 電訊。  <br/> |
