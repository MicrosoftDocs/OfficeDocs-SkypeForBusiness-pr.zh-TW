...
ms.locfileid: "58598527"
---
# <a name="how-many-phone-numbers-can-you-get"></a>您可以取得多少電話號碼？

當您尋找及取得貴組織的電話號碼時，您可以取得比已指派授權更多的電話號碼。 但這取決於您購買和指派的電話號碼類型及授權類型。 您可以按一下[[通話方案](different-kinds-of-phone-numbers-used-for-calling-plans.md)使用的不同電話號碼類型，以找出在通話方案中使用的不同電話號碼Microsoft Teams。
  
您可以在 Microsoft Teams 系統管理中心的取得電話號碼頁面上查看可取得的電話號碼數目，或者您可以執行[Get-CsOnlineTelephoneNumberAvailableCount](/powershell/module/skype/Get-CsOnlineTelephoneNumberAvailableCount) Cmdlet。
  
> [!IMPORTANT]
> 下列限制不包含您移轉或移轉到 Microsoft 的電話號碼。 
