...
```
 將剖析器儲存為 KQL 函數，其別名為 TeamsData。 它將用於後續查詢。 如需設定及使用 KQL 函數作為剖析器的詳細資訊，請參閱本[技術社群文章](https://techcommunity.microsoft.com/t5/azure-sentinel/using-kql-functions-to-speed-up-analysis-in-azure-sentinel/ba-p/712381) (英文)。
