...
description: 瞭解如何在 Microsoft Teams 中建立和管理Microsoft Teams。
...
如果您已經部署組織中直接路由[](direct-routing-landing-page.md)，您可以使用通話路由策略來允許 Teams 使用者使用您的內部部署電話基礎結構接收及撥打公用交換電話網絡 (PSTN) 。

呼叫路由 (也稱為語音路由) 是 PSTN 使用記錄的容器。 您可以到系統管理中心中的語音語音路由Microsoft Teams使用語音路由  >  **** Windows PowerShell。
