...
1. 登入[您的Teams系統管理中心](https://admin.teams.microsoft.com)。

2. 在左側窗格中，選取 **[語音**]，然後 **電話數位。**
...
- 開啟現有大小寫、向下捲動，然後選取 [**新增批註**]，**與 TNS 服務台** 就您的案例進行溝通。 將會顯示新視窗。 在註解方塊中輸入您的訊息。 附加任何可協助您處理要求的支援文件 (如果有)，然後選取 **[提交]**。
