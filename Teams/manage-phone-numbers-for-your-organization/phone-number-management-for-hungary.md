...
|將電話號碼轉接給我們。<br/> | 下載此表單。 <br/>[匈牙利 (LOA) 授權書 (所有號碼)  (v.1.0)  (hu-hu) ](https://download.microsoft.com/download/f/b/1/fb17b2df-b5cf-45b7-89f0-0cbf250df1f7/letter-of-authorization-(loa)-for-hungary-(all-numbers)-(v1.0)-(hu-hu)%20(1).pdf) <br/> <br/>填寫並 [連連 PTSN 服務台以尋找指示](contact-pstn-service-desk.md)。 <br/><br/>在這個市場中，移轉數位可能需要兩到三周才能完成。 <br/><br/>這些號碼目前無法用於會議。   |
