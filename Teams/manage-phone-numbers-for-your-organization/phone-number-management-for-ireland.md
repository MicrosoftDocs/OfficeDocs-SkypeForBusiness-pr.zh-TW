...
|**您想要做什麼？**|**下載正確的表單**|
|:-----|:-----|
|取得系統管理中心未Microsoft Teams新使用者Microsoft Teams電話號碼。 <br/> |在愛爾蘭，您無法使用系統管理中心取得Microsoft Teams電話號碼。 您必須提交新的電話號碼要求。 <br/><br/>下載此表單。<br/>[適用于愛爾蘭的新電話號碼要求 (v.5.0)  (en-us) 。](https://download.microsoft.com/download/9/e/5/9e5634d7-ce23-489f-b867-6f5120645fb1/new-phone-number-request-for-ireland-(v.5.0)-(en-us).pdf) <br/><br/> 填寫它，並 [連上 PTSN 服務台以尋找指示](contact-pstn-service-desk.md)。  <br/> |
