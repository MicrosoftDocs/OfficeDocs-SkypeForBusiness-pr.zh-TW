...
ms.locfileid: "57849718"
---
# <a name="phone-number-management-for-italy"></a>電話義大利的號碼管理
...
|將電話號碼轉接給我們。  <br/> | 下載此表單。 <br/>[義大利 (LOA (授權書) 所有 (6.0)  (6.0)  (所有) ](https://download.microsoft.com/download/e/8/a/e8a20665-cbea-4f15-a50c-b8e1f6ef352d/letter-of-authorization-(loa)-for-italy-(all-numbers)-(v.6.0)-(it-it).pdf) <br/> <br/>填寫並 [連連 PTSN 服務台以尋找指示](contact-pstn-service-desk.md)。 |
