...
|將電話號碼轉接給我們。   | 下載此表單。 <br/>斯洛伐克 (LOA) 授權書 (所有)  ([v.1.0)  (en-sk) 。](https://download.microsoft.com/download/5/e/2/5e294448-313e-4398-bd8e-bbaee92dc78d/letter-of-authorization-(loa)-for-slovakia-(all-numbers)-(v.1.0)-(en-sk).pdf) <br/> <br/>斯洛伐克 (LOA) 授權書 (所有號碼[)  (v.1.0)  (sk-sk) 。](https://download.microsoft.com/download/f/2/d/f2d73643-c597-4da6-8e0e-d6d3af3737a3/letter-of-authorization-(loa)-for-slovakia-(all-numbers)-(v.1.0)-(sk-sk)(2).pdf) <br/><br/>填寫並 [傳送給我們](mailto:ptneu@microsoft.com)。 <br/><br/>在這個市場中，移轉數位可能需要四到五周才能完成。 <br/><br/>這些號碼目前無法用於會議。 |
