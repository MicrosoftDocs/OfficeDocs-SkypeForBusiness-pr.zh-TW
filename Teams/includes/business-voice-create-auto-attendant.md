...
取得服務號碼 (服務號碼是自動總機使用的特殊電話號碼類型) 您所需的自動總機號碼，您需從組織外部直接撥號來取得。 這可能包括 [從另一個提供者移轉號碼](../phone-number-calling-plans/transfer-phone-numbers-to-teams.md) 或 [要求新的服務號碼](../getting-service-phone-numbers.md)。

每個自動總機都需要指派一個電話系統虛擬使用者授權。 當您購買 Business Voice 時，您也會收到電話系統 - 虛擬使用者授權，因此您可能不需要要求更多。 不過，如果您日後需要更多，您可以遵循 電話系統[- 虛擬使用者授權中的指示電話系統取得。](../teams-add-on-licensing/virtual-user.md)
...
您建立的每個自動助理都需要資源帳戶。 這類似于使用者帳戶，除了該帳戶與自動通話或通話佇列相關聯，而不是與人員相關聯。 在此步驟中，我們將建立帳戶、指派帳戶Microsoft 365 電話系統 *虛擬* 使用者授權，然後指派服務號碼。
...
1. 在系統管理Teams中，展開 **[語音** 與語音提示與自動 **語音** 留言，然後按一下 [**新增**> 。
...
4. 如果您想要使用此自動助理做為公司目錄，請在目錄搜尋 **下，選取****按名稱撥號**。 當您啟用此選項時，來電者可以說出使用者的名稱，或在電話鍵臺上輸入。 任何擁有授權電話系統使用者都是合格的使用者，而且可以使用撥號名稱找到。 
