...
您可以在系統管理中心的 [**團隊 app** ] 中管理貴組織的應用程式。  (請參閱[使用團隊管理員角色管理團隊](https://docs.microsoft.com/microsoftteams/using-admin-roles)，瞭解如何取得管理員角色和許可權。 ) 例如，您可以在組織階層允許或封鎖 app、設定原則以控制團隊使用者可以使用哪些應用程式，以及將最重要的 app 釘選到您的使用者，來自訂團隊。
