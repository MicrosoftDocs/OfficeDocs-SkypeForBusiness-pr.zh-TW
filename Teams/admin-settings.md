...
若要深入瞭解，請參閱在 Teams[中管理Teams。](manage-apps.md)
...
若要深入瞭解，請前往 管理[Teams 中的應用程式許可權Teams。](teams-app-permission-policies.md)
...
- 選擇性地釘選核心Teams功能，例如聊天、Teams和通話。 這麼做有助於確保使用者參與Teams。

若要深入瞭解，請查看管理[應用程式設定Teams。](teams-app-setup-policies.md)
...
若要深入瞭解，請前往 管理中的[自訂應用程式](teams-custom-app-policies-and-settings.md)Teams。