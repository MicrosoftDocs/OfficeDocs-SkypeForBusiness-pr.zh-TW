...
---
# <a name="set-up-meeting-dial-out-confirmation-for-your-users-in-microsoft-teams"></a>在 Microsoft Teams 中為使用者設定會議撥出確認

會議撥出和撥打電話給我是邀請參與者加入會議，以及現有參與者使用傳統或行動電話加入會議非常有用的方式。 不過，當通話者無法接聽來電，且語音信箱系統接聽來電時，語音信箱系統會連接到會議，參與者將能夠聆聽，直到會議移除。
