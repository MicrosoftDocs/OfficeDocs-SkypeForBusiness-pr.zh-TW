...
> [!NOTE]
> 雖然 Teams 服務系統管理員無法使用審查許可權和同意選項，而且無法將整個組織系統管理員同意給應用程式，Teams 服務系統管理員可以在應用程式的 "許可權" 選項卡上查看內容。**** 例如，Teams系統管理員可以按一下 [**Azure Active Directory連結，** 即可在 Azure AD 入口網站中查看應用程式Azure AD詳細資料。 
