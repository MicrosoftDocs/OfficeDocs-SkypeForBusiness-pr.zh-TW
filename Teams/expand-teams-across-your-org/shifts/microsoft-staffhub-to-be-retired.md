...
在團隊網頁用戶端、團隊桌面用戶端，以及團隊行動用戶端 (iOS 和 Android) ，提供倒班。
 
#### <a name="are-there-differences-between-the-shifts-desktop-and-web-apps-and-the-mobile-ios-and-android-apps"></a>將桌面與 web app 以及行動 (iOS 和 Android) app 之間是否有差異？
...
您可以在下列語言中使用倒班：簡體中文、英文 (美國 ) 、西班牙文、俄文、日文、法文、巴西文-葡萄牙文、德文、韓語、義大利文、中國傳統、荷蘭文、義大利文、英國、丹麥文及挪威文。 我們打算在將來新增其他語言支援。  
...
#### <a name="does-each-user-need-to-have-a-microsoft-365-or-office-365-account-or-azure-active-directory-azure-ad-account"></a>每位使用者都需要將 Microsoft 365 或 Office 365 帳戶或 Azure Active Directory (Azure AD) 帳戶？

是的，在小組中使用團隊和倒班的每位管理員和小組成員，都必須在 (Azure AD) 中擁有 Microsoft 365 或 Office 365 帳戶，且必須指派有效的授權。
