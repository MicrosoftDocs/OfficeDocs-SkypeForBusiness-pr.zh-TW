...
若要使用這些範本, 只要將申請主體中的 ' template@odata.bind」屬性從「標準」變更為上述 TemplateIDs。  如需如何部署團隊範本的詳細資訊, 請參閱[建立團隊](https://docs.microsoft.com/graph/api/team-post?view=graph-rest-beta)的 Microsoft Graph 文章。
