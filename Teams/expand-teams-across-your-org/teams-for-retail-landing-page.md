...
### <a name="cross-store-communication-and-collaboration"></a>跨商店通訊和共同作業
...
為您的工作者選擇適當的授權、管理其帳戶和管理其裝置，為員工打下正確的基礎，以便您可以提供安全、符合規範的方式讓其完成工作。
...
| Yammer | 使用 Yammer 連接您的組織並允許跨部門與地區的通訊。 | [管理 Yammer](/yammer) | [使用 Yammer](https://support.microsoft.com/office/what-is-yammer-1b0f3b3e-89ee-4b66-aac5-30def12f287c) |

### <a name="use-templates-to-set-up-teams"></a>使用範本來設定團隊

建立團隊，其中包括預先定義的一組設定、頻道、索引標籤和預先安裝的應用程式，以在個別商店、地區內，或在總部與您的人員之間 (無論他們身在何處) 進行通訊和共同作業。

- 零售 **組織商店** 範本包含一般、班次交班、商店整備度和學習的頻道，並包含核准、工作及 Wiki 應用程式。
- **適用於經理的零售** 範本包含一般、作業和學習的頻道，並包含 Wiki 的索引標籤。

您也可以[建立自訂範本](../create-a-team-template.md)，以包含您的商店所需的應用程式。 詳細資訊：[開始使用零售業團隊範本](../get-started-with-retail-teams-templates.md)

除了團隊範本之外，您也可以設定其他網站和服務，以協助進行通訊：SharePoint 網站和 Viva Connections。

- 設定 SharePoint 網站以為您的組織建立首頁、跨公司發佈新聞，以及為上線使用者提供具有資源的位置。 在[組織通訊：指引、方法和產品](/sharepoint/corporate-communications-overview)深入了解使用 SharePoint 網站進行公司通訊的案例。
- 使用 Viva Connections 將各項結合在一起。 使用 Viva Connections 做為員工在 Teams 中的首頁，他們可以取得有關其工作、組織新聞等的更新。 如需詳細資訊，請參閱[概觀：Viva Connections (預覽)](/viva/connections/viva-connections-overview) 和[在 Teams 系統管理中心新增 Viva Connections 應用程式 (預覽)](/viva/connections/add-viva-connections-app)。
