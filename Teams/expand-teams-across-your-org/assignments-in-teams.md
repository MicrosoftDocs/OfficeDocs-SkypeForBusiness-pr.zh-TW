...
該電子郵件將會包含上周的工作分派及未來一周的作業相關資訊，並將于週末傳送。 您可以在這裡找到有關電子郵件內容的資訊。 您必須使用 [學校資料同步處理 (SDS) ](https://docs.microsoft.com/schooldatasync/)，才能由管理員設定並更新電子郵件。 此功能會自動使用學校的學生資訊系統 (SIS) 中的 [學生 rosters]，為小組填入課程。 啟用此功能的步驟如下：
...
Turnitin 是 plagiarism 偵測服務。 這是協力廠商產品或服務，受限於它本身的條款與隱私權原則。 您負責使用任何協力廠商產品和服務。
