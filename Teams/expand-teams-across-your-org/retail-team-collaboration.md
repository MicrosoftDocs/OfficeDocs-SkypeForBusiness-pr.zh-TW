---
title: 零售團隊共同作業
description: 了解零售團隊如何在商店內或商店間或位置之間有效地共同作業。
ms.topic: conceptual
author: daisyfeller
...
## <a name="day-to-day-communications-and-collaboration-in-teams"></a>Teams 中的日常通訊和共同作業
...
![資訊圖表顯示 Teams 中及以 Teams 應用程式形式提供的不同功能，如下列清單所述。](../media/retail-teams-collaborate.png)
...
### <a name="set-up-your-teams-channels-and-apps"></a>設定您的團隊、頻道和應用程式
...
#### <a name="create-a-team-based-on-a-template"></a>根據範本建立團隊
...
## <a name="connect-information-from-across-the-organization-with-viva-connections"></a>使用 Viva Connections 連接整個組織的資訊
...
## <a name="connect-across-your-organization-with-yammer-and-teams"></a>使用 Yammer 和 Teams 與整個組織連絡
