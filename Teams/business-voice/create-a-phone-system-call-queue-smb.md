---
title: 在小型企業教學課程Microsoft Teams 電話系統通話佇列
author: CarolynRowe
ms.author: crowe
manager: serdars
ms.reviewer: dobro
...
- Phone System
description: 瞭解如何在 Microsoft Teams 電話系統 中為中小型企業設定Microsoft Teams 電話系統。
ms.openlocfilehash: 8856d447d9197be4833d95fa6262bee1832b4b44
ms.sourcegitcommit: e86e3824c300c24e022d5cb1848338278a5a96a8
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 03/03/2022
ms.locfileid: "63053072"
---
# <a name="create-a-call-queue---small-and-medium-business-tutorial"></a>建立通話佇列 - 中小型企業教學課程
...
這段影片示範如何在 Microsoft Teams 中建立Microsoft Teams。

> [!VIDEO https://www.microsoft.com/videoplayer/embed/RWCF23?autoplay=false]

## <a name="before-you-begin"></a>開始之前

取得Microsoft Teams 電話[標準 - 虛擬](../teams-add-on-licensing/virtual-user.md)使用者授權 ，如果您還沒有這些授權。 針對您打算設定的每個通話佇列和自動話務員取得一個。 這些授權是免費的，因此我們建議您額外取得一些授權，以防您決定日後變更您的設定。

由於通話佇列中的代理人可能會撥出以傳回客戶電話，請考慮將呼叫代理的本機號碼設定為主電話號碼或適當的自動語音機號碼。 請參閱[在 Microsoft Teams 管理來電](../caller-id-policies.md)顯示Microsoft Teams以瞭解更多資訊。

<a name="steps"></a>

## <a name="follow-these-steps-to-set-up-your-call-queue"></a>請遵循下列步驟來設定您的通話佇列

### <a name="step-1---create-a-team"></a>[步驟 1 - 建立團隊](#tab/create-team)
...
7. 輸入您想要在通話佇列中擁有之人員的名稱，然後按一下 [ **新增**。

8. 按一下 **[關閉**。 您新加入團隊的人會收到一封電子郵件，讓他們知道他們現在是您團隊的成員，而團隊會顯示在團隊清單中。
...
### <a name="step-2---resource-accounts"></a>[步驟 2 - 資源帳戶](#tab/resource-account)

您建立的每個通話佇列都需要資源帳戶。 這類似于使用者帳戶，除了該帳戶與自動電話機或通話佇列相關聯，而不是與人員相關聯。 在此步驟中，我們將建立帳戶，將帳戶指派Microsoft Teams 電話 *標準 - 虛擬使用者* 授權，然後使用它開始建立通話佇列。
...
您必須為資源帳戶 *Microsoft Teams 電話標準 - 虛擬* 使用者授權。

1. 在 Microsoft 365 系統管理中心中，按一下 [**使用** 中使用者」 清單中的您想要指派授權的資源帳戶。

2. 在 "**授權與應用程式"** 選項卡 **的 "授權**" 下，選取 **Microsoft Teams 電話標準 - 虛擬使用者**。
...
1. 在系統Teams，展開 **[語音** 與通話佇列>，然後按一下 ****[**新增**。

2. 輸入通話佇列的名稱。

3. 按一下 **[新增帳戶**>、搜尋要用於此通話佇列的資源帳戶、按一下 [ **新增**，然後按一下 [ **新增**> 。

4.  ([) 指定通話識別碼下，按一下 ****[新增>，搜尋您為自動話務員建立的資源帳戶，按一下 [新增，然後按一下 **[新增**> 。**** 這樣一來，通話代理人就會在來電時，提供主線本機號碼。

5. 選擇語言。 如果您啟用系統產生的語音提示和語音信箱 (，就會使用) 。

6. 指定當來電者抵達佇列時，是否要播放問候語。 您必須上傳包含您想要播放的問候語的 MP3、WAV 或 WMA 檔案。

7. Teams在佇列中保留來電者時，提供預設音樂。 如果您想要播放特定的音訊檔案，請選擇播放音訊檔案並上傳 MP3、WAV 或 WMA 檔案。
...
### <a name="step-3---call-agents"></a>[步驟 3 - 通話代理人](#tab/call-agents)

若要將代理人新增到通話佇列，我們會將它們新加到我們先前建立的團隊和頻道中。 您必須是團隊的成員，以執行此工作。

1. 選取 [ **選擇團隊選項** ，然後按一下 **[新增頻道**。
2. 輸入您建立的團隊名稱，選取該名稱，然後按一下 [ **新增**。
3. 選取您為佇列所建立頻道。
4. 按一下 **[申請**。
...
### <a name="step-4---call-routing"></a>[步驟 4 - 通話路由](#tab/call-routing)

選擇您想要使用的通話路由方法。

1. 將 **會議模式設定** 為 **自動**。

2. 選擇 **您想要使用的** 路由方法。 這決定代理程式從佇列接收來電的順序。 我們建議您使用 **序列路由或****迴圈路由**。 從這些選項中選擇：
...
### <a name="step-5---call-overflow"></a>[步驟 5 - 通話溢出](#tab/call-overflow)
...
### <a name="step-6---call-timeout"></a>[步驟 6 - 通話超時](#tab/call-timeout)
...
這會完成通話佇列的設定。 接下來，您可能會想要 [設定自動話務員](set-up-auto-attendant.md)。
