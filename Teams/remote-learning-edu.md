...
---
# <a name="get-started-with-microsoft-teams-for-remote-learning"></a>Get started with Microsoft Teams for remote learning
...
Within Teams, educators can quickly converse with students, share files and websites, create a OneNote Class Notebook, and distribute and grade assignments. Built-in OneNote Class Notebooks and end-to-end assignment management allow educators to organize interactive lessons and provide effective and timely feedback. 教育機構系統管理員和教職員可使用 [教職員團隊] 進行公告和主題交談，來掌握最新資訊並共同作業。 Educators can share instructional material using Professional Learning Communities.
...
## <a name="user-accounts-licenses-and-identity-security"></a>User accounts, licenses, and identity security
...
## <a name="easily-set-up-teams"></a>Easily set up Teams

These are the two things you need to do to get up and running with Teams:

### <a name="1-allow-users-to-create-teams"></a>1. Allow users to create teams
...
### <a name="2-configure-user-experiences-using-policies"></a>2. Configure user experiences using policies
...
## <a name="start-using-teams"></a>Start using Teams

### <a name="create-class-teams-for-secure-classroom-use"></a>Create class teams for secure classroom use
...
#### <a name="automatic-team-creation-using-sds"></a>Automatic team creation using SDS
...
#### <a name="educator-led-team-creation-from-office-365-class-groups"></a>Educator-led team creation from Office 365 class groups
...
#### <a name="powershell-script-using-graph-apis"></a>PowerShell script using Graph APIs
...
#### <a name="manual-team-creation"></a>Manual team creation
...
#### <a name="recommended-best-practices"></a>Recommended best practices
...
#### <a name="early-access-to-class-teams"></a>Early access to class teams
...
##### <a name="how-do-i-create-class-teams-that-allow-educators-early-access-to-set-up-a-team-before-admitting-students"></a>How do I create class teams that allow educators early access to set up a team before admitting students?
...
##### <a name="how-do-i-check-if-a-class-is-activated"></a>How do I check if a class is activated?
...
##### <a name="how-do-i-activate-a-class-for-an-educator"></a>How do I activate a class for an educator?
...
### <a name="create-staff-teams-for-staff-communication-and-collaboration"></a>Create staff teams for staff communication and collaboration
...
## <a name="teams-meeting-scenarios"></a>Teams meeting scenarios

### <a name="collaborative-meetings-for-virtual-classes"></a>Collaborative meetings for virtual classes
...
### <a name="districtuniversity-events-or-updates"></a>District/University events or updates
...
## <a name="recommended-tips--tricks"></a>Recommended Tips & Tricks
...
### <a name="prevent-users-from-changing-their-profile-photo"></a>Prevent users from changing their profile photo
...
## <a name="adoption-content"></a>Adoption content
...
## <a name="support-readiness"></a>Support Readiness
