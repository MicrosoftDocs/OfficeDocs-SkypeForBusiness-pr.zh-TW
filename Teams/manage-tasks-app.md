...
針對想要簡化第一線工人工作管理的組織而言，工作也包含可讓您以不同的第一線員工的規模進行設定、發佈及追蹤任務的功能。 例如，公司和地區性領導可以建立併發布針對相關位置（例如特定零售商店）的工作清單，以及透過即時報告追蹤進度。 管理員可以將工作指派給其員工，並直接在其位置內進行活動，而第一線工作者在行動或桌面上會有其已指派任務的優先順序清單。 若要啟用 [ [任務發佈](#task-publishing)]，您必須先設定組織的小組目標階層，以定義階層中所有團隊之間相互關聯的方式。
...
我們建議您不要對資訊工作者進行此操作，但在某些情況下可能會套用這種情況，例如針對不依賴電子郵件的第一線工作人員。
...
- 第一線工人有簡單的行動體驗，可查看指派給他們的工作。 他們可以附加相片，在適當時顯示其工作，並將其任務標示為已完成。
...
在每個市集中位置的第一線工作者現在會在行動裝置上的工作中有一個優先順序清單。 完成工作後，他們會將它標示為完成。 有些人甚至可能會選擇將相片上傳並附加至工作，以顯示他們的工作。
