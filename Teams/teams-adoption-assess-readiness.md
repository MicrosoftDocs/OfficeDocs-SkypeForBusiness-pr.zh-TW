...
您可以新增與貴組織相關的其他問題。 在啟動 (試驗) 的兩個階段中，您會看到善於變更、對目前技術有些不滿意，而且關係良好的領導者。 這些領導者應該會以商務顧問的名次加入核心專案小組，而且可能有專案對於您的實驗階段至關重要。 為初始實驗選取影響很大且實際的情況進行實驗，並避免高風險專案非常重要。
...
![Graph說明對變更的阻力。](media/teams-adoption-resistance.png)
