...
您可以刪除您知道已不再需要的團隊 (例如專為測試而建立的團隊，或是含有敏感性資料的團隊)。 實際上，團隊會以「虛刪除」的方式刪除，IT 人員最多可以在 21 天內回復 (Microsoft 365 群組為 30天)。 刪除團隊不會影響依照合規性原則而保留的任何交談或內容。 頻道也有「虛刪除」，而且可以在刪除後最多 21 天內回復。 刪除頻道並不會刪除 SharePoint 文件庫中的資料夾或內容。
