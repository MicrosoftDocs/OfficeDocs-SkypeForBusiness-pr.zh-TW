...
推動採用Microsoft Teams，您可以提供絕佳的使用者體驗，並提升公司內部的商業價值。 我們的目標是快速啟動並運作，以便開始使用Teams。 本指南著重于使用者採用Teams，並依存于您環境的技術準備狀態，我們檔的其他章節會說明這個問題。
...
Microsoft 365 Office 365採用架構，適用于服務中的主要工作負載。 此架構會解決任何組織支援雲端服務所應採取的核心步驟。 若要深入瞭解整體採用架構，請參閱[Microsoft Enterprise檔和資源](/microsoft-365/enterprise/)。 
...
- **縮放**- 這是一個大規模的部署階段，您可以在此為所有員工開啟Teams功能。 在這個階段中，貴組織的大小會決定這是一個「大」專案，可同時為所有員工開啟 Teams，或是否要按地區、業務單位或其他員工人口區段方法來接近此專案。 在這個階段中，您將移至連續傳遞模型。 員工、領導者和業務單位會想要擴充其 Teams 的使用，並需要訓練和您的參與，以瞭解如何以最佳方式使用 Teams 和其他 Microsoft 365 或 Office 365。
