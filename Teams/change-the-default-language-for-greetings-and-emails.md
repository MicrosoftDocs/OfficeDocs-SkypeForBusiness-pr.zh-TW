...
- **您想要變更語音信箱提示語言嗎？** 如果是商務用 Skype [https://mysettings.lync.com/voicemail](https://mysettings.lync.com/voicemail) ，請在 [**提示語言**] 下選擇新的語言。 Microsoft 團隊-使用者可以變更來自[小組桌面用戶端設定](https://support.office.com/article/manage-your-call-settings-in-teams-456cb611-3477-496f-b31a-6ab752a7595f)的語音信箱問候語
