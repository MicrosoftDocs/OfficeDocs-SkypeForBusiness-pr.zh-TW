...
商務用 Skype 與 Teams 用戶端和使用者之間的共存和互通性是由 TeamsUpgrade 模式定義，適用于使用 Teams 與 商務用 Skype 的組織移移[和互通性指南中所述](migration-interop-guidance-for-teams-with-skype.md)。
...
|--- |--- |--- |--- |--- |
| 離島 | Teams <br/> 商務用 Skype<br/> Teams<br/> 商務用 Skype| 線上<br/> 線上<br/> On-prem<br/>On-prem| &boxv;<br/>&boxv;<br/>&boxv;<br/>&boxv;|Teams <br/> 商務用 Skype<br/> **無法**<br/> 商務用 Skype|
...
|--- |--- |--- |---   |--- |
| 離島 |Teams<br/>商務用 Skype<br/>Teams <br/>商務用 Skype  |線上<br/> 線上<br/> On-prem<br/> On-prem<br/>  | &boxv;<br/>&boxv;<br/>&boxv;<br/>&boxv;<br/>| *商務用 Skype* <br/> 商務用 Skype<br/> **無法** <br/>商務用 Skype<br/> |
|SfB\* <br/> | 商務用 Skype<br/>商務用 Skype<br/> | 線上<br/> On-prem<br/> |&boxv;<br/>&boxv; |  商務用 Skype<br/>商務用 Skype<br/> |
...
| <br/><br/>模式   | 鼻祖<br/><br/> 用戶端| <br/><br/>SfB 家用|<br/><br/>路由--> | 收件者<br/><br/> 離島 |
|--- |--- |--- |--- |--- |
| 離島 |Teams<br/>商務用 Skype <br/>Teams <br/>商務用 Skype  |線上<br/> 線上<br/> On-prem<br/> On-prem<br/>  | &boxv;<br/>&boxv;<br/>&boxv;<br/>&boxv;<br/>| *商務用 Skype* <br/> 商務用 Skype <br/> **無法**   <br/> 商務用 Skype |
...
| <br/><br/>模式   | 鼻祖<br/><br/> 用戶端| <br/><br/>SfB 家用|<br/><br/>路由-->|  收件者<br/><br/> SfB\* |  
|--- |--- |--- |--- |--- |
| 離島 |Teams<br/>商務用 Skype <br/>Teams <br/>商務用 Skype <br/>|線上<br/> 線上<br/> On-prem<br/> On-prem<br/> | &boxv;<br/>&boxv;<br/>&boxv;<br/>&boxv;<br/>| *商務用 Skype* <br/> 商務用 Skype <br/> **無法** <br/>商務用 Skype <br/> |  
| SfB\* |商務用 Skype <br/>商務用 Skype  |線上<br/> On-prem<br/>  |&boxv;<br/>&boxv; | 商務用 Skype <br/>商務用 Skype  |
| TeamsOnly | Teams|線上 |&boxv; |*商務用 Skype*  |
|  | | | | |
...
如果仍然可以使用該路由選項，則從 Teams 中現有永久執行緒開始的通話或聊天，會以與該對話相同的方式路由。

如果 Teams 中現有的永久執行緒是原生執行緒 (即路由至 Teams) ，則來自該執行緒的其他聊天訊息和通話會傳送到 Teams。 如果這是內部 (執行緒，商務用 Skype) 路由到 商務用 Skype) ，如果路由選項可供使用，其他聊天訊息和通話商務用 Skype (會再次傳送到) 。
