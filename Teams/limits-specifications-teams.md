...
> **Microsoft 365 的即時活動限制增加**
>
> 為了協助客戶滿足迅速變化的通訊需求，我們將針對於 Teams、Stream 和 Yammer 中進行的即時活動暫時提高預設限制，直到 2021 年 1 月 1 日止。
>
> - 出席者限制：活動最多可支援 20,000 位出席者
> - 同時活動：不同租用戶可以同時進行 50 個活動
> - 活動持續時間：每個廣播的活動長度已增加為 16 小時
>
> 此外，可透過 Microsoft 即時活動輔助計畫來規劃最多 100,000 位出席者參與的即時活動。 [深入了解](https://aka.ms/Stream/Blog/LiveEventOptions)。 **2021 年 1 月 1 日之後，需要這些限制增加的客戶必須購買 [[進階通訊附加元件]](teams-add-on-licensing/advanced-communications.md)。**
