...
ms.locfileid: "49812643"
---
# <a name="facilitate-user-adoption-of-your-new-online-phone-system"></a><span data-ttu-id="2c60c-103">協助使用者採用新的線上電話系統</span><span class="sxs-lookup"><span data-stu-id="2c60c-103">Facilitate user adoption of your new online phone system</span></span>

<span data-ttu-id="2c60c-104">電話可以是使用者的生命線。</span><span class="sxs-lookup"><span data-stu-id="2c60c-104">A phone can be a user's lifeline.</span></span> <span data-ttu-id="2c60c-105">從傳統的電話系統切換到線上電話系統，會對使用者的運作方式有重大變更，而且可能會對生產力造成負面影響。</span><span class="sxs-lookup"><span data-stu-id="2c60c-105">Switching from a traditional phone system to an online phone system represents a significant change in the way users work, and can negatively affect productivity.</span></span> <span data-ttu-id="2c60c-106">您需要花時間透過這項變更來通知、引導及支援使用者，這可以協助確保使用者體驗良好，並最大化投資回報。</span><span class="sxs-lookup"><span data-stu-id="2c60c-106">Taking time to inform, guide, and support users through this change can help ensure a positive user experience and maximize your return on investment.</span></span>

<span data-ttu-id="2c60c-107">本文包含可自訂的電子郵件範本，可協助使用者瞭解他們的新電話系統。</span><span class="sxs-lookup"><span data-stu-id="2c60c-107">This article contains customizable email templates to help inform users about their new phone system.</span></span> <span data-ttu-id="2c60c-108">自訂並傳送適當的電子郵件，以與您的特定語音部署相符。</span><span class="sxs-lookup"><span data-stu-id="2c60c-108">Customize and send the appropriate emails to align with your specific voice deployment.</span></span> <span data-ttu-id="2c60c-109">我們使用括弧來指示章節，以輕鬆進行個人化，但我們建議您新增組織特定的訊息，讓您的使用者與您的使用者最有關系。</span><span class="sxs-lookup"><span data-stu-id="2c60c-109">We've used brackets to indicate sections for easy personalization, but we recommend that you add organization-specific messaging to make the announcement most relevant for your users.</span></span> <span data-ttu-id="2c60c-110">如果適用于您的部署，請將「團隊」的所有參考全部取代為「商務用 Skype」。</span><span class="sxs-lookup"><span data-stu-id="2c60c-110">If applicable for your deployment, replace all references to "Teams" with "Skype for Business."</span></span>

## <a name="email-number-1-send-three-weeks-before-launch"></a><span data-ttu-id="2c60c-111">電子郵件編號1：啟動前三周傳送</span><span class="sxs-lookup"><span data-stu-id="2c60c-111">Email number 1: Send three weeks before launch</span></span>

<span data-ttu-id="2c60c-112">主題行：</span><span class="sxs-lookup"><span data-stu-id="2c60c-112">Subject line:</span></span>

```
IMPORTANT ANNOUNCEMENT about your office desk phone
```

<span data-ttu-id="2c60c-113">電子郵件的主體：</span><span class="sxs-lookup"><span data-stu-id="2c60c-113">Body of email:</span></span>
...
## <a name="email-number-2-send-one-week-before-launch"></a><span data-ttu-id="2c60c-114">電子郵件編號2：啟動前先傳送一周</span><span class="sxs-lookup"><span data-stu-id="2c60c-114">Email number 2: Send one week before launch</span></span>

<span data-ttu-id="2c60c-115">主題行：</span><span class="sxs-lookup"><span data-stu-id="2c60c-115">Subject line:</span></span>

```
ACTION REQUESTED: Are you ready for your new phone system?
```

<span data-ttu-id="2c60c-116">電子郵件的主體：</span><span class="sxs-lookup"><span data-stu-id="2c60c-116">Body of email:</span></span>
...
## <a name="email-number-3-send-on-launch-day"></a><span data-ttu-id="2c60c-117">電子郵件編號3：啟動日時傳送</span><span class="sxs-lookup"><span data-stu-id="2c60c-117">Email number 3: Send on launch day</span></span>

<span data-ttu-id="2c60c-118">主題行：</span><span class="sxs-lookup"><span data-stu-id="2c60c-118">Subject line:</span></span>

```
IMPORTANT NOTICE: Your new phone system is live
```

<span data-ttu-id="2c60c-119">電子郵件的主體：</span><span class="sxs-lookup"><span data-stu-id="2c60c-119">Body of email:</span></span>
...
## <a name="email-number-4-send-two-weeks-after-launch"></a><span data-ttu-id="2c60c-120">電子郵件號碼4：啟動後傳送兩周</span><span class="sxs-lookup"><span data-stu-id="2c60c-120">Email number 4: Send two weeks after launch</span></span>

<span data-ttu-id="2c60c-121">主題行：</span><span class="sxs-lookup"><span data-stu-id="2c60c-121">Subject line:</span></span>

```
FEEDBACK REQUESTED: Your new phone system
```

<span data-ttu-id="2c60c-122">電子郵件的主體：</span><span class="sxs-lookup"><span data-stu-id="2c60c-122">Body of email:</span></span>
