...
---
# <a name="facilitate-user-adoption-of-your-new-online-phone-system"></a><span data-ttu-id="e653f-103">協助使用者採用新的線上電話系統</span><span class="sxs-lookup"><span data-stu-id="e653f-103">Facilitate user adoption of your new online phone system</span></span>

<span data-ttu-id="e653f-104">手機可以是使用者的命脈。</span><span class="sxs-lookup"><span data-stu-id="e653f-104">A phone can be a user's lifeline.</span></span> <span data-ttu-id="e653f-105">從傳統電話系統切換到線上電話系統，代表使用者工作方式的大幅變更，可能會對生產力造成負面影響。</span><span class="sxs-lookup"><span data-stu-id="e653f-105">Switching from a traditional phone system to an online phone system represents a significant change in the way users work, and can negatively affect productivity.</span></span> <span data-ttu-id="e653f-106">花時間通知、引導和支援使用者完成這項變更，可協助確保良好的使用者體驗，並最大化您的投資收益。</span><span class="sxs-lookup"><span data-stu-id="e653f-106">Taking time to inform, guide, and support users through this change can help ensure a positive user experience and maximize your return on investment.</span></span>

<span data-ttu-id="e653f-107">本文包含可自訂的電子郵件範本，可協助使用者瞭解其新電話系統。</span><span class="sxs-lookup"><span data-stu-id="e653f-107">This article contains customizable email templates to help inform users about their new phone system.</span></span> <span data-ttu-id="e653f-108">自訂並傳送適當的電子郵件，以配合您的特定語音部署。</span><span class="sxs-lookup"><span data-stu-id="e653f-108">Customize and send the appropriate emails to align with your specific voice deployment.</span></span> <span data-ttu-id="e653f-109">我們已使用方括弧指出可輕鬆個人化的節，但我們建議您新增組織特定的訊息，讓公告最適用于您的使用者。</span><span class="sxs-lookup"><span data-stu-id="e653f-109">We've used brackets to indicate sections for easy personalization, but we recommend that you add organization-specific messaging to make the announcement most relevant for your users.</span></span> <span data-ttu-id="e653f-110">如果適用于您的部署，請將 「Teams」的所有參照取代為「商務用 Skype」。</span><span class="sxs-lookup"><span data-stu-id="e653f-110">If applicable for your deployment, replace all references to "Teams" with "Skype for Business."</span></span>

## <a name="email-number-1-send-three-weeks-before-launch"></a><span data-ttu-id="e653f-111">電子郵件號碼 1：在啟動前三周傳送</span><span class="sxs-lookup"><span data-stu-id="e653f-111">Email number 1: Send three weeks before launch</span></span>

<span data-ttu-id="e653f-112">主題行：</span><span class="sxs-lookup"><span data-stu-id="e653f-112">Subject line:</span></span>

```
IMPORTANT ANNOUNCEMENT about your office desk phone
```

<span data-ttu-id="e653f-113">電子郵件的內體：</span><span class="sxs-lookup"><span data-stu-id="e653f-113">Body of email:</span></span>
...
## <a name="email-number-2-send-one-week-before-launch"></a><span data-ttu-id="e653f-114">電子郵件號碼 2：在啟動前一周傳送</span><span class="sxs-lookup"><span data-stu-id="e653f-114">Email number 2: Send one week before launch</span></span>

<span data-ttu-id="e653f-115">主題行：</span><span class="sxs-lookup"><span data-stu-id="e653f-115">Subject line:</span></span>

```
ACTION REQUESTED: Are you ready for your new phone system?
```

<span data-ttu-id="e653f-116">電子郵件的內體：</span><span class="sxs-lookup"><span data-stu-id="e653f-116">Body of email:</span></span>
...
## <a name="email-number-3-send-on-launch-day"></a><span data-ttu-id="e653f-117">電子郵件號碼 3：啟動日傳送</span><span class="sxs-lookup"><span data-stu-id="e653f-117">Email number 3: Send on launch day</span></span>

<span data-ttu-id="e653f-118">主題行：</span><span class="sxs-lookup"><span data-stu-id="e653f-118">Subject line:</span></span>

```
IMPORTANT NOTICE: Your new phone system is live
```

<span data-ttu-id="e653f-119">電子郵件的內體：</span><span class="sxs-lookup"><span data-stu-id="e653f-119">Body of email:</span></span>
...
## <a name="email-number-4-send-two-weeks-after-launch"></a><span data-ttu-id="e653f-120">電子郵件號碼 4：啟動後兩周傳送</span><span class="sxs-lookup"><span data-stu-id="e653f-120">Email number 4: Send two weeks after launch</span></span>

<span data-ttu-id="e653f-121">主題行：</span><span class="sxs-lookup"><span data-stu-id="e653f-121">Subject line:</span></span>

```
FEEDBACK REQUESTED: Your new phone system
```

<span data-ttu-id="e653f-122">電子郵件的內體：</span><span class="sxs-lookup"><span data-stu-id="e653f-122">Body of email:</span></span>
