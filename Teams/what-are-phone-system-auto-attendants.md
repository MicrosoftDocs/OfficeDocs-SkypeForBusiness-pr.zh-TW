...
您可以在每個自動語音應答上設定上班時間。 如果未設定上班時間，則當天的所有日期和所有的時間都被視為「上班時間」，因為預設會設定24/7 排程。 您可以在一天中使用時段來設定上班時間，而且所有未設為「上班時間」的小時都會被視為時間。 您可以設定不同的撥入式通話處理選項和不同的問候語 (，這是可供您在上班時間和時間之後選用的) 。
