...
[內容搜尋] 提供一種特殊的方式, 可查詢 Microsoft 團隊資訊跨越 Exchange、SharePoint Online 和商務用 OneDrive。
...
例如, 針對您的製造規格信箱和製造規格 SharePoint 網站使用**內容搜尋**, 您可以從 Exchange、檔案上傳與 SharePoint Online 的檔案上傳及修改 (OneNote) 搜尋小組頻道交談。雖.
