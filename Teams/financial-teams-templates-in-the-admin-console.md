...
>| ------------------ |--|----------------------------------------------------- |
>|銀行分行|`https://graph.microsoft.com/beta/teamsTemplates('CollaborateWithinABankBranch')`|一般<br>公告<br>過程中討論<br>客戶會議<br>核准要求<br>指導<br>技能開發<br>貸款處理<br>客戶抱怨<br>讚美<br>有趣的內容<br>合規性|
