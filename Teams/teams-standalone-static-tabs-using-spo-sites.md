...
4. <span data-ttu-id="6a7ee-125">在 App Studio 已開啟時，按一下 [資訊清單編輯器]\*\*\*\*。</span><span class="sxs-lookup"><span data-stu-id="6a7ee-125">With App Studio open, click on **Manifest Editor**.</span></span>
