...
11. 流覽至 [**網域和許可權**]。 請確定有效的網域區段包含您的 SharePoint online 網功能變數名稱稱。

    範例： contoso.sharepoint.com

12. 新增下列 web app**單一登入**屬性： 
     
     範例： **AAD 應用程式識別碼**： 00000003-0000-0Ff1-ce00-000000000000**資源 Url**： {{子域}}. sharepoint .com
