...
ms.reviewer: ''
description: 為授課者概述Teams 會議室系統和裝置在各種空間和設定中的潛在用途和優點。
ms.collection:
- M365-voice
- M365-collaboration
...
### <a name="what-is-the-role-of-the-space"></a>空間的作用是什麼？
...
### <a name="what-are-the-right-audio-devices-for-each-space"></a>哪些音訊裝置適合每個空間？
...
![學生使用個人電腦和頭戴式裝置的影像。](media/devices4.png)
...
![具有一體式音效列的個人電腦設定。](media/devicesnew1.png)
