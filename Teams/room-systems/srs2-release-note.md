...
- 聊天室使用者介面的主題和正面改善
- TLS 1.2 用戶端支援。 針對內部部署客戶, 在 Microsoft 團隊聊天室啟用經由 TLS 1.2 的通訊需要商務用 Skype Server 2015 累加更新 9 (CU9) 或商務用 Skype Server 2019 累加更新 1 (CU1)。
...
- 使 IT 專業人員能夠使用 Windows 10 版本 1709 (更新版及更新版本) 來建立自己動手影像的優化。 
