...
>[!NOTE]
>如果顯示的版本是1607或更舊版本, 請先依照在<a href="#Windows-up">恢復步驟之前更新 Windows</a>中的步驟操作, 然後再 Proceding 到<a href="#Perform">執行損毀修復</a>步驟。 如果顯示的版本大於 1607, 請依照<a href="#Perform">執行恢復</a>中的步驟進行。
