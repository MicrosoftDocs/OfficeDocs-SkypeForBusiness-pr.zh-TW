...
連接器將經常使用的內容和服務更新直接傳送至頻道，讓您的小組保持在最新狀態。 有了連接器，Microsoft Teams使用者就可以在其小組的聊天串流中接收來自熱門服務的更新，例如 Trello、Wunderlist、GitHub 和 Azure DevOps Services。
