...
您可以針對美國政府客戶Office 365 政府版高GCC方案 ，包括資格要求Office 365 政府版[更多](https://products.office.com/government/compare-office-365-government-plans)[相關資訊](https://products.office.com/government/compare-office-365-government-plans#EligibilityRequirements)。
...
|&nbsp;|&nbsp;|
|-----------|------------|
| ![描述決策點的圖示。](media/audio_conferencing_image7.png) <br/>決策點|<ul><li>決定是否需要修改任何預設選項 - Office 365 政府版高安全性GCC，解決以先瞭解您可能進行的任何變更的影響。</li></ul> |
...
為了配合我們政府雲端客戶的需求，Teams方案中的 Teams - Office 365 政府版 - GCC 高Teams Enterprise差異。 請參閱下表，瞭解哪些功能可供使用。
