...
本指南適用于在美國聯邦、州、地方、部落或地區政府機構中推動 Microsoft 365 部署的 IT 專業人員，或是處理受政府法規和需求規範之資料的其他實體，而其中 Microsoft 365 政府 - GCC 適合使用 Microsoft 365 政府 - GCC 來符合這些要求。 2020 年 3 月 26 日新[版](https://github.com/MicrosoftDocs/OfficeDocs-SkypeForBusiness/blob/live/Teams/downloads/Quick-Start-Guide-for-GCC.pdf?raw=true)：請勿錯過我們可下載的快速入門手冊GCC。
...
> 
>這些音訊/視Microsoft Azure位於 FedRAMP High 認證邊界伺服器內，且不會儲存任何客戶內容。 不過，這些伺服器正在處理通話和會議的音訊和視音訊，並在此期間由我們的商業人員操作。<br/>
> 
...
Microsoft 365政府 - GCC 環境符合美國政府雲端服務的需求，包括 FedRAMP 中度，以及犯罪審判和聯邦稅務資訊系統 (CJI 和 FTI 資料類型) 。

除了享受本服務的功能Microsoft 365，組織還受益于下列政府特有的功能 -Microsoft 365 - GCC：

-   貴組織的客戶內容在邏輯上與 Microsoft 商務服務Microsoft 365內容分隔。
-   貴組織的客戶內容會儲存在美國境內。
...
|    |     |
|-----------|------------|
| ![描繪決策點的圖示](media/audio_conferencing_image7.png) <br/>決策點|<ul><li>請遵循管理計畫中的指導方針，在 Teams 中判斷[和記錄您的Teams。](plan-teams-governance.md)</li></ul> |
