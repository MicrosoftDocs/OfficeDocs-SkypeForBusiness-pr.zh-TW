---
title: 規劃在 Teams - Microsoft Teams
ms.author: mikeplum
...
> [!Tip] 
> 請觀看下列會話，以深入瞭解 Microsoft Teams 中的[管理：Microsoft Teams](https://aka.ms/teams-governance)
...
|<img src="media/audio_conferencing_image9.png" alt= "An icon depicting the next steps"/>|後續步驟|<ul><li>記錄貴組織建立團隊、命名、分類和來賓存取的需求。</li><li>規劃將這些要求作為您推行計畫的一Teams一部分。</li><li>溝通和發佈您的Teams告知使用者他們預期的行為。</li></ul>|
...
| ![描繪後續步驟的圖示](media/audio_conferencing_image9.png)<br/>後續步驟|<ul><li>記錄貴組織對於小組到期、資料保留和存檔的需求。</li><li>規劃將這些要求作為您推行計畫的一Teams一部分。</li><li>溝通和發佈您的Teams告知使用者他們預期的行為。</li></ul>|
...
> [!Note]
> 群組到期是一項Azure AD Premium功能。 若要使用這項功能，您的租使用者必須擁有設定設定Azure AD Premium群組成員之系統管理員的訂閱和授權。
...
|<img src="media/audio_conferencing_image9.png" alt= "An icon depicting the next steps"/>| 下一個步驟？ | 記錄每個團隊或特定團隊的成員資格到期組織需求。<br>規劃貴組織如何將團隊、群組、SharePoint網站和應用程式組合在存取套件中。<br>規劃哪些人員需要核准或拒絕存取要求，例如要求者主管、專案經理、連線組織的贊助者或貴組織的安全性專員。 |
...
系統管理與生命週期管理的另一Teams是能夠控制使用者可存取的功能。 您可以管理訊息、會議及通話功能，Microsoft 365或Office 365層級或每個使用者。


|-        |-        |
|---------|---------|
| ![描繪決策點的圖示](media/audio_conferencing_image7.png) <br/>決策點|<ul><li>貴組織是否需要限制Teams租使用者的功能？</li><li>貴組織是否需要限制Teams使用者的功能？</li></ul>|
| ![描繪後續步驟的圖示](media/audio_conferencing_image9.png)<br/>後續步驟|<ul><li>記錄貴組織限制租使用者Teams使用者層級的功能需求。</li><li>規劃將您的特定需求作為您推行計畫的一Teams一部分。</li><li>溝通併發布您的Teams告知使用者他們預期的行為。</li></ul>|

### <a name="teams-feature-management-focus-areas"></a>Teams功能管理焦點區域

Teams提供精細的功能，可透過策略控制訊息、會議、通話和即時活動功能等。 根據預設，不同的原則可以適用于所有使用者，也可以根據貴組織的需求，將每個使用者都適用。 
...
Teams建基於 Microsoft 365 和 Office 365 進位安全性與合規性功能，支援稽核與報告、合規性內容搜尋、電子探索、法律保留和保留政策。
