...
- [設定網路](onboarding-checklist-configure-networking.md)
...
<table>
<tr><td><img src="media/audio_conferencing_image7.png" alt="An icon depicting a decision point"/> <br/>決策點</td><td><ul><li>誰將負責監視加入核對檢查的完成情況？</li></ul></td></tr>
