...
ms.locfileid: "66789838"
---
# <a name="use-power-bi-to-analyze-cqd-data-for-microsoft-teams"></a>使用 Power BI 來分析 Microsoft Teams 的 CQD 資料

2020 年 1 月的新功能： [下載適用于 CQD 的 Power BI 查詢範本](https://www.microsoft.com/download/details.aspx?id=102291)。 您可以使用可自訂的 Power BI 範本來分析及報告 CQD 資料。
...
|CQD 行動裝置報表.pbit     | 提供針對行動裝置使用者特別調整的深入解析，包括通話品質、可靠性和通話評分。 檢視 Android、iOS)  (行動網路、WiFi 網路和行動作業系統報告。 |
