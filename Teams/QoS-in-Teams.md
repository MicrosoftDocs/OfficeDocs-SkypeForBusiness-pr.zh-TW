...
4. 在 [**顯示篩選**] 欄位中, 使用撥打電話之電腦的來源 IP 位址, 並透過定義 DSCP 值 46 (十六進位 0x2E) 做為搜尋準則來縮小篩選器, 如下列範例所示:
...
在這個範例中, DSCP 值會設定為46。 這是正確的, 因為使用的來源埠是 50019, 這表示這是語音工作負載。
