...
- 最短的 Microsoft 365 或 Office 365 路徑是最佳做法。
- 關閉埠只會導致品質下降。
...
如需設定防火牆埠的相關資訊，請移至[Microsoft 365 和 Office 365 url 與 IP 範圍](office-365-urls-ip-address-ranges.md)。
