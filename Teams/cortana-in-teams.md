...
ms.locfileid: "60749099"
---
# <a name="cortana-voice-assistance-in-teams"></a>Cortana語音協助Teams

> [!Note]
> Cortana iOS 和 Android Microsoft Teams 行動應用程式中支援語音協助，Microsoft Teams適用于美國、英國、加拿大、印度和澳洲的使用者。 Microsoft Teams 會議室上的Windows僅適用于設定為 en-us 的裝置。 Cortana目前不適用於 GCC、GCC高、DoD 和非美國 EDU 租使用者。 Cortana行動應用程式中Teams語音協助，現在適用于美國 EDU 客戶。 擴充至其他語言和地區，將在未來發行時進行。


Cortana Teams行動裝置 App、Windows 上的 Microsoft Teams 會議室 和 Microsoft Teams 顯示裝置中提供語音協助，Microsoft 365 企業版 使用者可以使用自然語言。 使用者可以選取 Teams 行動Cortana右上角的麥克風按鈕，或在 Microsoft Teams 會議室中念出 &#8220;Cortana&#8221;，或是使用 Microsoft Teams 顯示器。 若要不用手快速與小組聯繫，以及進行中，使用者可以說出查詢，例如 &#8220;打電話給 Megan&#8221; 或 &#8220;將訊息傳送至下一個會議&#8221;。 使用者也可以說加入下一&#8220;會議&#8221;並使用語音協助來共用檔案、檢查他們的日曆等來加入會議。 這些語音協助體驗是使用[Cortana](/microsoft-365/admin/misc/cortana-integration?view=o365-worldwide)企業級服務提供，完全遵守 Office 365 的隱私權、安全性和合規性承諾，如線上服務條款[ (OST ](https://www.microsoft.com/licensing/product-licensing/products?rtc=1)) 。
...
租使用者管理員可以控制租使用者中的哪些人Cortana TeamsCortanaPolicy Teams使用 (語音) 。 此策略設定為使用者帳戶層級或租使用者層級。 系統管理員可以使用此策略控制項中的 CortanaVoiceInvocationMode 欄位，判斷 Cortana 是停用、是否僅以按鈕式啟用啟用，或是使用喚醒字叫用，以及 (適用于支援此功能的裝置 ，例如 Microsoft Teams 顯示) 。
...
此範例顯示使用名稱 &#8220;EmployeeCortanaPolicy&#8221; 更新現有策略，Cortana僅使用按鈕Microsoft Teams啟用 Microsoft Teams 語音協助。 使用者可以在 Cortana 中選取 Cortana麥克風按鈕來Teams。 喚醒字 (&#8220;嘿，Cortana&#8221;或&#8220;Cortana&#8221;) 會停用該叫叫。  
...
- Teams行動應用程式不支援喚醒字詞啟用，但日後將會支援。  

- Microsoft Teams 會議室裝置Windows Microsoft Teams裝置上，將會支援喚醒字啟用。

## <a name="user-control"></a>使用者控制項

個別使用者可以在不同的裝置Cortana語音協助：
...
Cortana _將_ 裝置設定為使用地區設定時，系統預設會啟用推入通話功能。 [瞭解更多資訊。](/MicrosoftTeams/rooms/console#to-apply-your-desired-language)  Cortana圖示會 _取代更多__..._ Teams 功能表。 若要停用Cortana _按以交談，請使用_ PowerShell。[深入瞭解。](/powershell/module/skype/new-csteamscortanapolicy?view=skype-ps#example-1)
...
```
在會議層級，只有在裝置層級啟用語音Cortana _才能_ 進行變更。  若要 _在Cortana啟用_ 語音啟用功能，請移動開關 **開啟** 或 **關閉** 以停用。 會議結束後，Cortana回到裝置層級設定設定。
