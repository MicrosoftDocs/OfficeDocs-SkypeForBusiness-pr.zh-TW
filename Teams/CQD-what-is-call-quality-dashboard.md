...
CQD 是專為協助Teams管理員、商務用 Skype系統管理員和網路工程師監控全組織層級的通話和會議品質所設計。 您將使用 CQD 來協助 **優化** 您的網路，以提升品質。 當您需要查看特定使用者的通話和會議資訊時，請使用CQD 資料與每個使用者的通話[分析](use-call-analytics-to-troubleshoot-poor-call-quality.md)。
...
請勿錯過我們的管理通話[](quality-of-experience-review-guide.md)和會議品質文章，為負責管理 Teams 服務品質的系統管理員或支援工程師提供深入Teams。

## <a name="legacy-version-of-cqd-cqdlynccom"></a>舊版 CQD (CQD.lync.com) 

目前版本的 CQD (https://CQD.Teams.microsoft.com) 已取代舊版 CQD https://CQD.lync.com) (。 您仍可使用 CQD.lync.com (系統管理中心 商務用 Skype) ，但自 2020 年 7 月 1 日起，它使用的是 CQD 的資料。Teams.microsoft.com，您無法再從舊的 CQD 資料表來查看或修改建築物或查詢 (CQD.lync.com) 。 如果您尚未從資料庫移 CQD.lync.com，請記錄支援票證。
