...
| 日期 | 版本 | 更新 |
|------- | -------------------- | ------------------------------ |
| 2021 年 8 月 | [2.5.0](https://www.powershellgallery.com/packages/MicrosoftTeams/2.5.0) |<li>AccessToken 使用 連線 -MicrosoftTeams 登入的更新。</li><li>在雲端shell 中登入Connect-MicrosoftTeams的修正。</li><li>針對小組New-Team Cmdlet 的改良功能。</li><li>TeamsUnasignedNumberTreatment Cmdlet 現已提供。</li><li>Get-CsCsOnlineDialInConferencingBridge和 Set-CsOnlineDialInConferencingBridge。</li><li>發行更新版的 Get-CsTenant，Get-CsOnlineUser (僅包含 -identity 參數) 。</li>|
