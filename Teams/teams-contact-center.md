...
將熱門的連絡人中心解決方案與 Microsoft Teams 整合，是部署 Teams 通話功能的客戶的常見需求。  本文概觀說明連絡人中心解決方案如何與 Microsoft Teams 整合，以及參與 Microsoft Teams 已連接聯絡中心認證計畫之解決方案提供者的其他資訊。
...
此模型將 CCaaS 解決方案提供者與 Microsoft Teams 電話系統基礎結構連結，啟用增強的路由、組配置和系統深入見解。 
...
雖然下列不是此整合模型的功能全面清單，但焦點區域包括：
  ...
  - 適用于代理人的 Office 365 authN，允許代理人從整合的 CCaaS 用戶端連接到其 Microsoft 租使用者 

  - Teams 使用者的目前狀態指示 

  - 支援與 Teams 使用者的轉接和群組通話 

  - 與 Teams 整合的 Teams Graph API 和雲端通訊 API 

  - 支援多租使用者 SIP 主幹，支援解決方案提供者 SBC 上的多個客戶。  
...
雖然下列不是此整合模型的功能全面清單，但它確實會強調主要焦點區域：
  ...
  - 代理人體驗應用程式應該可以同時在 Teams Web 和行動用戶端上工作

  - Teams 內 CCaaS App 中的分析、工作流程管理、代理角色型體驗
...
請查看下表，瞭解 Microsoft Teams 支援的整合模型概觀。
...
如果您是想加入認證計畫廠商，請 <Teamscategorypartner@microsoft.com> 以電子郵件 。