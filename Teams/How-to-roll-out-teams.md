...
無論您是小型企業或跨國企業，推出 Teams 的起點位置都是在 [快速入門](get-started-with-teams-quick-start.md)。它會逐步引導您完成小規模的 Teams 推出，而如果您是小型企業，或者要快速部署 Teams 做為您支援 **遠端工作者** 的第一個 Microsoft 365 或 Office 365 工作負載的話，這就是您所需要的功能。如果您的組織規模較大，請使用 [快速入門](get-started-with-teams-quick-start.md)，以一小組早期採用者試驗 Teams，使得您能夠了解 Teams，並開始規劃整個組織的部署。 

## <a name="recommended-path-to-teams"></a>Teams 的建議路徑
...
- [開始使用](get-started-with-teams-quick-start.md)
