...
您可以使用[Microsoft Team 管理中心](#using-the-microsoft-teams-admin-center)或[PowerShel](#using-powershell)l 來啟用以位置為基礎的路由。
...
若要針對特定的使用者強制執行以位置為基礎的路由，請設定使用者的通話原則，以避免 PSTN 免付費旁路。 若要這樣做，請在通話原則中開啟 [**防止收費略過**] 設定。
