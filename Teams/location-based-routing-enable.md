...
您可以使用 Microsoft [小組系統管理中心](#using-the-microsoft-teams-admin-center) 或 [PowerShel](#using-powershell)l 啟用Location-Based路由。
...
針對需要Location-Based路由限制的網站啟用路由路由。 若要這麼做，請在系統管理中心的左側導Microsoft Teams，前往 [位置網路拓撲圖Microsoft Teams選取網路網站，按一下 [編輯，然後開啟位置型路由  >  ****。    
