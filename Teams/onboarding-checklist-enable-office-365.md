...
| 第  | 確認已處理建築物資訊，且通話品質儀表板 (CQD) 可供您的租使用者執行。 | | | [通話品質儀表板](https://cqd.teams.microsoft.com) |
