...
- Phone System
- seo-marvel-apr2020
description: 瞭解自動語音應答和通話佇列，以及如何使用自動語音應答和通話佇列來協助來電者在功能表系統中移動，以連絡組織中的人員或部門。
ms.openlocfilehash: 76755e722abdcde6673baac42681697165921aca
ms.sourcegitcommit: bd05783dfb33a63e0eb083a2135f97d110dc81a3
ms.translationtype: MT
ms.contentlocale: zh-TW
ms.lasthandoff: 04/26/2022
ms.locfileid: "65059274"
---
# <a name="plan-for-teams-auto-attendants-and-call-queues"></a>規劃Teams自動語音應答和通話佇列

自動語音應答可讓您根據來電者輸入來設定功能表選項來路由通話。 功能表選項，例如「若為銷售，請按 1。  對於服務按 2 吋，自動語音應答可讓組織提供一系列選項，引導來電者快速前往目的地，而不需要由人力運算子來處理來電。

通話佇列是來電者的等候區域。 如果來電者需要連絡特定專業的人員，例如銷售或服務，而不是特定人員，您可以使用通話佇列，將來電者連線到可協助他們的代理群組。 來電者會被保留，直到被指派到佇列的專員可以接聽他們的來電。
...
- 每個自動語音應答以及每個通話佇列的資源帳戶
- 免費Microsoft 電話系統 - 每個資源帳戶的虛擬使用者授權
- 針對您想要直接撥打的每一個資源帳戶，至少一個[Microsoft 服務號碼](getting-service-phone-numbers.md)、電信業者連線號碼、直接路由號碼或混合式號碼
 - 服務號碼可能是付費或免付費電話號碼
...
當將資源帳戶用於通話佇列中的通話行識別碼，或當自動語音應答或通話佇列將來電轉接至外部電話號碼時，資源帳戶必須具有電話系統虛擬使用者授權，以及下列其中一項指派：
...
如果您有現有的自動語音應答和通話佇列基礎結構，而您要移轉到Teams，您將需要一個方案，將現有的電話號碼移轉到新的自動語音應答和通話佇列。 您可能需要建立 [移轉訂單](phone-number-calling-plans/port-order-overview.md) ，才能從其他提供者移動您的號碼。 我們建議您暫時取得一或多個新的電話號碼，並測試自動語音應答和通話佇列流量，然後再將它們切換到您目前服務中的號碼。
