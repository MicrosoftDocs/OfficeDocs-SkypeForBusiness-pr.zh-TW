...
>
> Microsoft Teams 使用者和通話代理程式僅支援自動語音應答的直接路由服務號碼和通話佇列。
> 
...
如果您有現有的自動語音應答和通話佇列基礎結構，而您要移轉到 Teams，您將需要一個方案，將現有的電話號碼移轉到新的自動語音應答和通話佇列。 您可能需要建立 [移轉訂單](phone-number-calling-plans/port-order-overview.md) ，才能從其他提供者移動您的號碼。 我們建議您暫時取得一或多個新的電話號碼，並測試自動語音應答和通話佇列流量，然後再將它們切換到您目前處於服務中的號碼。
