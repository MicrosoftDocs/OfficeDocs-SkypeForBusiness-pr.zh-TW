...
ms.locfileid: "69176690"
---
# <a name="updated-auto-attendant-and-call-queue-historical-reports"></a>已更新自動語音應答和通話佇列歷史報告
...
3. 開啟 `Teams Auto Attendant & Call Queue Historical Reports V3.0.4.pbit` 範本檔案。 Power BI Desktop應該會啟動。
...
|FirstIsCaller<br> (布林值)                              |                               |                                                                  |
|FirstUPN<br> (文字)                                      |                               |                                                                  |
|小時<br> (文字)                                          |                               |在 UTC)  (啟動小時通話                                           |
|分鐘<br> (文字)                                        |                               | (UTC) 啟動的分鐘通話                                         |
|PSTNCallDuration<br> (整數)                      |                               |                                                                  |
|PSTNCallType<br> (文字)                                  |                               |                                                                  |
|                                                       |外部                       |                                                                  |
|                                                       |內部                       |                                                                  |
...
|AutoAttendantChairDurationInSecs<br> (實數)       |                               |                                                                  |
...
|CallQueueDurationSeconds<br> (實數)               |                               |                                                                  |
